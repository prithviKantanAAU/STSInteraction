...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void instanceResetUserInterface() {
		...
		fHslider84 = FAUSTFLOAT(0.035999999999999997f);
		fHslider85 = FAUSTFLOAT(0.90000000000000002f);
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("Control 0", &fHslider85, 0.899999976f, 0.0f, 2000.0f, 0.00100000005f);
		ui_interface->closeBox();
		...
		ui_interface->addHorizontalSlider("Control 0", &fHslider84, 0.0359999985f, 0.0f, 2000.0f, 0.00100000005f);
		ui_interface->closeBox();
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow378 = float(fHslider84);
		float fSlow379 = (fConst109 * ((11.1111107f * (fSlow378 + -0.0359999985f)) + 1.0f));
		float fSlow380 = (fConst111 * float(fHslider85));
		float fSlow381 = float(fHslider86);
		float fSlow382 = float((fSlow381 > 0.0f));
		float fSlow383 = (0.0f - fSlow381);
		float fSlow384 = float(fHslider87);
		float fSlow385 = (0.400000006f * (float(fHslider88) + -0.5f));
		float fSlow386 = (fConst119 * (fSlow385 + 0.270000011f));
		float fSlow387 = (fConst119 * (0.730000019f - fSlow385));
		float fSlow388 = (fConst31 * ((1.0f / float(fHslider89)) + -1.0f));
		float fSlow389 = float(fHslider90);
		int iSlow390 = (std::fabs(fSlow389) < 1.1920929e-07f);
		float fSlow391 = (iSlow390 ? 0.0f : std::exp((0.0f - (fConst29 / (iSlow390 ? 1.0f : fSlow389)))));
		float fSlow392 = float(fHslider91);
		...
		float fSlow397 = float(fHslider92);
		float fSlow398 = (1.0f / float(fHslider93));
		float fSlow399 = std::tan((fConst18 * float(fHslider94)));
		...
		float fSlow404 = (1.0f / fSlow376);
		float fSlow405 = float(fHslider95);
		int iSlow406 = (fSlow405 > 0.0f);
		float fSlow407 = (float(fHslider96) * std::sin((fConst32 * fSlow375)));
		float fSlow408 = (fConst18 * ((fSlow375 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow405)))) / fSlow407));
		float fSlow409 = (fConst18 * (fSlow375 / fSlow407));
		...
		float fSlow416 = (1.0f / fSlow373);
		float fSlow417 = float(fHslider97);
		int iSlow418 = (fSlow417 > 0.0f);
		float fSlow419 = (float(fHslider98) * std::sin((fConst32 * fSlow372)));
		float fSlow420 = (fConst18 * ((fSlow372 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow417)))) / fSlow419));
		float fSlow421 = (fConst18 * (fSlow372 / fSlow419));
		...
		float fSlow428 = (1.0f / fSlow370);
		float fSlow429 = (((fSlow369 - fSlow367) / fSlow368) + 1.0f);
		float fSlow430 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow368))));
		float fSlow431 = (1.0f / float(fHslider100));
		float fSlow432 = std::tan((fConst18 * float(fHslider101)));
		float fSlow433 = (1.0f / fSlow432);
		float fSlow434 = (((fSlow431 + fSlow433) / fSlow432) + 1.0f);
		float fSlow435 = ((std::pow(10.0f, (0.0500000007f * float(fHslider99))) * (1.0f - float(fCheckbox5))) / fSlow434);
		float fSlow436 = float(fHslider102);
		float fSlow437 = std::tan((fConst18 * fSlow436));
		float fSlow438 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow437))));
		float fSlow439 = float(fHslider103);
		float fSlow440 = std::tan((fConst18 * fSlow439));
		float fSlow441 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow440))));
		float fSlow442 = (0.5f * fSlow16);
		float fSlow443 = (fConst228 * fSlow17);
		float fSlow444 = (27.0f * fSlow17);
		float fSlow445 = (9.0f * fSlow17);
		float fSlow446 = (3.0f * fSlow17);
		float fSlow447 = (fConst31 * ((1.0f / float(fHslider104)) + -1.0f));
		float fSlow448 = float(fHslider105);
		int iSlow449 = (std::fabs(fSlow448) < 1.1920929e-07f);
		float fSlow450 = (iSlow449 ? 0.0f : std::exp((0.0f - (fConst29 / (iSlow449 ? 1.0f : fSlow448)))));
		float fSlow451 = float(fHslider106);
		...
		float fSlow456 = float(fHslider107);
		float fSlow457 = (1.0f / float(fHslider108));
		float fSlow458 = std::tan((fConst18 * float(fHslider109)));
		...
		float fSlow464 = float(fHslider110);
		int iSlow465 = (fSlow464 > 0.0f);
		float fSlow466 = (float(fHslider111) * std::sin((fConst32 * fSlow439)));
		float fSlow467 = (fConst18 * ((fSlow439 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow464)))) / fSlow466));
		float fSlow468 = (fConst18 * (fSlow439 / fSlow466));
		...
		float fSlow476 = float(fHslider112);
		int iSlow477 = (fSlow476 > 0.0f);
		float fSlow478 = (float(fHslider113) * std::sin((fConst32 * fSlow436)));
		float fSlow479 = (fConst18 * ((fSlow436 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow476)))) / fSlow478));
		float fSlow480 = (fConst18 * (fSlow436 / fSlow478));
		...
		float fSlow490 = (1.0f / float(fHslider115));
		float fSlow491 = std::tan((fConst18 * float(fHslider116)));
		float fSlow492 = (1.0f / fSlow491);
		float fSlow493 = (((fSlow490 + fSlow492) / fSlow491) + 1.0f);
		float fSlow494 = ((std::pow(10.0f, (0.0500000007f * float(fHslider114))) * (1.0f - float(fCheckbox6))) / fSlow493);
		float fSlow495 = float(fHslider117);
		float fSlow496 = std::tan((fConst18 * fSlow495));
		float fSlow497 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow496))));
		float fSlow498 = float(fHslider118);
		float fSlow499 = std::tan((fConst18 * fSlow498));
		float fSlow500 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow499))));
		float fSlow501 = float(fHslider119);
		float fSlow502 = float((fSlow501 > 0.0f));
		float fSlow503 = (0.0f - fSlow501);
		float fSlow504 = float(fHslider120);
		float fSlow505 = (0.00100000005f * float((fSlow504 > 310.0f)));
		float fSlow506 = (fConst29 * std::max<float>(20.0f, fSlow504));
		float fSlow507 = float(fHslider121);
		float fSlow508 = (0.00100000005f * float((fSlow507 > 610.0f)));
		float fSlow509 = (fConst29 * std::max<float>(20.0f, fSlow507));
		float fSlow510 = float(fHslider122);
		float fSlow511 = (0.00100000005f * float((fSlow510 > 1210.0f)));
		float fSlow512 = (fConst29 * std::max<float>(20.0f, fSlow510));
		float fSlow513 = (fConst31 * ((1.0f / float(fHslider123)) + -1.0f));
		float fSlow514 = float(fHslider124);
		int iSlow515 = (std::fabs(fSlow514) < 1.1920929e-07f);
		float fSlow516 = (iSlow515 ? 0.0f : std::exp((0.0f - (fConst29 / (iSlow515 ? 1.0f : fSlow514)))));
		float fSlow517 = float(fHslider125);
		...
		float fSlow521 = (1.0f - fSlow516);
		float fSlow522 = float(fHslider126);
		float fSlow523 = (1.0f / float(fHslider127));
		float fSlow524 = std::tan((fConst18 * float(fHslider128)));
		float fSlow525 = (1.0f / fSlow524);
		float fSlow526 = (1.0f / (((fSlow523 + fSlow525) / fSlow524) + 1.0f));
		float fSlow527 = (((fSlow525 - fSlow523) / fSlow524) + 1.0f);
		float fSlow528 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow524))));
		float fSlow529 = (1.0f / fSlow499);
		float fSlow530 = float(fHslider129);
		int iSlow531 = (fSlow530 > 0.0f);
		float fSlow532 = (float(fHslider130) * std::sin((fConst32 * fSlow498)));
		float fSlow533 = (fConst18 * ((fSlow498 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow530)))) / fSlow532));
		float fSlow534 = (fConst18 * (fSlow498 / fSlow532));
		float fSlow535 = (iSlow531 ? fSlow534 : fSlow533);
		float fSlow536 = ((fSlow529 * (fSlow529 - fSlow535)) + 1.0f);
		float fSlow537 = ((fSlow529 * (fSlow529 + fSlow535)) + 1.0f);
		float fSlow538 = (iSlow531 ? fSlow533 : fSlow534);
		float fSlow539 = ((fSlow529 * (fSlow529 + fSlow538)) + 1.0f);
		float fSlow540 = ((fSlow529 * (fSlow529 - fSlow538)) + 1.0f);
		float fSlow541 = (1.0f / fSlow496);
		float fSlow542 = float(fHslider131);
		int iSlow543 = (fSlow542 > 0.0f);
		float fSlow544 = (float(fHslider132) * std::sin((fConst32 * fSlow495)));
		float fSlow545 = (fConst18 * ((fSlow495 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow542)))) / fSlow544));
		float fSlow546 = (fConst18 * (fSlow495 / fSlow544));
		float fSlow547 = (iSlow543 ? fSlow546 : fSlow545);
		float fSlow548 = ((fSlow541 * (fSlow541 - fSlow547)) + 1.0f);
		float fSlow549 = ((fSlow541 * (fSlow541 + fSlow547)) + 1.0f);
		float fSlow550 = (iSlow543 ? fSlow545 : fSlow546);
		float fSlow551 = ((fSlow541 * (fSlow541 + fSlow550)) + 1.0f);
		float fSlow552 = ((fSlow541 * (fSlow541 - fSlow550)) + 1.0f);
		float fSlow553 = (1.0f / fSlow493);
		float fSlow554 = (((fSlow492 - fSlow490) / fSlow491) + 1.0f);
		float fSlow555 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow491))));
		for (int i = 0; (i < count); i = (i + 1)) {
			iVec0[0] = 1;
			...
			fRec153[0] = (fSlow379 + (fRec153[1] - std::floor((fSlow379 + fRec153[1]))));
			fVec12[0] = fSlow381;
			float fTemp142 = (fSlow381 - fVec12[1]);
			fVec13[0] = fSlow383;
			float fTemp143 = (0.0f - (fSlow381 + fVec13[1]));
			fRec157[0] = (int(std::min<float>(1.0f, ((fTemp142 * float((fTemp142 > 0.0f))) + (fSlow382 * (fTemp143 * float((fTemp143 > 0.0f))))))) ? fSlow384 : fRec157[1]);
			...
			fRec154[0] = ((fConst110 * fRec154[1]) + (fSlow380 * fRec155[0]));
			...
			int iTemp147 = int(((fSlow386 * fTemp146) + -1.49999499f));
			...
			float fTemp150 = (fSlow386 * fTemp149);
			...
			float fTemp173 = (((fSlow378 * ftbl0mydspSIG0[int((65536.0f * fRec153[0]))]) + (fRec154[0] * ((fConst115 * (fRec158[2] + (fRec158[0] + (2.0f * fRec158[1])))) + 1.0f))) - (0.5f * fVec14[1]));
			...
			int iTemp175 = int(((fSlow387 * fTemp146) + -1.49999499f));
			int iTemp176 = (int(std::min<float>(fConst33, float(std::max<int>(0, iTemp175)))) + 1);
			float fTemp177 = (fSlow387 * fTemp149);
			...
			fRec163[0] = std::max<float>(fTemp200, ((fRec163[1] * fSlow394) + (fTemp200 * fSlow395)));
			fRec162[0] = ((fRec162[1] * fSlow391) + (fRec163[0] * fSlow396));
			fRec161[0] = ((fConst30 * fRec161[1]) + (fSlow388 * std::max<float>(((20.0f * std::log10(fRec162[0])) - fSlow397), 0.0f)));
			float fTemp201 = (0.125f * (fRec131[0] * std::pow(10.0f, (0.0500000007f * fRec161[0]))));
			fRec164[0] = (fTemp201 - (fSlow401 * ((fSlow402 * fRec164[2]) + (fSlow403 * fRec164[1]))));
			float fTemp202 = (fSlow377 * fRec130[1]);
			fRec130[0] = (fTemp201 - ((fSlow401 * (fRec164[2] + (fRec164[0] + (2.0f * fRec164[1])))) + (((fRec130[2] * fSlow411) + fTemp202) / fSlow412)));
			float fTemp203 = (fSlow374 * fRec129[1]);
			fRec129[0] = ((((fTemp202 + (fRec130[0] * fSlow414)) + (fRec130[2] * fSlow415)) / fSlow412) - (((fRec129[2] * fSlow423) + fTemp203) / fSlow424));
			fRec128[0] = ((((fTemp203 + (fRec129[0] * fSlow426)) + (fRec129[2] * fSlow427)) / fSlow424) - (fSlow428 * ((fSlow429 * fRec128[2]) + (fSlow430 * fRec128[1]))));
			...
			fRec214[0] = (iTemp6 ? fSlow442 : fRec214[1]);
			float fTemp254 = (fRec218[1] + (fSlow443 * fRec214[0]));
			fRec218[0] = (fTemp254 - std::floor(fTemp254));
			float fTemp255 = (fRec217[1] + (fConst29 * ((315.0f * (fRec212[0] * ftbl0mydspSIG0[int((65536.0f * fRec218[0]))])) + (fSlow444 * fRec214[0]))));
			fRec217[0] = (fTemp255 - std::floor(fTemp255));
			float fTemp256 = (fRec216[1] + (fConst29 * ((315.0f * (fRec212[0] * ftbl0mydspSIG0[int((65536.0f * fRec217[0]))])) + (fSlow445 * fRec214[0]))));
			fRec216[0] = (fTemp256 - std::floor(fTemp256));
			float fTemp257 = (fRec215[1] + (fConst29 * ((315.0f * (fRec212[0] * ftbl0mydspSIG0[int((65536.0f * fRec216[0]))])) + (fSlow446 * fRec214[0]))));
			...
			fRec221[0] = std::max<float>(fTemp262, ((fRec221[1] * fSlow453) + (fTemp262 * fSlow454)));
			fRec220[0] = ((fRec220[1] * fSlow450) + (fRec221[0] * fSlow455));
			fRec219[0] = ((fConst30 * fRec219[1]) + (fSlow447 * std::max<float>(((20.0f * std::log10(fRec220[0])) - fSlow456), 0.0f)));
			float fTemp263 = (0.25f * (fTemp261 * std::pow(10.0f, (0.0500000007f * fRec219[0]))));
			fRec222[0] = (fTemp263 - (fSlow460 * ((fSlow461 * fRec222[2]) + (fSlow462 * fRec222[1]))));
			float fTemp264 = (fSlow441 * fRec211[1]);
			fRec211[0] = (fTemp263 - ((fSlow460 * (fRec222[2] + (fRec222[0] + (2.0f * fRec222[1])))) + (((fRec211[2] * fSlow470) + fTemp264) / fSlow471)));
			float fTemp265 = (fSlow438 * fRec210[1]);
			fRec210[0] = ((((fTemp264 + (fRec211[0] * fSlow473)) + (fRec211[2] * fSlow474)) / fSlow471) - (((fRec210[2] * fSlow482) + fTemp265) / fSlow483));
			fRec209[0] = ((((fTemp265 + (fRec210[0] * fSlow485)) + (fRec210[2] * fSlow486)) / fSlow483) - (fSlow487 * ((fSlow488 * fRec209[2]) + (fSlow489 * fRec209[1]))));
			float fTemp266 = (fSlow435 * (fRec209[2] + (fRec209[0] + (2.0f * fRec209[1]))));
			...
			fVec34[0] = fSlow501;
			float fTemp267 = (fSlow501 - fVec34[1]);
			fVec35[0] = fSlow503;
			float fTemp268 = (0.0f - (fSlow501 + fVec35[1]));
			float fTemp269 = std::min<float>(1.0f, ((fTemp267 * float((fTemp267 > 0.0f))) + (fSlow502 * (fTemp268 * float((fTemp268 > 0.0f))))));
			fVec36[0] = fTemp269;
			...
			fRec279[0] = (fSlow505 + (0.999000013f * fRec279[1]));
			fRec280[0] = (fSlow506 + (fRec280[1] - std::floor((fSlow506 + fRec280[1]))));
			fRec281[0] = (fSlow508 + (0.999000013f * fRec281[1]));
			fRec282[0] = (fSlow509 + (fRec282[1] - std::floor((fSlow509 + fRec282[1]))));
			fRec283[0] = (fSlow511 + (0.999000013f * fRec283[1]));
			fRec284[0] = (fSlow512 + (fRec284[1] - std::floor((fSlow512 + fRec284[1]))));
			...
			fRec287[0] = std::max<float>(fTemp274, ((fRec287[1] * fSlow519) + (fTemp274 * fSlow520)));
			fRec286[0] = ((fRec286[1] * fSlow516) + (fRec287[0] * fSlow521));
			fRec285[0] = ((fConst30 * fRec285[1]) + (fSlow513 * std::max<float>(((20.0f * std::log10(fRec286[0])) - fSlow522), 0.0f)));
			float fTemp275 = (0.25f * (fTemp273 * std::pow(10.0f, (0.0500000007f * fRec285[0]))));
			fRec288[0] = (fTemp275 - (fSlow526 * ((fSlow527 * fRec288[2]) + (fSlow528 * fRec288[1]))));
			float fTemp276 = (fSlow500 * fRec225[1]);
			fRec225[0] = (fTemp275 - ((fSlow526 * (fRec288[2] + (fRec288[0] + (2.0f * fRec288[1])))) + (((fRec225[2] * fSlow536) + fTemp276) / fSlow537)));
			float fTemp277 = (fSlow497 * fRec224[1]);
			fRec224[0] = ((((fTemp276 + (fRec225[0] * fSlow539)) + (fRec225[2] * fSlow540)) / fSlow537) - (((fRec224[2] * fSlow548) + fTemp277) / fSlow549));
			fRec223[0] = ((((fTemp277 + (fRec224[0] * fSlow551)) + (fRec224[2] * fSlow552)) / fSlow549) - (fSlow553 * ((fSlow554 * fRec223[2]) + (fSlow555 * fRec223[1]))));
			float fTemp278 = (fSlow494 * (fRec223[2] + (fRec223[0] + (2.0f * fRec223[1]))));
