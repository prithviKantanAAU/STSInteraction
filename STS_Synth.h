...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void instanceResetUserInterface() {
		...
		fHslider85 = FAUSTFLOAT(50.0f);
		fHslider86 = FAUSTFLOAT(440.0f);
		fHslider87 = FAUSTFLOAT(0.5f);
		fHslider88 = FAUSTFLOAT(1.0f);
		fHslider89 = FAUSTFLOAT(0.10000000000000001f);
		fHslider90 = FAUSTFLOAT(0.10000000000000001f);
		fHslider91 = FAUSTFLOAT(0.0f);
		fHslider92 = FAUSTFLOAT(0.69999999999999996f);
		fHslider93 = FAUSTFLOAT(50.0f);
		fHslider94 = FAUSTFLOAT(0.0f);
		fHslider95 = FAUSTFLOAT(0.69999999999999996f);
		fHslider96 = FAUSTFLOAT(0.0f);
		fHslider97 = FAUSTFLOAT(0.69999999999999996f);
		fHslider98 = FAUSTFLOAT(0.0f);
		fCheckbox5 = FAUSTFLOAT(0.0f);
		fHslider99 = FAUSTFLOAT(0.69999999999999996f);
		fHslider100 = FAUSTFLOAT(20000.0f);
		fHslider101 = FAUSTFLOAT(2000.0f);
		fHslider102 = FAUSTFLOAT(500.0f);
		fHslider103 = FAUSTFLOAT(1.0f);
		fHslider104 = FAUSTFLOAT(0.10000000000000001f);
		fHslider105 = FAUSTFLOAT(0.10000000000000001f);
		fHslider106 = FAUSTFLOAT(0.0f);
		fHslider107 = FAUSTFLOAT(0.69999999999999996f);
		fHslider108 = FAUSTFLOAT(50.0f);
		fHslider109 = FAUSTFLOAT(0.0f);
		fHslider110 = FAUSTFLOAT(0.69999999999999996f);
		fHslider111 = FAUSTFLOAT(0.0f);
		fHslider112 = FAUSTFLOAT(0.69999999999999996f);
		fHslider113 = FAUSTFLOAT(0.0f);
		fCheckbox6 = FAUSTFLOAT(0.0f);
		fHslider114 = FAUSTFLOAT(0.69999999999999996f);
		fHslider115 = FAUSTFLOAT(20000.0f);
		fHslider116 = FAUSTFLOAT(2000.0f);
		fHslider117 = FAUSTFLOAT(500.0f);
		fHslider118 = FAUSTFLOAT(50.0f);
		fHslider119 = FAUSTFLOAT(10.0f);
		fHslider120 = FAUSTFLOAT(10.0f);
		fHslider121 = FAUSTFLOAT(10.0f);
		fHslider122 = FAUSTFLOAT(1.0f);
		fHslider123 = FAUSTFLOAT(0.10000000000000001f);
		fHslider124 = FAUSTFLOAT(0.10000000000000001f);
		fHslider125 = FAUSTFLOAT(0.0f);
		fHslider126 = FAUSTFLOAT(0.69999999999999996f);
		fHslider127 = FAUSTFLOAT(50.0f);
		fHslider128 = FAUSTFLOAT(0.0f);
		fHslider129 = FAUSTFLOAT(0.69999999999999996f);
		fHslider130 = FAUSTFLOAT(0.0f);
		fHslider131 = FAUSTFLOAT(0.69999999999999996f);
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("Attack", &fHslider89, 0.100000001f, 0.00100000005f, 0.5f, 0.00100000005f);
		ui_interface->declare(&fHslider88, "style", "knob");
		ui_interface->addHorizontalSlider("Ratio", &fHslider88, 1.0f, 1.0f, 10.0f, 0.100000001f);
		ui_interface->declare(&fHslider90, "style", "knob");
		ui_interface->addHorizontalSlider("Release", &fHslider90, 0.100000001f, 0.00100000005f, 0.5f, 0.00100000005f);
		ui_interface->declare(&fHslider91, "style", "knob");
		ui_interface->addHorizontalSlider("Threshold", &fHslider91, 0.0f, -96.0f, 0.0f, 0.100000001f);
		ui_interface->closeBox();
		ui_interface->openHorizontalBox("Track 5");
		ui_interface->declare(&fHslider104, "style", "knob");
		ui_interface->addHorizontalSlider("Attack", &fHslider104, 0.100000001f, 0.00100000005f, 0.5f, 0.00100000005f);
		ui_interface->declare(&fHslider103, "style", "knob");
		ui_interface->addHorizontalSlider("Ratio", &fHslider103, 1.0f, 1.0f, 10.0f, 0.100000001f);
		ui_interface->declare(&fHslider105, "style", "knob");
		ui_interface->addHorizontalSlider("Release", &fHslider105, 0.100000001f, 0.00100000005f, 0.5f, 0.00100000005f);
		ui_interface->declare(&fHslider106, "style", "knob");
		ui_interface->addHorizontalSlider("Threshold", &fHslider106, 0.0f, -96.0f, 0.0f, 0.100000001f);
		ui_interface->closeBox();
		...
		ui_interface->addHorizontalSlider("Attack", &fHslider123, 0.100000001f, 0.00100000005f, 0.5f, 0.00100000005f);
		ui_interface->declare(&fHslider122, "style", "knob");
		ui_interface->addHorizontalSlider("Ratio", &fHslider122, 1.0f, 1.0f, 10.0f, 0.100000001f);
		ui_interface->declare(&fHslider124, "style", "knob");
		ui_interface->addHorizontalSlider("Release", &fHslider124, 0.100000001f, 0.00100000005f, 0.5f, 0.00100000005f);
		ui_interface->declare(&fHslider125, "style", "knob");
		ui_interface->addHorizontalSlider("Threshold", &fHslider125, 0.0f, -96.0f, 0.0f, 0.100000001f);
		ui_interface->closeBox();
		ui_interface->closeBox();
		...
		ui_interface->addHorizontalSlider("Freq", &fHslider93, 50.0f, 50.0f, 1000.0f, 0.100000001f);
		...
		ui_interface->addHorizontalSlider("Gain", &fHslider94, 0.0f, -24.0f, 24.0f, 0.00999999978f);
		...
		ui_interface->addHorizontalSlider("Gain", &fHslider96, 0.0f, -24.0f, 24.0f, 0.00999999978f);
		ui_interface->declare(&fHslider97, "style", "knob");
		ui_interface->addHorizontalSlider("Q", &fHslider97, 0.699999988f, 0.5f, 10.0f, 0.00999999978f);
		ui_interface->closeBox();
		ui_interface->openHorizontalBox("4_LPF");
		...
		ui_interface->addHorizontalSlider("Freq", &fHslider108, 50.0f, 50.0f, 1000.0f, 0.100000001f);
		...
		ui_interface->addHorizontalSlider("Freq", &fHslider102, 500.0f, 100.0f, 2000.0f, 0.00999999978f);
		ui_interface->declare(&fHslider109, "style", "knob");
		ui_interface->addHorizontalSlider("Gain", &fHslider109, 0.0f, -24.0f, 24.0f, 0.00999999978f);
		...
		ui_interface->addHorizontalSlider("Freq", &fHslider101, 2000.0f, 1500.0f, 15000.0f, 0.00999999978f);
		ui_interface->declare(&fHslider111, "style", "knob");
		ui_interface->addHorizontalSlider("Gain", &fHslider111, 0.0f, -24.0f, 24.0f, 0.00999999978f);
		ui_interface->declare(&fHslider112, "style", "knob");
		ui_interface->addHorizontalSlider("Q", &fHslider112, 0.699999988f, 0.5f, 10.0f, 0.00999999978f);
		ui_interface->closeBox();
		ui_interface->openHorizontalBox("4_LPF");
		ui_interface->declare(&fHslider100, "style", "knob");
		ui_interface->addHorizontalSlider("Freq", &fHslider100, 20000.0f, 50.0f, 20000.0f, 0.100000001f);
		ui_interface->declare(&fHslider99, "style", "knob");
		ui_interface->addHorizontalSlider("Q", &fHslider99, 0.699999988f, 0.5f, 10.0f, 0.00999999978f);
		ui_interface->closeBox();
		ui_interface->closeBox();
		ui_interface->openHorizontalBox("Track 6");
		ui_interface->openHorizontalBox("1_HPF");
		...
		ui_interface->addHorizontalSlider("Freq", &fHslider127, 50.0f, 50.0f, 1000.0f, 0.100000001f);
		...
		ui_interface->addHorizontalSlider("Freq", &fHslider117, 500.0f, 100.0f, 2000.0f, 0.00999999978f);
		ui_interface->declare(&fHslider128, "style", "knob");
		ui_interface->addHorizontalSlider("Gain", &fHslider128, 0.0f, -24.0f, 24.0f, 0.00999999978f);
		ui_interface->declare(&fHslider129, "style", "knob");
		ui_interface->addHorizontalSlider("Q", &fHslider129, 0.699999988f, 0.5f, 10.0f, 0.00999999978f);
		ui_interface->closeBox();
		ui_interface->openHorizontalBox("3_Parametric_2");
		ui_interface->declare(&fHslider116, "style", "knob");
		ui_interface->addHorizontalSlider("Freq", &fHslider116, 2000.0f, 1500.0f, 15000.0f, 0.00999999978f);
		ui_interface->declare(&fHslider130, "style", "knob");
		ui_interface->addHorizontalSlider("Gain", &fHslider130, 0.0f, -24.0f, 24.0f, 0.00999999978f);
		ui_interface->declare(&fHslider131, "style", "knob");
		ui_interface->addHorizontalSlider("Q", &fHslider131, 0.699999988f, 0.5f, 10.0f, 0.00999999978f);
		ui_interface->closeBox();
		ui_interface->openHorizontalBox("4_LPF");
		ui_interface->declare(&fHslider115, "style", "knob");
		ui_interface->addHorizontalSlider("Freq", &fHslider115, 20000.0f, 50.0f, 20000.0f, 0.100000001f);
		ui_interface->declare(&fHslider114, "style", "knob");
		ui_interface->addHorizontalSlider("Q", &fHslider114, 0.699999988f, 0.5f, 10.0f, 0.00999999978f);
		ui_interface->closeBox();
		ui_interface->closeBox();
		ui_interface->closeBox();
		...
		ui_interface->addHorizontalSlider("Track 5", &fHslider98, 0.0f, -96.0f, 24.0f, 0.00999999978f);
		ui_interface->addHorizontalSlider("Track 6", &fHslider23, 0.0f, -96.0f, 24.0f, 0.00999999978f);
		ui_interface->addHorizontalSlider("Track 7", &fHslider113, 0.0f, -96.0f, 24.0f, 0.00999999978f);
		ui_interface->closeBox();
		...
		ui_interface->addHorizontalSlider("Control 0", &fHslider118, 50.0f, 0.0f, 2000.0f, 0.00100000005f);
		ui_interface->closeBox();
		...
		ui_interface->addHorizontalSlider("Control 0", &fHslider119, 10.0f, 0.0f, 2000.0f, 0.00100000005f);
		ui_interface->closeBox();
		...
		ui_interface->addHorizontalSlider("Control 0", &fHslider87, 0.5f, 0.0f, 2000.0f, 0.00100000005f);
		ui_interface->closeBox();
		ui_interface->openHorizontalBox("Soni 24");
		ui_interface->addHorizontalSlider("Control 0", &fHslider85, 50.0f, 0.0f, 2000.0f, 0.00100000005f);
		ui_interface->closeBox();
		...
		ui_interface->addHorizontalSlider("Control 0", &fHslider86, 440.0f, 0.0f, 2000.0f, 0.00100000005f);
		ui_interface->closeBox();
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow12 = (0.25f * float(fHslider5));
		float fSlow13 = float(fHslider6);
		float fSlow14 = float((fSlow13 > 0.0f));
		float fSlow15 = (0.0f - fSlow13);
		float fSlow16 = std::min<float>(20000.0f, std::max<float>(20.0f, float(fHslider7)));
		float fSlow17 = std::pow(10.0f, (2.0f * (std::min<float>(1.0f, std::max<float>(0.0f, float(fHslider8))) + -0.5f)));
		float fSlow18 = std::min<float>(1.0f, std::max<float>(0.0f, float(fHslider9)));
		float fSlow19 = ((fSlow16 * fSlow17) * ((0.0500000007f * fSlow18) + 1.0f));
		float fSlow20 = ((std::min<float>(20000.0f, std::max<float>(20.0f, float(fHslider10))) * fSlow17) * (1.0f - (0.0299999993f * fSlow18)));
		float fSlow21 = ((std::min<float>(20000.0f, std::max<float>(20.0f, float(fHslider11))) * fSlow17) * ((0.310000002f * fSlow18) + 1.0f));
		float fSlow22 = ((std::min<float>(20000.0f, std::max<float>(20.0f, float(fHslider12))) * fSlow17) * (1.0f - (0.270000011f * fSlow18)));
		float fSlow23 = (fConst31 * ((1.0f / float(fHslider13)) + -1.0f));
		float fSlow24 = float(fHslider14);
		int iSlow25 = (std::fabs(fSlow24) < 1.1920929e-07f);
		float fSlow26 = (iSlow25 ? 0.0f : std::exp((0.0f - (fConst29 / (iSlow25 ? 1.0f : fSlow24)))));
		float fSlow27 = float(fHslider15);
		int iSlow28 = (std::fabs(fSlow27) < 1.1920929e-07f);
		float fSlow29 = (iSlow28 ? 0.0f : std::exp((0.0f - (fConst29 / (iSlow28 ? 1.0f : fSlow27)))));
		float fSlow30 = (1.0f - fSlow29);
		float fSlow31 = (1.0f - fSlow26);
		float fSlow32 = float(fHslider16);
		float fSlow33 = (1.0f / float(fHslider17));
		float fSlow34 = std::tan((fConst18 * float(fHslider18)));
		float fSlow35 = (1.0f / fSlow34);
		float fSlow36 = (1.0f / (((fSlow33 + fSlow35) / fSlow34) + 1.0f));
		float fSlow37 = (((fSlow35 - fSlow33) / fSlow34) + 1.0f);
		float fSlow38 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow34))));
		float fSlow39 = (1.0f / fSlow10);
		float fSlow40 = float(fHslider19);
		int iSlow41 = (fSlow40 > 0.0f);
		float fSlow42 = (float(fHslider20) * std::sin((fConst32 * fSlow9)));
		float fSlow43 = (fConst18 * ((fSlow9 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow40)))) / fSlow42));
		float fSlow44 = (fConst18 * (fSlow9 / fSlow42));
		float fSlow45 = (iSlow41 ? fSlow44 : fSlow43);
		float fSlow46 = ((fSlow39 * (fSlow39 - fSlow45)) + 1.0f);
		float fSlow47 = ((fSlow39 * (fSlow39 + fSlow45)) + 1.0f);
		float fSlow48 = (iSlow41 ? fSlow43 : fSlow44);
		float fSlow49 = ((fSlow39 * (fSlow39 + fSlow48)) + 1.0f);
		float fSlow50 = ((fSlow39 * (fSlow39 - fSlow48)) + 1.0f);
		float fSlow51 = (1.0f / fSlow7);
		float fSlow52 = float(fHslider21);
		int iSlow53 = (fSlow52 > 0.0f);
		float fSlow54 = (float(fHslider22) * std::sin((fConst32 * fSlow6)));
		float fSlow55 = (fConst18 * ((fSlow6 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow52)))) / fSlow54));
		float fSlow56 = (fConst18 * (fSlow6 / fSlow54));
		...
		float fSlow63 = (1.0f / fSlow4);
		float fSlow64 = (((fSlow3 - fSlow1) / fSlow2) + 1.0f);
		float fSlow65 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow2))));
		float fSlow66 = (1.0f / float(fHslider24));
		float fSlow67 = std::tan((fConst18 * float(fHslider25)));
		float fSlow68 = (1.0f / fSlow67);
		float fSlow69 = (((fSlow66 + fSlow68) / fSlow67) + 1.0f);
		float fSlow70 = ((std::pow(10.0f, (0.0500000007f * float(fHslider23))) * (1.0f - float(fCheckbox1))) / fSlow69);
		float fSlow71 = float(fHslider26);
		float fSlow72 = std::tan((fConst18 * fSlow71));
		float fSlow73 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow72))));
		float fSlow74 = float(fHslider27);
		float fSlow75 = std::tan((fConst18 * fSlow74));
		float fSlow76 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow75))));
		float fSlow77 = (340.0f / fSlow17);
		float fSlow78 = (0.5f * fSlow18);
		float fSlow79 = float(fHslider28);
		float fSlow80 = float((fSlow79 > 0.0f));
		float fSlow81 = (0.0f - fSlow79);
		float fSlow82 = (4.0f * float(fHslider29));
		float fSlow83 = std::min<float>(1.0f, std::max<float>(0.00999999978f, float(fHslider30)));
		float fSlow84 = (1.0f - fSlow83);
		float fSlow85 = (0.00999999978f * float(fHslider31));
		float fSlow86 = (fConst31 * ((1.0f / float(fHslider32)) + -1.0f));
		float fSlow87 = float(fHslider33);
		int iSlow88 = (std::fabs(fSlow87) < 1.1920929e-07f);
		float fSlow89 = (iSlow88 ? 0.0f : std::exp((0.0f - (fConst29 / (iSlow88 ? 1.0f : fSlow87)))));
		float fSlow90 = float(fHslider34);
		int iSlow91 = (std::fabs(fSlow90) < 1.1920929e-07f);
		float fSlow92 = (iSlow91 ? 0.0f : std::exp((0.0f - (fConst29 / (iSlow91 ? 1.0f : fSlow90)))));
		float fSlow93 = (1.0f - fSlow92);
		float fSlow94 = (1.0f - fSlow89);
		float fSlow95 = float(fHslider35);
		float fSlow96 = (1.0f / float(fHslider36));
		float fSlow97 = std::tan((fConst18 * float(fHslider37)));
		float fSlow98 = (1.0f / fSlow97);
		float fSlow99 = (1.0f / (((fSlow96 + fSlow98) / fSlow97) + 1.0f));
		float fSlow100 = (((fSlow98 - fSlow96) / fSlow97) + 1.0f);
		float fSlow101 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow97))));
		float fSlow102 = (1.0f / fSlow75);
		float fSlow103 = float(fHslider38);
		int iSlow104 = (fSlow103 > 0.0f);
		float fSlow105 = (float(fHslider39) * std::sin((fConst32 * fSlow74)));
		float fSlow106 = (fConst18 * ((fSlow74 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow103)))) / fSlow105));
		float fSlow107 = (fConst18 * (fSlow74 / fSlow105));
		float fSlow108 = (iSlow104 ? fSlow107 : fSlow106);
		float fSlow109 = ((fSlow102 * (fSlow102 - fSlow108)) + 1.0f);
		float fSlow110 = ((fSlow102 * (fSlow102 + fSlow108)) + 1.0f);
		float fSlow111 = (iSlow104 ? fSlow106 : fSlow107);
		float fSlow112 = ((fSlow102 * (fSlow102 + fSlow111)) + 1.0f);
		float fSlow113 = ((fSlow102 * (fSlow102 - fSlow111)) + 1.0f);
		float fSlow114 = (1.0f / fSlow72);
		float fSlow115 = float(fHslider40);
		int iSlow116 = (fSlow115 > 0.0f);
		float fSlow117 = (float(fHslider41) * std::sin((fConst32 * fSlow71)));
		float fSlow118 = (fConst18 * ((fSlow71 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow115)))) / fSlow117));
		float fSlow119 = (fConst18 * (fSlow71 / fSlow117));
		float fSlow120 = (iSlow116 ? fSlow119 : fSlow118);
		float fSlow121 = ((fSlow114 * (fSlow114 - fSlow120)) + 1.0f);
		float fSlow122 = ((fSlow114 * (fSlow114 + fSlow120)) + 1.0f);
		float fSlow123 = (iSlow116 ? fSlow118 : fSlow119);
		float fSlow124 = ((fSlow114 * (fSlow114 + fSlow123)) + 1.0f);
		float fSlow125 = ((fSlow114 * (fSlow114 - fSlow123)) + 1.0f);
		float fSlow126 = (1.0f / fSlow69);
		float fSlow127 = (((fSlow68 - fSlow66) / fSlow67) + 1.0f);
		float fSlow128 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow67))));
		float fSlow129 = (1.0f / float(fHslider43));
		float fSlow130 = std::tan((fConst18 * float(fHslider44)));
		float fSlow131 = (1.0f / fSlow130);
		float fSlow132 = (((fSlow129 + fSlow131) / fSlow130) + 1.0f);
		float fSlow133 = ((std::pow(10.0f, (0.0500000007f * float(fHslider42))) * (1.0f - float(fCheckbox2))) / fSlow132);
		float fSlow134 = float(fHslider45);
		float fSlow135 = std::tan((fConst18 * fSlow134));
		float fSlow136 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow135))));
		float fSlow137 = float(fHslider46);
		float fSlow138 = std::tan((fConst18 * fSlow137));
		float fSlow139 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow138))));
		float fSlow140 = std::min<float>(5.0f, std::max<float>(0.00999999978f, float(fHslider47)));
		float fSlow141 = (0.0125000002f * (std::pow(10.0f, (0.0500000007f * fSlow140)) + 1.0f));
		float fSlow142 = ((2.0f * fSlow140) + 1.0f);
		float fSlow143 = std::tan((fConst18 * ((1875.0f * fSlow142) + 500.0f)));
		float fSlow144 = (1.0f / fSlow143);
		float fSlow145 = (1.0f / (((fSlow144 + 1.41421354f) / fSlow143) + 1.0f));
		float fSlow146 = std::tan((fConst18 * ((62.5f * fSlow142) + 40.0f)));
		float fSlow147 = (1.0f / fSlow146);
		float fSlow148 = (1.0f / (((fSlow147 + 1.41421354f) / fSlow146) + 1.0f));
		float fSlow149 = mydsp_faustpower2_f(fSlow146);
		float fSlow150 = (1.0f / fSlow149);
		float fSlow151 = (((fSlow147 + -1.41421354f) / fSlow146) + 1.0f);
		float fSlow152 = (2.0f * (1.0f - fSlow150));
		float fSlow153 = (0.0f - (2.0f / fSlow149));
		float fSlow154 = (((fSlow144 + -1.41421354f) / fSlow143) + 1.0f);
		float fSlow155 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow143))));
		float fSlow156 = (1.0f / std::max<float>(1.0f, (fConst37 * fSlow142)));
		float fSlow157 = float(fHslider48);
		float fSlow158 = float((fSlow157 > 0.0f));
		float fSlow159 = (0.0f - fSlow157);
		float fSlow160 = float(fHslider49);
		float fSlow161 = (fConst31 * ((1.0f / float(fHslider50)) + -1.0f));
		float fSlow162 = float(fHslider51);
		int iSlow163 = (std::fabs(fSlow162) < 1.1920929e-07f);
		float fSlow164 = (iSlow163 ? 0.0f : std::exp((0.0f - (fConst29 / (iSlow163 ? 1.0f : fSlow162)))));
		float fSlow165 = float(fHslider52);
		int iSlow166 = (std::fabs(fSlow165) < 1.1920929e-07f);
		float fSlow167 = (iSlow166 ? 0.0f : std::exp((0.0f - (fConst29 / (iSlow166 ? 1.0f : fSlow165)))));
		float fSlow168 = (1.0f - fSlow167);
		float fSlow169 = (1.0f - fSlow164);
		float fSlow170 = float(fHslider53);
		float fSlow171 = (1.0f / float(fHslider54));
		float fSlow172 = std::tan((fConst18 * float(fHslider55)));
		float fSlow173 = (1.0f / fSlow172);
		float fSlow174 = (1.0f / (((fSlow171 + fSlow173) / fSlow172) + 1.0f));
		float fSlow175 = (((fSlow173 - fSlow171) / fSlow172) + 1.0f);
		float fSlow176 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow172))));
		float fSlow177 = (1.0f / fSlow138);
		float fSlow178 = float(fHslider56);
		int iSlow179 = (fSlow178 > 0.0f);
		float fSlow180 = (float(fHslider57) * std::sin((fConst32 * fSlow137)));
		float fSlow181 = (fConst18 * ((fSlow137 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow178)))) / fSlow180));
		float fSlow182 = (fConst18 * (fSlow137 / fSlow180));
		float fSlow183 = (iSlow179 ? fSlow182 : fSlow181);
		float fSlow184 = ((fSlow177 * (fSlow177 - fSlow183)) + 1.0f);
		float fSlow185 = ((fSlow177 * (fSlow177 + fSlow183)) + 1.0f);
		float fSlow186 = (iSlow179 ? fSlow181 : fSlow182);
		float fSlow187 = ((fSlow177 * (fSlow177 + fSlow186)) + 1.0f);
		float fSlow188 = ((fSlow177 * (fSlow177 - fSlow186)) + 1.0f);
		float fSlow189 = (1.0f / fSlow135);
		float fSlow190 = float(fHslider58);
		int iSlow191 = (fSlow190 > 0.0f);
		float fSlow192 = (float(fHslider59) * std::sin((fConst32 * fSlow134)));
		float fSlow193 = (fConst18 * ((fSlow134 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow190)))) / fSlow192));
		float fSlow194 = (fConst18 * (fSlow134 / fSlow192));
		...
		float fSlow201 = (1.0f / fSlow132);
		float fSlow202 = (((fSlow131 - fSlow129) / fSlow130) + 1.0f);
		float fSlow203 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow130))));
		float fSlow204 = (1.0f / float(fHslider61));
		float fSlow205 = std::tan((fConst18 * float(fHslider62)));
		float fSlow206 = (1.0f / fSlow205);
		float fSlow207 = (((fSlow204 + fSlow206) / fSlow205) + 1.0f);
		float fSlow208 = ((std::pow(10.0f, (0.0500000007f * float(fHslider60))) * (1.0f - float(fCheckbox3))) / fSlow207);
		float fSlow209 = float(fHslider63);
		float fSlow210 = std::tan((fConst18 * fSlow209));
		float fSlow211 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow210))));
		float fSlow212 = float(fHslider64);
		float fSlow213 = std::tan((fConst18 * fSlow212));
		float fSlow214 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow213))));
		float fSlow215 = (fConst101 * float(fHslider65));
		float fSlow216 = (fConst103 * float((float(fHslider66) > 50.0f)));
		float fSlow217 = (fConst105 * (float(fHslider67) * fSlow17));
		float fSlow218 = std::min<float>(3.0f, std::max<float>(0.0f, float(fHslider68)));
		float fSlow219 = (fSlow218 + 5.0f);
		int iSlow220 = (fSlow219 < 23.0f);
		int iSlow221 = (fSlow219 < 24.0f);
		float fSlow222 = (fSlow218 + -18.0f);
		int iSlow223 = (fSlow219 < 22.0f);
		float fSlow224 = (fSlow218 + -17.0f);
		int iSlow225 = (fSlow219 < 21.0f);
		float fSlow226 = (fSlow218 + -16.0f);
		int iSlow227 = (fSlow219 < 20.0f);
		float fSlow228 = (fSlow218 + -15.0f);
		int iSlow229 = (fSlow219 < 19.0f);
		float fSlow230 = (fSlow218 + -14.0f);
		int iSlow231 = (fSlow219 < 18.0f);
		float fSlow232 = (fSlow218 + -13.0f);
		int iSlow233 = (fSlow219 < 17.0f);
		float fSlow234 = (fSlow218 + -12.0f);
		int iSlow235 = (fSlow219 < 16.0f);
		float fSlow236 = (fSlow218 + -11.0f);
		float fSlow237 = (80.0f * fSlow236);
		int iSlow238 = (fSlow219 < 15.0f);
		float fSlow239 = (fSlow218 + -10.0f);
		int iSlow240 = (fSlow219 < 14.0f);
		float fSlow241 = (fSlow218 + -9.0f);
		int iSlow242 = (fSlow219 < 13.0f);
		float fSlow243 = (fSlow218 + -8.0f);
		int iSlow244 = (fSlow219 < 12.0f);
		float fSlow245 = (fSlow218 + -7.0f);
		int iSlow246 = (fSlow219 < 11.0f);
		float fSlow247 = (fSlow218 + -6.0f);
		int iSlow248 = (fSlow219 < 10.0f);
		float fSlow249 = (fSlow218 + -5.0f);
		int iSlow250 = (fSlow219 < 9.0f);
		float fSlow251 = (fSlow218 + -4.0f);
		int iSlow252 = (fSlow219 < 8.0f);
		float fSlow253 = (fSlow218 + -3.0f);
		float fSlow254 = (50.0f * fSlow253);
		int iSlow255 = (fSlow219 < 7.0f);
		float fSlow256 = (fSlow218 + -2.0f);
		int iSlow257 = (fSlow219 < 6.0f);
		float fSlow258 = (fSlow218 + -1.0f);
		int iSlow259 = (fSlow219 < 5.0f);
		int iSlow260 = (fSlow219 < 4.0f);
		float fSlow261 = (fSlow218 + 1.0f);
		int iSlow262 = (fSlow219 < 3.0f);
		float fSlow263 = (fSlow218 + 2.0f);
		int iSlow264 = (fSlow219 < 2.0f);
		float fSlow265 = (fSlow218 + 3.0f);
		int iSlow266 = (fSlow219 < 1.0f);
		float fSlow267 = (fSlow218 + 4.0f);
		int iSlow268 = (fSlow219 < 0.0f);
		float fSlow269 = (iSlow220 ? (iSlow223 ? (iSlow225 ? (iSlow227 ? (iSlow229 ? (iSlow231 ? (iSlow233 ? (iSlow235 ? (iSlow238 ? (iSlow240 ? (iSlow242 ? (iSlow244 ? (iSlow246 ? (iSlow248 ? (iSlow250 ? (iSlow252 ? (iSlow255 ? (iSlow257 ? (iSlow259 ? (iSlow260 ? (iSlow262 ? (iSlow264 ? (iSlow266 ? (iSlow268 ? 800.0f : (iSlow266 ? (800.0f - (400.0f * fSlow219)) : 400.0f)) : (iSlow264 ? (400.0f - (50.0f * fSlow267)) : 350.0f)) : (iSlow262 ? ((100.0f * fSlow265) + 350.0f) : 450.0f)) : (iSlow260 ? (450.0f - (125.0f * fSlow263)) : 325.0f)) : (iSlow259 ? ((275.0f * fSlow261) + 325.0f) : 600.0f)) : (iSlow257 ? (600.0f - (200.0f * fSlow218)) : 400.0f)) : (iSlow255 ? (400.0f - (150.0f * fSlow258)) : 250.0f)) : (iSlow252 ? ((150.0f * fSlow256) + 250.0f) : 400.0f)) : (iSlow250 ? (400.0f - fSlow254) : 350.0f)) : (iSlow248 ? ((310.0f * fSlow251) + 350.0f) : 660.0f)) : (iSlow246 ? (660.0f - (220.0f * fSlow249)) : 440.0f)) : (iSlow244 ? (440.0f - (170.0f * fSlow247)) : 270.0f)) : (iSlow242 ? ((160.0f * fSlow245) + 270.0f) : 430.0f)) : (iSlow240 ? (430.0f - (60.0f * fSlow243)) : 370.0f)) : (iSlow238 ? ((430.0f * fSlow241) + 370.0f) : 800.0f)) : (iSlow235 ? (800.0f - (450.0f * fSlow239)) : 350.0f)) : (iSlow233 ? (350.0f - fSlow237) : 270.0f)) : (iSlow231 ? ((180.0f * fSlow234) + 270.0f) : 450.0f)) : (iSlow229 ? (450.0f - (125.0f * fSlow232)) : 325.0f)) : (iSlow227 ? (325.0f * (fSlow230 + 1.0f)) : 650.0f)) : (iSlow225 ? (650.0f - (250.0f * fSlow228)) : 400.0f)) : (iSlow223 ? (400.0f - (110.0f * fSlow226)) : 290.0f)) : (iSlow220 ? ((110.0f * fSlow224) + 290.0f) : 400.0f)) : (iSlow221 ? (400.0f - (50.0f * fSlow222)) : 350.0f));
		float fSlow270 = (20.0f * fSlow228);
		float fSlow271 = (20.0f * fSlow239);
		float fSlow272 = (10.0f * fSlow249);
		float fSlow273 = (10.0f * fSlow261);
		float fSlow274 = (20.0f * fSlow263);
		float fSlow275 = (20.0f * fSlow265);
		float fSlow276 = (20.0f * fSlow219);
		float fSlow277 = (iSlow220 ? (iSlow223 ? (iSlow225 ? (iSlow227 ? (iSlow229 ? (iSlow231 ? (iSlow233 ? (iSlow235 ? (iSlow238 ? (iSlow240 ? (iSlow242 ? (iSlow244 ? (iSlow246 ? (iSlow248 ? (iSlow250 ? (iSlow252 ? (iSlow255 ? (iSlow257 ? (iSlow259 ? (iSlow260 ? (iSlow262 ? (iSlow264 ? (iSlow266 ? (iSlow268 ? 80.0f : (iSlow266 ? (80.0f - fSlow276) : 60.0f)) : (iSlow264 ? (60.0f - (10.0f * fSlow267)) : 50.0f)) : (iSlow262 ? (fSlow275 + 50.0f) : 70.0f)) : (iSlow260 ? (70.0f - fSlow274) : 50.0f)) : (iSlow259 ? (fSlow273 + 50.0f) : 60.0f)) : (iSlow257 ? (60.0f - (20.0f * fSlow218)) : 40.0f)) : (iSlow255 ? ((20.0f * fSlow258) + 40.0f) : 60.0f)) : (iSlow252 ? (60.0f - (20.0f * fSlow256)) : 40.0f)) : 40.0f) : (iSlow248 ? (40.0f * (fSlow251 + 1.0f)) : 80.0f)) : (iSlow246 ? (80.0f - fSlow272) : 70.0f)) : (iSlow244 ? (70.0f - (30.0f * fSlow247)) : 40.0f)) : 40.0f) : 40.0f) : (iSlow238 ? (40.0f * (fSlow241 + 1.0f)) : 80.0f)) : (iSlow235 ? (80.0f - fSlow271) : 60.0f)) : 60.0f) : (iSlow231 ? (60.0f - (20.0f * fSlow234)) : 40.0f)) : (iSlow229 ? ((10.0f * fSlow232) + 40.0f) : 50.0f)) : 50.0f) : (iSlow225 ? (fSlow270 + 50.0f) : 70.0f)) : (iSlow223 ? (70.0f - (30.0f * fSlow226)) : 40.0f)) : (iSlow220 ? ((30.0f * fSlow224) + 40.0f) : 70.0f)) : (iSlow221 ? (70.0f - (30.0f * fSlow222)) : 40.0f));
		float fSlow278 = (iSlow220 ? (iSlow223 ? (iSlow225 ? (iSlow227 ? (iSlow229 ? (iSlow231 ? (iSlow233 ? (iSlow235 ? (iSlow238 ? (iSlow240 ? (iSlow242 ? (iSlow244 ? (iSlow246 ? (iSlow248 ? (iSlow250 ? (iSlow252 ? (iSlow255 ? (iSlow257 ? (iSlow259 ? (iSlow260 ? (iSlow262 ? (iSlow264 ? (iSlow266 ? (iSlow268 ? 1150.0f : (iSlow266 ? ((450.0f * fSlow219) + 1150.0f) : 1600.0f)) : (iSlow264 ? ((100.0f * fSlow267) + 1600.0f) : 1700.0f)) : (iSlow262 ? (1700.0f - (900.0f * fSlow265)) : 800.0f)) : (iSlow260 ? (800.0f - (100.0f * fSlow263)) : 700.0f)) : (iSlow259 ? ((340.0f * fSlow261) + 700.0f) : 1040.0f)) : (iSlow257 ? ((580.0f * fSlow218) + 1040.0f) : 1620.0f)) : (iSlow255 ? ((130.0f * fSlow258) + 1620.0f) : 1750.0f)) : (iSlow252 ? (1750.0f - (1000.0f * fSlow256)) : 750.0f)) : (iSlow250 ? (750.0f - (150.0f * fSlow253)) : 600.0f)) : (iSlow248 ? ((520.0f * fSlow251) + 600.0f) : 1120.0f)) : (iSlow246 ? ((680.0f * fSlow249) + 1120.0f) : 1800.0f)) : (iSlow244 ? ((50.0f * fSlow247) + 1800.0f) : 1850.0f)) : (iSlow242 ? (1850.0f - (1030.0f * fSlow245)) : 820.0f)) : (iSlow240 ? (820.0f - (190.0f * fSlow243)) : 630.0f)) : (iSlow238 ? ((520.0f * fSlow241) + 630.0f) : 1150.0f)) : (iSlow235 ? ((850.0f * fSlow239) + 1150.0f) : 2000.0f)) : (iSlow233 ? ((140.0f * fSlow236) + 2000.0f) : 2140.0f)) : (iSlow231 ? (2140.0f - (1340.0f * fSlow234)) : 800.0f)) : (iSlow229 ? (800.0f - (100.0f * fSlow232)) : 700.0f)) : (iSlow227 ? ((380.0f * fSlow230) + 700.0f) : 1080.0f)) : (iSlow225 ? ((620.0f * fSlow228) + 1080.0f) : 1700.0f)) : (iSlow223 ? ((170.0f * fSlow226) + 1700.0f) : 1870.0f)) : (iSlow220 ? (1870.0f - (1070.0f * fSlow224)) : 800.0f)) : (iSlow221 ? (800.0f - (200.0f * fSlow222)) : 600.0f));
		int iSlow279 = (fSlow278 >= 1300.0f);
		float fSlow280 = (fSlow278 + -1300.0f);
		float fSlow281 = (10.0f * fSlow224);
		float fSlow282 = (10.0f * fSlow228);
		float fSlow283 = (10.0f * fSlow251);
		float fSlow284 = (10.0f * fSlow218);
		float fSlow285 = (iSlow220 ? (iSlow223 ? (iSlow225 ? (iSlow227 ? (iSlow229 ? (iSlow231 ? (iSlow233 ? (iSlow235 ? (iSlow238 ? (iSlow240 ? (iSlow242 ? (iSlow244 ? (iSlow246 ? (iSlow248 ? (iSlow250 ? (iSlow252 ? (iSlow255 ? (iSlow257 ? (iSlow259 ? (iSlow260 ? (iSlow262 ? (iSlow264 ? (iSlow266 ? (iSlow268 ? 90.0f : (iSlow266 ? (90.0f - (10.0f * fSlow219)) : 80.0f)) : (iSlow264 ? ((20.0f * fSlow267) + 80.0f) : 100.0f)) : (iSlow262 ? (100.0f - fSlow275) : 80.0f)) : (iSlow260 ? (80.0f - fSlow274) : 60.0f)) : (iSlow259 ? (fSlow273 + 60.0f) : 70.0f)) : (iSlow257 ? (fSlow284 + 70.0f) : 80.0f)) : (iSlow255 ? ((10.0f * fSlow258) + 80.0f) : 90.0f)) : (iSlow252 ? (90.0f - (10.0f * fSlow256)) : 80.0f)) : 80.0f) : (iSlow248 ? (fSlow283 + 80.0f) : 90.0f)) : (iSlow246 ? (90.0f - fSlow272) : 80.0f)) : (iSlow244 ? ((10.0f * fSlow247) + 80.0f) : 90.0f)) : (iSlow242 ? (90.0f - (10.0f * fSlow245)) : 80.0f)) : (iSlow240 ? (80.0f - (20.0f * fSlow243)) : 60.0f)) : (iSlow238 ? ((30.0f * fSlow241) + 60.0f) : 90.0f)) : (iSlow235 ? ((10.0f * fSlow239) + 90.0f) : 100.0f)) : (iSlow233 ? (100.0f - (10.0f * fSlow236)) : 90.0f)) : (iSlow231 ? (90.0f - (10.0f * fSlow234)) : 80.0f)) : (iSlow229 ? (80.0f - (20.0f * fSlow232)) : 60.0f)) : (iSlow227 ? ((30.0f * fSlow230) + 60.0f) : 90.0f)) : (iSlow225 ? (90.0f - fSlow282) : 80.0f)) : (iSlow223 ? ((10.0f * fSlow226) + 80.0f) : 90.0f)) : (iSlow220 ? (90.0f - fSlow281) : 80.0f)) : (iSlow221 ? (80.0f - (20.0f * fSlow222)) : 60.0f));
		float fSlow286 = (iSlow220 ? (iSlow223 ? (iSlow225 ? (iSlow227 ? (iSlow229 ? (iSlow231 ? (iSlow233 ? (iSlow235 ? (iSlow238 ? (iSlow240 ? (iSlow242 ? (iSlow244 ? (iSlow246 ? (iSlow248 ? (iSlow250 ? (iSlow252 ? (iSlow255 ? (iSlow257 ? (iSlow259 ? (iSlow260 ? (iSlow262 ? (iSlow264 ? (iSlow266 ? (iSlow268 ? 0.630957007f : (iSlow266 ? (0.630957007f - (0.567861021f * fSlow219)) : 0.0630960017f)) : (iSlow264 ? ((0.0369039997f * fSlow267) + 0.0630960017f) : 0.100000001f)) : (iSlow262 ? ((0.254812986f * fSlow265) + 0.100000001f) : 0.35481301f)) : (iSlow260 ? (0.35481301f - (0.103624001f * fSlow263)) : 0.251188993f)) : (iSlow259 ? ((0.195494995f * fSlow261) + 0.251188993f) : 0.446684003f)) : (iSlow257 ? (0.446684003f - (0.195494995f * fSlow218)) : 0.251188993f)) : (iSlow255 ? (0.251188993f - (0.219566002f * fSlow258)) : 0.0316229984f)) : (iSlow252 ? ((0.250214994f * fSlow256) + 0.0316229984f) : 0.281838f)) : (iSlow250 ? (0.281838f - (0.181838006f * fSlow253)) : 0.100000001f)) : (iSlow248 ? ((0.401187003f * fSlow251) + 0.100000001f) : 0.501187027f)) : (iSlow246 ? (0.501187027f - (0.301661015f * fSlow249)) : 0.199525997f)) : (iSlow244 ? (0.199525997f - (0.136429995f * fSlow247)) : 0.0630960017f)) : (iSlow242 ? ((0.253131986f * fSlow245) + 0.0630960017f) : 0.316228002f)) : (iSlow240 ? (0.316228002f - (0.216227993f * fSlow243)) : 0.100000001f)) : (iSlow238 ? ((0.401187003f * fSlow241) + 0.100000001f) : 0.501187027f)) : (iSlow235 ? (0.501187027f - (0.401187003f * fSlow239)) : 0.100000001f)) : (iSlow233 ? ((0.151188999f * fSlow236) + 0.100000001f) : 0.251188993f)) : (iSlow231 ? ((0.0306490008f * fSlow234) + 0.251188993f) : 0.281838f)) : (iSlow229 ? (0.281838f - (0.123349003f * fSlow232)) : 0.158489004f)) : (iSlow227 ? ((0.342698008f * fSlow230) + 0.158489004f) : 0.501187027f)) : (iSlow225 ? (0.501187027f - (0.301661015f * fSlow228)) : 0.199525997f)) : (iSlow223 ? (0.199525997f - (0.0216979999f * fSlow226)) : 0.177827999f)) : (iSlow220 ? ((0.138400003f * fSlow224) + 0.177827999f) : 0.316228002f)) : (iSlow221 ? (0.316228002f - (0.216227993f * fSlow222)) : 0.100000001f));
		float fSlow287 = (100.0f * fSlow222);
		float fSlow288 = (50.0f * fSlow230);
		float fSlow289 = (50.0f * fSlow249);
		float fSlow290 = (iSlow220 ? (iSlow223 ? (iSlow225 ? (iSlow227 ? (iSlow229 ? (iSlow231 ? (iSlow233 ? (iSlow235 ? (iSlow238 ? (iSlow240 ? (iSlow242 ? (iSlow244 ? (iSlow246 ? (iSlow248 ? (iSlow250 ? (iSlow252 ? (iSlow255 ? (iSlow257 ? (iSlow259 ? (iSlow260 ? (iSlow262 ? (iSlow264 ? (iSlow266 ? (iSlow268 ? 2800.0f : (iSlow266 ? (2800.0f - (100.0f * fSlow219)) : 2700.0f)) : 2700.0f) : (iSlow262 ? ((130.0f * fSlow265) + 2700.0f) : 2830.0f)) : (iSlow260 ? (2830.0f - (300.0f * fSlow263)) : 2530.0f)) : (iSlow259 ? (2530.0f - (280.0f * fSlow261)) : 2250.0f)) : (iSlow257 ? ((150.0f * fSlow218) + 2250.0f) : 2400.0f)) : (iSlow255 ? ((200.0f * fSlow258) + 2400.0f) : 2600.0f)) : (iSlow252 ? (2600.0f - (200.0f * fSlow256)) : 2400.0f)) : 2400.0f) : (iSlow248 ? ((350.0f * fSlow251) + 2400.0f) : 2750.0f)) : (iSlow246 ? (2750.0f - fSlow289) : 2700.0f)) : (iSlow244 ? ((200.0f * fSlow247) + 2700.0f) : 2900.0f)) : (iSlow242 ? (2900.0f - (200.0f * fSlow245)) : 2700.0f)) : (iSlow240 ? ((50.0f * fSlow243) + 2700.0f) : 2750.0f)) : (iSlow238 ? ((150.0f * fSlow241) + 2750.0f) : 2900.0f)) : (iSlow235 ? (2900.0f - (100.0f * fSlow239)) : 2800.0f)) : (iSlow233 ? ((150.0f * fSlow236) + 2800.0f) : 2950.0f)) : (iSlow231 ? (2950.0f - (120.0f * fSlow234)) : 2830.0f)) : (iSlow229 ? (2830.0f - (130.0f * fSlow232)) : 2700.0f)) : (iSlow227 ? (2700.0f - fSlow288) : 2650.0f)) : (iSlow225 ? (2650.0f - (50.0f * fSlow228)) : 2600.0f)) : (iSlow223 ? ((200.0f * fSlow226) + 2600.0f) : 2800.0f)) : (iSlow220 ? (2800.0f - (200.0f * fSlow224)) : 2600.0f)) : (iSlow221 ? (fSlow287 + 2600.0f) : 2700.0f));
		float fSlow291 = std::tan((fConst18 * fSlow290));
		float fSlow292 = (1.0f / fSlow291);
		float fSlow293 = (20.0f * fSlow241);
		float fSlow294 = (20.0f * fSlow249);
		float fSlow295 = (20.0f * fSlow251);
		float fSlow296 = (60.0f * fSlow261);
		float fSlow297 = ((iSlow220 ? (iSlow223 ? (iSlow225 ? (iSlow227 ? (iSlow229 ? (iSlow231 ? (iSlow233 ? (iSlow235 ? (iSlow238 ? (iSlow240 ? (iSlow242 ? (iSlow244 ? (iSlow246 ? (iSlow248 ? (iSlow250 ? (iSlow252 ? (iSlow255 ? (iSlow257 ? (iSlow259 ? (iSlow260 ? (iSlow262 ? (iSlow264 ? 120.0f : (iSlow262 ? (120.0f - fSlow275) : 100.0f)) : (iSlow260 ? ((70.0f * fSlow263) + 100.0f) : 170.0f)) : (iSlow259 ? (170.0f - fSlow296) : 110.0f)) : (iSlow257 ? (110.0f - fSlow284) : 100.0f)) : 100.0f) : 100.0f) : 100.0f) : (iSlow248 ? (fSlow295 + 100.0f) : 120.0f)) : (iSlow246 ? (120.0f - fSlow294) : 100.0f)) : 100.0f) : 100.0f) : 100.0f) : (iSlow238 ? (fSlow293 + 100.0f) : 120.0f)) : 120.0f) : (iSlow233 ? (120.0f - (20.0f * fSlow236)) : 100.0f)) : 100.0f) : (iSlow229 ? ((70.0f * fSlow232) + 100.0f) : 170.0f)) : (iSlow227 ? (170.0f - fSlow288) : 120.0f)) : (iSlow225 ? (120.0f - fSlow270) : 100.0f)) : 100.0f) : 100.0f) : 100.0f) / fSlow290);
		float fSlow298 = (((fSlow292 - fSlow297) / fSlow291) + 1.0f);
		float fSlow299 = (1.0f - (1.0f / mydsp_faustpower2_f(fSlow291)));
		float fSlow300 = (((fSlow292 + fSlow297) / fSlow291) + 1.0f);
		float fSlow301 = (iSlow231 ? ((0.0293140002f * fSlow234) + 0.0501190014f) : 0.0794330016f);
		float fSlow302 = (iSlow220 ? (iSlow223 ? (iSlow225 ? (iSlow227 ? (iSlow229 ? (iSlow231 ? (iSlow233 ? (iSlow235 ? (iSlow238 ? (iSlow240 ? (iSlow242 ? (iSlow244 ? (iSlow246 ? (iSlow248 ? (iSlow250 ? (iSlow252 ? (iSlow255 ? (iSlow257 ? (iSlow259 ? (iSlow260 ? (iSlow262 ? (iSlow264 ? (iSlow266 ? (iSlow268 ? 0.100000001f : (iSlow266 ? (0.100000001f - (0.0683770031f * fSlow219)) : 0.0316229984f)) : 0.0316229984f) : (iSlow262 ? ((0.126865998f * fSlow265) + 0.0316229984f) : 0.158489004f)) : (iSlow260 ? (0.158489004f - (0.126865998f * fSlow263)) : 0.0316229984f)) : (iSlow259 ? ((0.323190004f * fSlow261) + 0.0316229984f) : 0.35481301f)) : 0.35481301f) : (iSlow255 ? (0.35481301f - (0.196324006f * fSlow258)) : 0.158489004f)) : (iSlow252 ? (0.158489004f - (0.0693639964f * fSlow256)) : 0.0891249999f)) : (iSlow250 ? (0.0891249999f - (0.0640060008f * fSlow253)) : 0.0251189992f)) : (iSlow248 ? ((0.0456760004f * fSlow251) + 0.0251189992f) : 0.0707949996f)) : (iSlow246 ? ((0.0550980009f * fSlow249) + 0.0707949996f) : 0.125892997f)) : (iSlow244 ? (0.125892997f - (0.0627970025f * fSlow247)) : 0.0630960017f)) : (iSlow242 ? (0.0630960017f - (0.0129770003f * fSlow245)) : 0.0501190014f)) : (iSlow240 ? ((0.020676f * fSlow243) + 0.0501190014f) : 0.0707949996f)) : (iSlow238 ? (0.0707949996f - (0.0456760004f * fSlow241)) : 0.0251189992f)) : (iSlow235 ? ((0.152709007f * fSlow239) + 0.0251189992f) : 0.177827999f)) : (iSlow233 ? (0.177827999f - (0.127709001f * fSlow236)) : 0.0501190014f)) : fSlow301) : (iSlow229 ? (0.0794330016f - (0.0616500005f * fSlow232)) : 0.0177829992f)) : (iSlow227 ? ((0.428900987f * fSlow230) + 0.0177829992f) : 0.446684003f)) : (iSlow225 ? (0.446684003f - (0.195494995f * fSlow228)) : 0.251188993f)) : (iSlow223 ? (0.251188993f - (0.125295997f * fSlow226)) : 0.125892997f)) : (iSlow220 ? ((0.125295997f * fSlow224) + 0.125892997f) : 0.251188993f)) : (iSlow221 ? (0.251188993f - (0.109935001f * fSlow222)) : 0.141253993f));
		float fSlow303 = (fSlow291 * fSlow300);
		float fSlow304 = (350.0f * fSlow218);
		float fSlow305 = (iSlow220 ? (iSlow223 ? (iSlow225 ? (iSlow227 ? (iSlow229 ? (iSlow231 ? (iSlow233 ? (iSlow235 ? (iSlow238 ? (iSlow240 ? (iSlow242 ? (iSlow244 ? (iSlow246 ? (iSlow248 ? (iSlow250 ? (iSlow252 ? (iSlow255 ? (iSlow257 ? (iSlow259 ? (iSlow260 ? (iSlow262 ? (iSlow264 ? (iSlow266 ? (iSlow268 ? 3500.0f : (iSlow266 ? (3500.0f - (200.0f * fSlow219)) : 3300.0f)) : (iSlow264 ? ((400.0f * fSlow267) + 3300.0f) : 3700.0f)) : (iSlow262 ? (3700.0f - (200.0f * fSlow265)) : 3500.0f)) : 3500.0f) : (iSlow259 ? (3500.0f - (1050.0f * fSlow261)) : 2450.0f)) : (iSlow257 ? (fSlow304 + 2450.0f) : 2800.0f)) : (iSlow255 ? ((250.0f * fSlow258) + 2800.0f) : 3050.0f)) : (iSlow252 ? (3050.0f - (450.0f * fSlow256)) : 2600.0f)) : (iSlow250 ? ((75.0f * fSlow253) + 2600.0f) : 2675.0f)) : (iSlow248 ? ((325.0f * fSlow251) + 2675.0f) : 3000.0f)) : 3000.0f) : (iSlow244 ? ((350.0f * fSlow247) + 3000.0f) : 3350.0f)) : (iSlow242 ? (3350.0f - (350.0f * fSlow245)) : 3000.0f)) : 3000.0f) : (iSlow238 ? ((900.0f * fSlow241) + 3000.0f) : 3900.0f)) : (iSlow235 ? (3900.0f - (300.0f * fSlow239)) : 3600.0f)) : (iSlow233 ? ((300.0f * fSlow236) + 3600.0f) : 3900.0f)) : (iSlow231 ? (3900.0f - (100.0f * fSlow234)) : 3800.0f)) : 3800.0f) : (iSlow227 ? (3800.0f - (900.0f * fSlow230)) : 2900.0f)) : (iSlow225 ? ((300.0f * fSlow228) + 2900.0f) : 3200.0f)) : (iSlow223 ? ((50.0f * fSlow226) + 3200.0f) : 3250.0f)) : (iSlow220 ? (3250.0f - (450.0f * fSlow224)) : 2800.0f)) : (iSlow221 ? (fSlow287 + 2800.0f) : 2900.0f));
		float fSlow306 = std::tan((fConst18 * fSlow305));
		float fSlow307 = (1.0f / fSlow306);
		float fSlow308 = ((iSlow220 ? (iSlow223 ? (iSlow225 ? (iSlow227 ? (iSlow229 ? (iSlow231 ? (iSlow233 ? (iSlow235 ? (iSlow238 ? (iSlow240 ? (iSlow242 ? (iSlow244 ? (iSlow246 ? (iSlow248 ? (iSlow250 ? (iSlow252 ? (iSlow255 ? (iSlow257 ? (iSlow259 ? (iSlow260 ? (iSlow262 ? (iSlow264 ? (iSlow266 ? (iSlow268 ? 130.0f : (iSlow266 ? (fSlow276 + 130.0f) : 150.0f)) : 150.0f) : (iSlow262 ? (150.0f - fSlow275) : 130.0f)) : (iSlow260 ? ((50.0f * fSlow263) + 130.0f) : 180.0f)) : (iSlow259 ? (180.0f - fSlow296) : 120.0f)) : 120.0f) : 120.0f) : 120.0f) : 120.0f) : (iSlow248 ? (fSlow283 + 120.0f) : 130.0f)) : (iSlow246 ? (130.0f - fSlow272) : 120.0f)) : 120.0f) : 120.0f) : 120.0f) : (iSlow238 ? ((10.0f * fSlow241) + 120.0f) : 130.0f)) : (iSlow235 ? (fSlow271 + 130.0f) : 150.0f)) : (iSlow233 ? (150.0f - (30.0f * fSlow236)) : 120.0f)) : 120.0f) : (iSlow229 ? ((60.0f * fSlow232) + 120.0f) : 180.0f)) : (iSlow227 ? (180.0f - fSlow288) : 130.0f)) : (iSlow225 ? (130.0f - fSlow282) : 120.0f)) : 120.0f) : (iSlow220 ? (fSlow281 + 120.0f) : 130.0f)) : (iSlow221 ? (130.0f - (10.0f * fSlow222)) : 120.0f)) / fSlow305);
		float fSlow309 = (((fSlow307 - fSlow308) / fSlow306) + 1.0f);
		float fSlow310 = (1.0f - (1.0f / mydsp_faustpower2_f(fSlow306)));
		float fSlow311 = (((fSlow307 + fSlow308) / fSlow306) + 1.0f);
		float fSlow312 = (iSlow244 ? (0.100000001f - (0.0841509998f * fSlow247)) : 0.0158489998f);
		float fSlow313 = (iSlow220 ? (iSlow223 ? (iSlow225 ? (iSlow227 ? (iSlow229 ? (iSlow231 ? (iSlow233 ? (iSlow235 ? (iSlow238 ? (iSlow240 ? (iSlow242 ? (iSlow244 ? (iSlow246 ? (iSlow248 ? (iSlow250 ? (iSlow252 ? (iSlow255 ? (iSlow257 ? (iSlow259 ? (iSlow260 ? (iSlow262 ? (iSlow264 ? (iSlow266 ? (iSlow268 ? 0.0158489998f : (iSlow266 ? ((0.00193400006f * fSlow219) + 0.0158489998f) : 0.0177829992f)) : (iSlow264 ? (0.0177829992f - (0.00193400006f * fSlow267)) : 0.0158489998f)) : (iSlow262 ? ((0.0239620004f * fSlow265) + 0.0158489998f) : 0.0398110002f)) : (iSlow260 ? (0.0398110002f - (0.0298110005f * fSlow263)) : 0.00999999978f)) : (iSlow259 ? ((0.344812989f * fSlow261) + 0.00999999978f) : 0.35481301f)) : (iSlow257 ? (0.35481301f - (0.103624001f * fSlow218)) : 0.251188993f)) : (iSlow255 ? (0.251188993f - (0.171755999f * fSlow258)) : 0.0794330016f)) : (iSlow252 ? ((0.0205669999f * fSlow256) + 0.0794330016f) : 0.100000001f)) : (iSlow250 ? (0.100000001f - (0.0601890013f * fSlow253)) : 0.0398110002f)) : (iSlow248 ? ((0.0232849997f * fSlow251) + 0.0398110002f) : 0.0630960017f)) : (iSlow246 ? ((0.0369039997f * fSlow249) + 0.0630960017f) : 0.100000001f)) : fSlow312) : (iSlow242 ? ((0.0635839999f * fSlow245) + 0.0158489998f) : 0.0794330016f)) : (iSlow240 ? (0.0794330016f - (0.0478099994f * fSlow243)) : 0.0316229984f)) : (iSlow238 ? ((0.0683770031f * fSlow241) + 0.0316229984f) : 0.100000001f)) : (iSlow235 ? (0.100000001f - (0.0900000036f * fSlow239)) : 0.00999999978f)) : (iSlow233 ? ((0.0401189998f * fSlow236) + 0.00999999978f) : 0.0501190014f)) : fSlow301) : (iSlow229 ? (0.0794330016f - (0.0694330037f * fSlow232)) : 0.00999999978f)) : (iSlow227 ? ((0.388107002f * fSlow230) + 0.00999999978f) : 0.398106992f)) : (iSlow225 ? (0.398106992f - (0.198580995f * fSlow228)) : 0.199525997f)) : (iSlow223 ? (0.199525997f - (0.099526003f * fSlow226)) : 0.100000001f)) : (iSlow220 ? ((0.151188999f * fSlow224) + 0.100000001f) : 0.251188993f)) : (iSlow221 ? (0.251188993f - (0.0516630001f * fSlow222)) : 0.199525997f));
		float fSlow314 = (fSlow306 * fSlow311);
		float fSlow315 = (iSlow220 ? (iSlow223 ? (iSlow225 ? (iSlow227 ? (iSlow229 ? (iSlow231 ? (iSlow233 ? (iSlow235 ? (iSlow238 ? (iSlow240 ? (iSlow242 ? (iSlow244 ? (iSlow246 ? (iSlow248 ? (iSlow250 ? (iSlow252 ? (iSlow255 ? (iSlow257 ? (iSlow259 ? (iSlow260 ? 4950.0f : (iSlow259 ? (4950.0f - (2200.0f * fSlow261)) : 2750.0f)) : (iSlow257 ? (fSlow304 + 2750.0f) : 3100.0f)) : (iSlow255 ? ((240.0f * fSlow258) + 3100.0f) : 3340.0f)) : (iSlow252 ? (3340.0f - (440.0f * fSlow256)) : 2900.0f)) : (iSlow250 ? (fSlow254 + 2900.0f) : 2950.0f)) : (iSlow248 ? ((400.0f * fSlow251) + 2950.0f) : 3350.0f)) : (iSlow246 ? (3350.0f - fSlow289) : 3300.0f)) : (iSlow244 ? ((290.0f * fSlow247) + 3300.0f) : 3590.0f)) : (iSlow242 ? (3590.0f - (290.0f * fSlow245)) : 3300.0f)) : (iSlow240 ? ((100.0f * fSlow243) + 3300.0f) : 3400.0f)) : (iSlow238 ? ((1550.0f * fSlow241) + 3400.0f) : 4950.0f)) : 4950.0f) : 4950.0f) : 4950.0f) : 4950.0f) : (iSlow227 ? (4950.0f - (1700.0f * fSlow230)) : 3250.0f)) : (iSlow225 ? ((330.0f * fSlow228) + 3250.0f) : 3580.0f)) : (iSlow223 ? (3580.0f - (40.0f * fSlow226)) : 3540.0f)) : (iSlow220 ? (3540.0f - (540.0f * fSlow224)) : 3000.0f)) : (iSlow221 ? ((300.0f * fSlow222) + 3000.0f) : 3300.0f));
		float fSlow316 = std::tan((fConst18 * fSlow315));
		float fSlow317 = (1.0f / fSlow316);
		float fSlow318 = ((iSlow220 ? (iSlow223 ? (iSlow225 ? (iSlow227 ? (iSlow229 ? (iSlow231 ? (iSlow233 ? (iSlow235 ? (iSlow238 ? (iSlow240 ? (iSlow242 ? (iSlow244 ? (iSlow246 ? (iSlow248 ? (iSlow250 ? (iSlow252 ? (iSlow255 ? (iSlow257 ? (iSlow259 ? (iSlow260 ? (iSlow262 ? (iSlow264 ? (iSlow266 ? (iSlow268 ? 140.0f : (iSlow266 ? ((60.0f * fSlow219) + 140.0f) : 200.0f)) : 200.0f) : (iSlow262 ? (200.0f - (65.0f * fSlow265)) : 135.0f)) : (iSlow260 ? ((65.0f * fSlow263) + 135.0f) : 200.0f)) : (iSlow259 ? (200.0f - (70.0f * fSlow261)) : 130.0f)) : (iSlow257 ? (130.0f - fSlow284) : 120.0f)) : 120.0f) : 120.0f) : 120.0f) : (iSlow248 ? (fSlow295 + 120.0f) : 140.0f)) : (iSlow246 ? (140.0f - fSlow294) : 120.0f)) : 120.0f) : 120.0f) : 120.0f) : (iSlow238 ? (fSlow293 + 120.0f) : 140.0f)) : (iSlow235 ? ((60.0f * fSlow239) + 140.0f) : 200.0f)) : (iSlow233 ? (200.0f - fSlow237) : 120.0f)) : 120.0f) : (iSlow229 ? ((80.0f * fSlow232) + 120.0f) : 200.0f)) : (iSlow227 ? (200.0f - (60.0f * fSlow230)) : 140.0f)) : (iSlow225 ? (140.0f - fSlow270) : 120.0f)) : 120.0f) : (iSlow220 ? ((15.0f * fSlow224) + 120.0f) : 135.0f)) : (iSlow221 ? (135.0f - (15.0f * fSlow222)) : 120.0f)) / fSlow315);
		float fSlow319 = (((fSlow317 - fSlow318) / fSlow316) + 1.0f);
		float fSlow320 = (1.0f - (1.0f / mydsp_faustpower2_f(fSlow316)));
		float fSlow321 = (((fSlow317 + fSlow318) / fSlow316) + 1.0f);
		float fSlow322 = (iSlow220 ? (iSlow223 ? (iSlow225 ? (iSlow227 ? (iSlow229 ? (iSlow231 ? (iSlow233 ? (iSlow235 ? (iSlow238 ? (iSlow240 ? (iSlow242 ? (iSlow244 ? (iSlow246 ? (iSlow248 ? (iSlow250 ? (iSlow252 ? (iSlow255 ? (iSlow257 ? (iSlow259 ? (iSlow260 ? (iSlow262 ? (iSlow264 ? 0.00100000005f : (iSlow262 ? ((0.000777999987f * fSlow265) + 0.00100000005f) : 0.00177800003f)) : (iSlow260 ? (0.00177800003f - (0.001147f * fSlow263)) : 0.000630999974f)) : (iSlow259 ? ((0.0993689969f * fSlow261) + 0.000630999974f) : 0.100000001f)) : (iSlow257 ? ((0.0258930009f * fSlow218) + 0.100000001f) : 0.125892997f)) : (iSlow255 ? (0.125892997f - (0.0860819966f * fSlow258)) : 0.0398110002f)) : (iSlow252 ? (0.0398110002f - (0.0298110005f * fSlow256)) : 0.00999999978f)) : (iSlow250 ? ((0.00584900007f * fSlow253) + 0.00999999978f) : 0.0158489998f)) : (iSlow248 ? (0.0158489998f - (0.00325999991f * fSlow251)) : 0.0125890002f)) : (iSlow246 ? ((0.0874110013f * fSlow249) + 0.0125890002f) : 0.100000001f)) : fSlow312) : (iSlow242 ? ((0.00410400005f * fSlow245) + 0.0158489998f) : 0.0199529994f)) : 0.0199529994f) : (iSlow238 ? (0.0199529994f - (0.0167909991f * fSlow241)) : 0.0031620001f)) : (iSlow235 ? (0.0031620001f - (0.00157700002f * fSlow239)) : 0.00158499996f)) : (iSlow233 ? ((0.00472499989f * fSlow236) + 0.00158499996f) : 0.00631000008f)) : (iSlow231 ? (0.00631000008f - (0.00314799999f * fSlow234)) : 0.0031620001f)) : (iSlow229 ? (0.0031620001f - (0.00216199993f * fSlow232)) : 0.00100000005f)) : (iSlow227 ? ((0.0784329996f * fSlow230) + 0.00100000005f) : 0.0794330016f)) : (iSlow225 ? ((0.0205669999f * fSlow228) + 0.0794330016f) : 0.100000001f)) : (iSlow223 ? (0.100000001f - (0.0683770031f * fSlow226)) : 0.0316229984f)) : (iSlow220 ? ((0.0184959993f * fSlow224) + 0.0316229984f) : 0.0501190014f)) : 0.0501190014f);
		float fSlow323 = (fSlow316 * fSlow321);
		float fSlow324 = (fConst31 * ((1.0f / float(fHslider69)) + -1.0f));
		float fSlow325 = float(fHslider70);
		int iSlow326 = (std::fabs(fSlow325) < 1.1920929e-07f);
		float fSlow327 = (iSlow326 ? 0.0f : std::exp((0.0f - (fConst29 / (iSlow326 ? 1.0f : fSlow325)))));
		float fSlow328 = float(fHslider71);
		int iSlow329 = (std::fabs(fSlow328) < 1.1920929e-07f);
		float fSlow330 = (iSlow329 ? 0.0f : std::exp((0.0f - (fConst29 / (iSlow329 ? 1.0f : fSlow328)))));
		float fSlow331 = (1.0f - fSlow330);
		float fSlow332 = (1.0f - fSlow327);
		float fSlow333 = float(fHslider72);
		float fSlow334 = (1.0f / float(fHslider73));
		float fSlow335 = std::tan((fConst18 * float(fHslider74)));
		float fSlow336 = (1.0f / fSlow335);
		float fSlow337 = (1.0f / (((fSlow334 + fSlow336) / fSlow335) + 1.0f));
		float fSlow338 = (((fSlow336 - fSlow334) / fSlow335) + 1.0f);
		float fSlow339 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow335))));
		float fSlow340 = (1.0f / fSlow213);
		float fSlow341 = float(fHslider75);
		int iSlow342 = (fSlow341 > 0.0f);
		float fSlow343 = (float(fHslider76) * std::sin((fConst32 * fSlow212)));
		float fSlow344 = (fConst18 * ((fSlow212 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow341)))) / fSlow343));
		float fSlow345 = (fConst18 * (fSlow212 / fSlow343));
		float fSlow346 = (iSlow342 ? fSlow345 : fSlow344);
		float fSlow347 = ((fSlow340 * (fSlow340 - fSlow346)) + 1.0f);
		float fSlow348 = ((fSlow340 * (fSlow340 + fSlow346)) + 1.0f);
		float fSlow349 = (iSlow342 ? fSlow344 : fSlow345);
		float fSlow350 = ((fSlow340 * (fSlow340 + fSlow349)) + 1.0f);
		float fSlow351 = ((fSlow340 * (fSlow340 - fSlow349)) + 1.0f);
		float fSlow352 = (1.0f / fSlow210);
		float fSlow353 = float(fHslider77);
		int iSlow354 = (fSlow353 > 0.0f);
		float fSlow355 = (float(fHslider78) * std::sin((fConst32 * fSlow209)));
		float fSlow356 = (fConst18 * ((fSlow209 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow353)))) / fSlow355));
		float fSlow357 = (fConst18 * (fSlow209 / fSlow355));
		float fSlow358 = (iSlow354 ? fSlow357 : fSlow356);
		float fSlow359 = ((fSlow352 * (fSlow352 - fSlow358)) + 1.0f);
		float fSlow360 = ((fSlow352 * (fSlow352 + fSlow358)) + 1.0f);
		float fSlow361 = (iSlow354 ? fSlow356 : fSlow357);
		float fSlow362 = ((fSlow352 * (fSlow352 + fSlow361)) + 1.0f);
		float fSlow363 = ((fSlow352 * (fSlow352 - fSlow361)) + 1.0f);
		float fSlow364 = (1.0f / fSlow207);
		float fSlow365 = (((fSlow206 - fSlow204) / fSlow205) + 1.0f);
		float fSlow366 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow205))));
		float fSlow367 = (1.0f / float(fHslider80));
		float fSlow368 = std::tan((fConst18 * float(fHslider81)));
		float fSlow369 = (1.0f / fSlow368);
		float fSlow370 = (((fSlow367 + fSlow369) / fSlow368) + 1.0f);
		float fSlow371 = ((std::pow(10.0f, (0.0500000007f * float(fHslider79))) * (1.0f - float(fCheckbox4))) / fSlow370);
		float fSlow372 = float(fHslider82);
		float fSlow373 = std::tan((fConst18 * fSlow372));
		float fSlow374 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow373))));
		float fSlow375 = float(fHslider83);
		float fSlow376 = std::tan((fConst18 * fSlow375));
		float fSlow377 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow376))));
		float fSlow378 = (fConst111 * float(fHslider84));
		float fSlow379 = float(fHslider85);
		float fSlow380 = float((fSlow379 > 0.0f));
		float fSlow381 = (0.0f - fSlow379);
		float fSlow382 = float(fHslider86);
		float fSlow383 = (0.400000006f * (float(fHslider87) + -0.5f));
		float fSlow384 = (fConst119 * (fSlow383 + 0.270000011f));
		float fSlow385 = (fConst119 * (0.730000019f - fSlow383));
		float fSlow386 = (fConst31 * ((1.0f / float(fHslider88)) + -1.0f));
		float fSlow387 = float(fHslider89);
		int iSlow388 = (std::fabs(fSlow387) < 1.1920929e-07f);
		float fSlow389 = (iSlow388 ? 0.0f : std::exp((0.0f - (fConst29 / (iSlow388 ? 1.0f : fSlow387)))));
		float fSlow390 = float(fHslider90);
		int iSlow391 = (std::fabs(fSlow390) < 1.1920929e-07f);
		float fSlow392 = (iSlow391 ? 0.0f : std::exp((0.0f - (fConst29 / (iSlow391 ? 1.0f : fSlow390)))));
		float fSlow393 = (1.0f - fSlow392);
		float fSlow394 = (1.0f - fSlow389);
		float fSlow395 = float(fHslider91);
		float fSlow396 = (1.0f / float(fHslider92));
		float fSlow397 = std::tan((fConst18 * float(fHslider93)));
		float fSlow398 = (1.0f / fSlow397);
		float fSlow399 = (1.0f / (((fSlow396 + fSlow398) / fSlow397) + 1.0f));
		float fSlow400 = (((fSlow398 - fSlow396) / fSlow397) + 1.0f);
		float fSlow401 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow397))));
		float fSlow402 = (1.0f / fSlow376);
		float fSlow403 = float(fHslider94);
		int iSlow404 = (fSlow403 > 0.0f);
		float fSlow405 = (float(fHslider95) * std::sin((fConst32 * fSlow375)));
		float fSlow406 = (fConst18 * ((fSlow375 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow403)))) / fSlow405));
		float fSlow407 = (fConst18 * (fSlow375 / fSlow405));
		float fSlow408 = (iSlow404 ? fSlow407 : fSlow406);
		float fSlow409 = ((fSlow402 * (fSlow402 - fSlow408)) + 1.0f);
		float fSlow410 = ((fSlow402 * (fSlow402 + fSlow408)) + 1.0f);
		float fSlow411 = (iSlow404 ? fSlow406 : fSlow407);
		float fSlow412 = ((fSlow402 * (fSlow402 + fSlow411)) + 1.0f);
		float fSlow413 = ((fSlow402 * (fSlow402 - fSlow411)) + 1.0f);
		float fSlow414 = (1.0f / fSlow373);
		float fSlow415 = float(fHslider96);
		int iSlow416 = (fSlow415 > 0.0f);
		float fSlow417 = (float(fHslider97) * std::sin((fConst32 * fSlow372)));
		float fSlow418 = (fConst18 * ((fSlow372 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow415)))) / fSlow417));
		float fSlow419 = (fConst18 * (fSlow372 / fSlow417));
		float fSlow420 = (iSlow416 ? fSlow419 : fSlow418);
		float fSlow421 = ((fSlow414 * (fSlow414 - fSlow420)) + 1.0f);
		float fSlow422 = ((fSlow414 * (fSlow414 + fSlow420)) + 1.0f);
		float fSlow423 = (iSlow416 ? fSlow418 : fSlow419);
		float fSlow424 = ((fSlow414 * (fSlow414 + fSlow423)) + 1.0f);
		float fSlow425 = ((fSlow414 * (fSlow414 - fSlow423)) + 1.0f);
		float fSlow426 = (1.0f / fSlow370);
		float fSlow427 = (((fSlow369 - fSlow367) / fSlow368) + 1.0f);
		float fSlow428 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow368))));
		float fSlow429 = (1.0f / float(fHslider99));
		float fSlow430 = std::tan((fConst18 * float(fHslider100)));
		float fSlow431 = (1.0f / fSlow430);
		float fSlow432 = (((fSlow429 + fSlow431) / fSlow430) + 1.0f);
		float fSlow433 = ((std::pow(10.0f, (0.0500000007f * float(fHslider98))) * (1.0f - float(fCheckbox5))) / fSlow432);
		float fSlow434 = float(fHslider101);
		float fSlow435 = std::tan((fConst18 * fSlow434));
		float fSlow436 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow435))));
		float fSlow437 = float(fHslider102);
		float fSlow438 = std::tan((fConst18 * fSlow437));
		float fSlow439 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow438))));
		float fSlow440 = (0.5f * fSlow16);
		float fSlow441 = (fConst228 * fSlow17);
		float fSlow442 = (27.0f * fSlow17);
		float fSlow443 = (9.0f * fSlow17);
		float fSlow444 = (3.0f * fSlow17);
		float fSlow445 = (fConst31 * ((1.0f / float(fHslider103)) + -1.0f));
		float fSlow446 = float(fHslider104);
		int iSlow447 = (std::fabs(fSlow446) < 1.1920929e-07f);
		float fSlow448 = (iSlow447 ? 0.0f : std::exp((0.0f - (fConst29 / (iSlow447 ? 1.0f : fSlow446)))));
		float fSlow449 = float(fHslider105);
		int iSlow450 = (std::fabs(fSlow449) < 1.1920929e-07f);
		float fSlow451 = (iSlow450 ? 0.0f : std::exp((0.0f - (fConst29 / (iSlow450 ? 1.0f : fSlow449)))));
		float fSlow452 = (1.0f - fSlow451);
		float fSlow453 = (1.0f - fSlow448);
		float fSlow454 = float(fHslider106);
		float fSlow455 = (1.0f / float(fHslider107));
		float fSlow456 = std::tan((fConst18 * float(fHslider108)));
		float fSlow457 = (1.0f / fSlow456);
		float fSlow458 = (1.0f / (((fSlow455 + fSlow457) / fSlow456) + 1.0f));
		float fSlow459 = (((fSlow457 - fSlow455) / fSlow456) + 1.0f);
		float fSlow460 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow456))));
		float fSlow461 = (1.0f / fSlow438);
		float fSlow462 = float(fHslider109);
		int iSlow463 = (fSlow462 > 0.0f);
		float fSlow464 = (float(fHslider110) * std::sin((fConst32 * fSlow437)));
		float fSlow465 = (fConst18 * ((fSlow437 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow462)))) / fSlow464));
		float fSlow466 = (fConst18 * (fSlow437 / fSlow464));
		float fSlow467 = (iSlow463 ? fSlow466 : fSlow465);
		float fSlow468 = ((fSlow461 * (fSlow461 - fSlow467)) + 1.0f);
		float fSlow469 = ((fSlow461 * (fSlow461 + fSlow467)) + 1.0f);
		float fSlow470 = (iSlow463 ? fSlow465 : fSlow466);
		float fSlow471 = ((fSlow461 * (fSlow461 + fSlow470)) + 1.0f);
		float fSlow472 = ((fSlow461 * (fSlow461 - fSlow470)) + 1.0f);
		float fSlow473 = (1.0f / fSlow435);
		float fSlow474 = float(fHslider111);
		int iSlow475 = (fSlow474 > 0.0f);
		float fSlow476 = (float(fHslider112) * std::sin((fConst32 * fSlow434)));
		float fSlow477 = (fConst18 * ((fSlow434 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow474)))) / fSlow476));
		float fSlow478 = (fConst18 * (fSlow434 / fSlow476));
		float fSlow479 = (iSlow475 ? fSlow478 : fSlow477);
		float fSlow480 = ((fSlow473 * (fSlow473 - fSlow479)) + 1.0f);
		float fSlow481 = ((fSlow473 * (fSlow473 + fSlow479)) + 1.0f);
		float fSlow482 = (iSlow475 ? fSlow477 : fSlow478);
		float fSlow483 = ((fSlow473 * (fSlow473 + fSlow482)) + 1.0f);
		float fSlow484 = ((fSlow473 * (fSlow473 - fSlow482)) + 1.0f);
		float fSlow485 = (1.0f / fSlow432);
		float fSlow486 = (((fSlow431 - fSlow429) / fSlow430) + 1.0f);
		float fSlow487 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow430))));
		float fSlow488 = (1.0f / float(fHslider114));
		float fSlow489 = std::tan((fConst18 * float(fHslider115)));
		float fSlow490 = (1.0f / fSlow489);
		float fSlow491 = (((fSlow488 + fSlow490) / fSlow489) + 1.0f);
		float fSlow492 = ((std::pow(10.0f, (0.0500000007f * float(fHslider113))) * (1.0f - float(fCheckbox6))) / fSlow491);
		float fSlow493 = float(fHslider116);
		float fSlow494 = std::tan((fConst18 * fSlow493));
		float fSlow495 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow494))));
		float fSlow496 = float(fHslider117);
		float fSlow497 = std::tan((fConst18 * fSlow496));
		float fSlow498 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow497))));
		float fSlow499 = float(fHslider118);
		float fSlow500 = float((fSlow499 > 0.0f));
		float fSlow501 = (0.0f - fSlow499);
		float fSlow502 = float(fHslider119);
		float fSlow503 = (0.00100000005f * float((fSlow502 > 310.0f)));
		float fSlow504 = (fConst29 * std::max<float>(20.0f, fSlow502));
		float fSlow505 = float(fHslider120);
		float fSlow506 = (0.00100000005f * float((fSlow505 > 610.0f)));
		float fSlow507 = (fConst29 * std::max<float>(20.0f, fSlow505));
		float fSlow508 = float(fHslider121);
		float fSlow509 = (0.00100000005f * float((fSlow508 > 1210.0f)));
		float fSlow510 = (fConst29 * std::max<float>(20.0f, fSlow508));
		float fSlow511 = (fConst31 * ((1.0f / float(fHslider122)) + -1.0f));
		float fSlow512 = float(fHslider123);
		int iSlow513 = (std::fabs(fSlow512) < 1.1920929e-07f);
		float fSlow514 = (iSlow513 ? 0.0f : std::exp((0.0f - (fConst29 / (iSlow513 ? 1.0f : fSlow512)))));
		float fSlow515 = float(fHslider124);
		int iSlow516 = (std::fabs(fSlow515) < 1.1920929e-07f);
		float fSlow517 = (iSlow516 ? 0.0f : std::exp((0.0f - (fConst29 / (iSlow516 ? 1.0f : fSlow515)))));
		float fSlow518 = (1.0f - fSlow517);
		float fSlow519 = (1.0f - fSlow514);
		float fSlow520 = float(fHslider125);
		float fSlow521 = (1.0f / float(fHslider126));
		float fSlow522 = std::tan((fConst18 * float(fHslider127)));
		float fSlow523 = (1.0f / fSlow522);
		float fSlow524 = (1.0f / (((fSlow521 + fSlow523) / fSlow522) + 1.0f));
		float fSlow525 = (((fSlow523 - fSlow521) / fSlow522) + 1.0f);
		float fSlow526 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow522))));
		float fSlow527 = (1.0f / fSlow497);
		float fSlow528 = float(fHslider128);
		int iSlow529 = (fSlow528 > 0.0f);
		float fSlow530 = (float(fHslider129) * std::sin((fConst32 * fSlow496)));
		float fSlow531 = (fConst18 * ((fSlow496 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow528)))) / fSlow530));
		float fSlow532 = (fConst18 * (fSlow496 / fSlow530));
		float fSlow533 = (iSlow529 ? fSlow532 : fSlow531);
		float fSlow534 = ((fSlow527 * (fSlow527 - fSlow533)) + 1.0f);
		float fSlow535 = ((fSlow527 * (fSlow527 + fSlow533)) + 1.0f);
		float fSlow536 = (iSlow529 ? fSlow531 : fSlow532);
		float fSlow537 = ((fSlow527 * (fSlow527 + fSlow536)) + 1.0f);
		float fSlow538 = ((fSlow527 * (fSlow527 - fSlow536)) + 1.0f);
		float fSlow539 = (1.0f / fSlow494);
		float fSlow540 = float(fHslider130);
		int iSlow541 = (fSlow540 > 0.0f);
		float fSlow542 = (float(fHslider131) * std::sin((fConst32 * fSlow493)));
		float fSlow543 = (fConst18 * ((fSlow493 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow540)))) / fSlow542));
		float fSlow544 = (fConst18 * (fSlow493 / fSlow542));
		float fSlow545 = (iSlow541 ? fSlow544 : fSlow543);
		float fSlow546 = ((fSlow539 * (fSlow539 - fSlow545)) + 1.0f);
		float fSlow547 = ((fSlow539 * (fSlow539 + fSlow545)) + 1.0f);
		float fSlow548 = (iSlow541 ? fSlow543 : fSlow544);
		float fSlow549 = ((fSlow539 * (fSlow539 + fSlow548)) + 1.0f);
		float fSlow550 = ((fSlow539 * (fSlow539 - fSlow548)) + 1.0f);
		float fSlow551 = (1.0f / fSlow491);
		float fSlow552 = (((fSlow490 - fSlow488) / fSlow489) + 1.0f);
		float fSlow553 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow489))));
		for (int i = 0; (i < count); i = (i + 1)) {
			iVec0[0] = 1;
			...
			fVec2[0] = fSlow13;
			float fTemp0 = (fSlow13 - fVec2[1]);
			fVec3[0] = fSlow15;
			float fTemp1 = (0.0f - (fSlow13 + fVec3[1]));
			float fTemp2 = std::min<float>(1.0f, ((fTemp0 * float((fTemp0 > 0.0f))) + (fSlow14 * (fTemp1 * float((fTemp1 > 0.0f))))));
			fVec4[0] = fTemp2;
			...
			fRec20[0] = (iTemp6 ? fSlow19 : fRec20[1]);
			...
			fRec25[0] = (iTemp6 ? fSlow20 : fRec25[1]);
			...
			fRec28[0] = (iTemp6 ? fSlow21 : fRec28[1]);
			...
			fRec31[0] = (iTemp6 ? fSlow22 : fRec31[1]);
			...
			float fTemp33 = std::fabs((fSlow12 * fTemp32));
			fRec34[0] = std::max<float>(fTemp33, ((fSlow29 * fRec34[1]) + (fSlow30 * fTemp33)));
			fRec33[0] = ((fSlow26 * fRec33[1]) + (fRec34[0] * fSlow31));
			fRec32[0] = ((fConst30 * fRec32[1]) + (fSlow23 * std::max<float>(((20.0f * std::log10(fRec33[0])) - fSlow32), 0.0f)));
			float fTemp34 = (fSlow12 * (fTemp32 * std::pow(10.0f, (0.0500000007f * fRec32[0]))));
			fRec35[0] = (fTemp34 - (fSlow36 * ((fSlow37 * fRec35[2]) + (fSlow38 * fRec35[1]))));
			float fTemp35 = (fSlow11 * fRec15[1]);
			fRec15[0] = (fTemp34 - ((fSlow36 * (fRec35[2] + (fRec35[0] + (2.0f * fRec35[1])))) + (((fSlow46 * fRec15[2]) + fTemp35) / fSlow47)));
			float fTemp36 = (fSlow8 * fRec14[1]);
			fRec14[0] = ((((fTemp35 + (fRec15[0] * fSlow49)) + (fSlow50 * fRec15[2])) / fSlow47) - (((fSlow58 * fRec14[2]) + fTemp36) / fSlow59));
			fRec13[0] = ((((fTemp36 + (fRec14[0] * fSlow61)) + (fSlow62 * fRec14[2])) / fSlow59) - (fSlow63 * ((fSlow64 * fRec13[2]) + (fSlow65 * fRec13[1]))));
			...
			fRec65[0] = ((0.999000013f * fRec65[1]) + (0.00100000005f * ((fSlow78 * ftbl0mydspSIG0[int((65536.0f * fRec67[0]))]) + 1.0f)));
			fVec5[0] = fSlow79;
			float fTemp38 = (fSlow79 - fVec5[1]);
			fVec6[0] = fSlow81;
			float fTemp39 = (0.0f - (fSlow79 + fVec6[1]));
			float fTemp40 = std::min<float>(1.0f, ((fTemp38 * float((fTemp38 > 0.0f))) + (fSlow80 * (fTemp39 * float((fTemp39 > 0.0f))))));
			fRec68[0] = (int(fTemp40) ? fSlow82 : fRec68[1]);
			float fTemp41 = ((fSlow77 / (fRec65[0] * fRec68[0])) + -0.109999999f);
			...
			fRec69[0] = ((fSlow83 * fRec69[1]) + (fSlow84 * fRec61[1]));
			...
			fVec8[0] = fTemp94;
			fRec70[(IOTA & 2047)] = ((fSlow83 * fRec70[((IOTA - 1) & 2047)]) + (fSlow84 * fVec8[2]));
			...
			fRec40[0] = fRec43;
			float fRec41 = fRec45;
			fRec73[0] = (fSlow85 + (0.999000013f * fRec73[1]));
			...
			fRec76[0] = std::max<float>(fTemp100, ((fRec76[1] * fSlow92) + (fTemp100 * fSlow93)));
			fRec75[0] = ((fRec75[1] * fSlow89) + (fRec76[0] * fSlow94));
			fRec74[0] = ((fConst30 * fRec74[1]) + (fSlow86 * std::max<float>(((20.0f * std::log10(fRec75[0])) - fSlow95), 0.0f)));
			float fTemp101 = (0.25f * ((fTemp99 * std::pow(10.0f, (0.0500000007f * fRec74[0]))) / fTemp98));
			fRec77[0] = (fTemp101 - (fSlow99 * ((fSlow100 * fRec77[2]) + (fSlow101 * fRec77[1]))));
			float fTemp102 = (fSlow76 * fRec38[1]);
			fRec38[0] = (fTemp101 - ((fSlow99 * (fRec77[2] + (fRec77[0] + (2.0f * fRec77[1])))) + (((fRec38[2] * fSlow109) + fTemp102) / fSlow110)));
			float fTemp103 = (fSlow73 * fRec37[1]);
			fRec37[0] = ((((fTemp102 + (fRec38[0] * fSlow112)) + (fRec38[2] * fSlow113)) / fSlow110) - (((fRec37[2] * fSlow121) + fTemp103) / fSlow122));
			fRec36[0] = ((((fTemp103 + (fRec37[0] * fSlow124)) + (fRec37[2] * fSlow125)) / fSlow122) - (fSlow126 * ((fSlow127 * fRec36[2]) + (fSlow128 * fRec36[1]))));
			float fTemp104 = (fSlow70 * (fRec36[2] + (fRec36[0] + (2.0f * fRec36[1]))));
			iRec84[0] = ((1103515245 * iRec84[1]) + 12345);
			float fTemp105 = (4.65661287e-10f * float(iRec84[0]));
			fRec83[0] = (fTemp105 - (fSlow148 * ((fSlow151 * fRec83[2]) + (fSlow152 * fRec83[1]))));
			fRec82[0] = ((fSlow148 * (((fSlow150 * fRec83[0]) + (fSlow153 * fRec83[1])) + (fSlow150 * fRec83[2]))) - (fSlow145 * ((fSlow154 * fRec82[2]) + (fSlow155 * fRec82[1]))));
			fVec9[0] = fSlow157;
			float fTemp106 = (fSlow157 - fVec9[1]);
			fVec10[0] = fSlow159;
			float fTemp107 = (0.0f - (fSlow157 + fVec10[1]));
			float fTemp108 = std::min<float>(1.0f, ((fTemp106 * float((fTemp106 > 0.0f))) + (fSlow158 * (fTemp107 * float((fTemp107 > 0.0f))))));
			fVec11[0] = fTemp108;
			iRec85[0] = (((iRec85[1] + (iRec85[1] > 0)) * (fTemp108 <= fVec11[1])) + (fTemp108 > fVec11[1]));
			float fTemp109 = (fSlow156 * float(iRec85[0]));
			float fTemp110 = (fSlow145 * ((fRec82[2] + (fRec82[0] + (2.0f * fRec82[1]))) * std::max<float>(0.0f, std::min<float>(fTemp109, (2.0f - fTemp109)))));
			fRec86[0] = (int(fTemp108) ? fSlow160 : fRec86[1]);
			...
			float fTemp112 = std::fabs((fSlow141 * fTemp111));
			fRec108[0] = std::max<float>(fTemp112, ((fRec108[1] * fSlow167) + (fTemp112 * fSlow168)));
			fRec107[0] = ((fRec107[1] * fSlow164) + (fRec108[0] * fSlow169));
			fRec106[0] = ((fConst30 * fRec106[1]) + (fSlow161 * std::max<float>(((20.0f * std::log10(fRec107[0])) - fSlow170), 0.0f)));
			float fTemp113 = (fSlow141 * (fTemp111 * std::pow(10.0f, (0.0500000007f * fRec106[0]))));
			fRec109[0] = (fTemp113 - (fSlow174 * ((fSlow175 * fRec109[2]) + (fSlow176 * fRec109[1]))));
			float fTemp114 = (fSlow139 * fRec80[1]);
			fRec80[0] = (fTemp113 - ((fSlow174 * (fRec109[2] + (fRec109[0] + (2.0f * fRec109[1])))) + (((fRec80[2] * fSlow184) + fTemp114) / fSlow185)));
			float fTemp115 = (fSlow136 * fRec79[1]);
			fRec79[0] = ((((fTemp114 + (fRec80[0] * fSlow187)) + (fRec80[2] * fSlow188)) / fSlow185) - (((fRec79[2] * fSlow196) + fTemp115) / fSlow197));
			fRec78[0] = ((((fTemp115 + (fRec79[0] * fSlow199)) + (fRec79[2] * fSlow200)) / fSlow197) - (fSlow201 * ((fSlow202 * fRec78[2]) + (fSlow203 * fRec78[1]))));
			...
			fRec114[0] = ((fConst102 * fRec114[1]) + (fSlow216 * fTemp116));
			fRec116[0] = ((fConst102 * fRec116[1]) + (fSlow217 * (fRec65[0] * fTemp116)));
			...
			float fTemp123 = ((fSlow269 <= fRec116[0]) ? fRec116[0] : fSlow269);
			float fTemp124 = std::tan((fConst18 * fTemp123));
			float fTemp125 = (1.0f / fTemp124);
			float fTemp126 = (fSlow277 / fTemp123);
			...
			float fTemp130 = ((iSlow279 & (fRec116[0] >= 200.0f)) ? (fSlow278 - (0.000952380942f * ((fRec116[0] + -200.0f) * fSlow280))) : ((fSlow278 <= fTemp129) ? fTemp129 : fSlow278));
			float fTemp131 = std::tan((fConst18 * fTemp130));
			float fTemp132 = (1.0f / fTemp131);
			float fTemp133 = (fSlow285 / fTemp130);
			...
			fRec121[0] = (fTemp122 - (((fRec121[2] * fSlow298) + (2.0f * (fRec121[1] * fSlow299))) / fSlow300));
			fRec122[0] = (fTemp122 - (((fRec122[2] * fSlow309) + (2.0f * (fRec122[1] * fSlow310))) / fSlow311));
			fRec123[0] = (fTemp122 - (((fRec123[2] * fSlow319) + (2.0f * (fRec123[1] * fSlow320))) / fSlow321));
			fRec113[0] = ((fRec114[0] * ((fTemp117 * (((((fRec117[0] / fTemp128) + ((fRec120[0] * fSlow286) / fTemp135)) + ((fRec121[0] * fSlow302) / fSlow303)) + ((fRec122[0] * fSlow313) / fSlow314)) + ((fRec123[0] * fSlow322) / fSlow323))) + (((((fRec117[2] * (0.0f - (fTemp117 / fTemp128))) + (fRec120[2] * (0.0f - ((fTemp117 * fSlow286) / fTemp135)))) + (fRec121[2] * (0.0f - ((fTemp117 * fSlow302) / fSlow303)))) + (fRec122[2] * (0.0f - ((fTemp117 * fSlow313) / fSlow314)))) + (fRec123[2] * (0.0f - ((fTemp117 * fSlow322) / fSlow323)))))) - (fConst106 * ((fConst107 * fRec113[2]) + (fConst108 * fRec113[1]))));
			float fTemp136 = (fRec113[2] + (fRec113[0] + (2.0f * fRec113[1])));
			float fTemp137 = std::fabs((fSlow215 * fTemp136));
			fRec126[0] = std::max<float>(fTemp137, ((fRec126[1] * fSlow330) + (fTemp137 * fSlow331)));
			fRec125[0] = ((fRec125[1] * fSlow327) + (fRec126[0] * fSlow332));
			fRec124[0] = ((fConst30 * fRec124[1]) + (fSlow324 * std::max<float>(((20.0f * std::log10(fRec125[0])) - fSlow333), 0.0f)));
			float fTemp138 = (fSlow215 * (fTemp136 * std::pow(10.0f, (0.0500000007f * fRec124[0]))));
			fRec127[0] = (fTemp138 - (fSlow337 * ((fSlow338 * fRec127[2]) + (fSlow339 * fRec127[1]))));
			float fTemp139 = (fSlow214 * fRec112[1]);
			fRec112[0] = (fTemp138 - ((fSlow337 * (fRec127[2] + (fRec127[0] + (2.0f * fRec127[1])))) + (((fRec112[2] * fSlow347) + fTemp139) / fSlow348)));
			float fTemp140 = (fSlow211 * fRec111[1]);
			fRec111[0] = ((((fTemp139 + (fRec112[0] * fSlow350)) + (fRec112[2] * fSlow351)) / fSlow348) - (((fRec111[2] * fSlow359) + fTemp140) / fSlow360));
			fRec110[0] = ((((fTemp140 + (fRec111[0] * fSlow362)) + (fRec111[2] * fSlow363)) / fSlow360) - (fSlow364 * ((fSlow365 * fRec110[2]) + (fSlow366 * fRec110[1]))));
			float fTemp141 = ((fSlow133 * (fRec78[2] + (fRec78[0] + (2.0f * fRec78[1])))) + (fSlow208 * (fRec110[2] + (fRec110[0] + (2.0f * fRec110[1])))));
			iRec146[0] = 0;
			fRec152[0] = ((0.699999988f * fRec152[1]) + (0.284999996f * fRec151[1]));
			float fRec150 = (fRec152[0] + float(iRec146[1]));
			fRec153[0] = (fConst109 + (fRec153[1] - std::floor((fConst109 + fRec153[1]))));
			fVec12[0] = fSlow379;
			float fTemp142 = (fSlow379 - fVec12[1]);
			fVec13[0] = fSlow381;
			float fTemp143 = (0.0f - (fSlow379 + fVec13[1]));
			fRec157[0] = (int(std::min<float>(1.0f, ((fTemp142 * float((fTemp142 > 0.0f))) + (fSlow380 * (fTemp143 * float((fTemp143 > 0.0f))))))) ? fSlow382 : fRec157[1]);
			fRec156[0] = ((fConst110 * fRec156[1]) + (fConst111 * fRec157[0]));
			float fTemp144 = (fSlow17 * (fRec65[0] * fRec156[0]));
			fRec155[0] = ((fConst102 * fRec155[1]) + (fConst103 * float((fTemp144 > 430.0f))));
			fRec154[0] = ((fConst110 * fRec154[1]) + (fSlow378 * fRec155[0]));
			...
			int iTemp147 = int(((fSlow384 * fTemp146) + -1.49999499f));
			...
			float fTemp150 = (fSlow384 * fTemp149);
			...
			float fTemp173 = (((0.0359999985f * ftbl0mydspSIG0[int((65536.0f * fRec153[0]))]) + (fRec154[0] * ((fConst115 * (fRec158[2] + (fRec158[0] + (2.0f * fRec158[1])))) + 1.0f))) - (0.5f * fVec14[1]));
			...
			int iTemp175 = int(((fSlow385 * fTemp146) + -1.49999499f));
			int iTemp176 = (int(std::min<float>(fConst33, float(std::max<int>(0, iTemp175)))) + 1);
			float fTemp177 = (fSlow385 * fTemp149);
			...
			float fTemp200 = std::fabs((0.125f * fRec131[0]));
			fRec163[0] = std::max<float>(fTemp200, ((fRec163[1] * fSlow392) + (fTemp200 * fSlow393)));
			fRec162[0] = ((fRec162[1] * fSlow389) + (fRec163[0] * fSlow394));
			fRec161[0] = ((fConst30 * fRec161[1]) + (fSlow386 * std::max<float>(((20.0f * std::log10(fRec162[0])) - fSlow395), 0.0f)));
			float fTemp201 = (0.125f * (fRec131[0] * std::pow(10.0f, (0.0500000007f * fRec161[0]))));
			fRec164[0] = (fTemp201 - (fSlow399 * ((fSlow400 * fRec164[2]) + (fSlow401 * fRec164[1]))));
			float fTemp202 = (fSlow377 * fRec130[1]);
			fRec130[0] = (fTemp201 - ((fSlow399 * (fRec164[2] + (fRec164[0] + (2.0f * fRec164[1])))) + (((fRec130[2] * fSlow409) + fTemp202) / fSlow410)));
			float fTemp203 = (fSlow374 * fRec129[1]);
			fRec129[0] = ((((fTemp202 + (fRec130[0] * fSlow412)) + (fRec130[2] * fSlow413)) / fSlow410) - (((fRec129[2] * fSlow421) + fTemp203) / fSlow422));
			fRec128[0] = ((((fTemp203 + (fRec129[0] * fSlow424)) + (fRec129[2] * fSlow425)) / fSlow422) - (fSlow426 * ((fSlow427 * fRec128[2]) + (fSlow428 * fRec128[1]))));
			float fTemp204 = (fSlow371 * (fRec128[2] + (fRec128[0] + (2.0f * fRec128[1]))));
			float fTemp205 = (fTemp141 + fTemp204);
			fVec17[(IOTA & 2047)] = (fTemp37 + (fTemp104 + fTemp205));
			...
			float fTemp228 = std::fabs((fSlow12 * fTemp227));
			fRec194[0] = std::max<float>(fTemp228, ((fRec194[1] * fSlow29) + (fTemp228 * fSlow30)));
			fRec193[0] = ((fRec193[1] * fSlow26) + (fRec194[0] * fSlow31));
			fRec192[0] = ((fConst30 * fRec192[1]) + (fSlow23 * std::max<float>(((20.0f * std::log10(fRec193[0])) - fSlow32), 0.0f)));
			float fTemp229 = (fSlow12 * (fTemp227 * std::pow(10.0f, (0.0500000007f * fRec192[0]))));
			fRec195[0] = (fTemp229 - (fSlow36 * ((fSlow37 * fRec195[2]) + (fSlow38 * fRec195[1]))));
			float fTemp230 = (fSlow11 * fRec183[1]);
			fRec183[0] = (fTemp229 - ((fSlow36 * (fRec195[2] + (fRec195[0] + (2.0f * fRec195[1])))) + (((fRec183[2] * fSlow46) + fTemp230) / fSlow47)));
			float fTemp231 = (fSlow8 * fRec182[1]);
			fRec182[0] = ((((fTemp230 + (fRec183[0] * fSlow49)) + (fRec183[2] * fSlow50)) / fSlow47) - (((fRec182[2] * fSlow58) + fTemp231) / fSlow59));
			fRec181[0] = ((((fTemp231 + (fRec182[0] * fSlow61)) + (fRec182[2] * fSlow62)) / fSlow59) - (fSlow63 * ((fSlow64 * fRec181[2]) + (fSlow65 * fRec181[1]))));
			float fTemp232 = ((fTemp141 + (fSlow5 * (fRec181[2] + (fRec181[0] + (2.0f * fRec181[1]))))) + fTemp204);
			fVec26[(IOTA & 2047)] = (fTemp232 + fTemp104);
			...
			fRec214[0] = (iTemp6 ? fSlow440 : fRec214[1]);
			float fTemp254 = (fRec218[1] + (fSlow441 * fRec214[0]));
			fRec218[0] = (fTemp254 - std::floor(fTemp254));
			float fTemp255 = (fRec217[1] + (fConst29 * ((315.0f * (fRec212[0] * ftbl0mydspSIG0[int((65536.0f * fRec218[0]))])) + (fSlow442 * fRec214[0]))));
			fRec217[0] = (fTemp255 - std::floor(fTemp255));
			float fTemp256 = (fRec216[1] + (fConst29 * ((315.0f * (fRec212[0] * ftbl0mydspSIG0[int((65536.0f * fRec217[0]))])) + (fSlow443 * fRec214[0]))));
			fRec216[0] = (fTemp256 - std::floor(fTemp256));
			float fTemp257 = (fRec215[1] + (fConst29 * ((315.0f * (fRec212[0] * ftbl0mydspSIG0[int((65536.0f * fRec216[0]))])) + (fSlow444 * fRec214[0]))));
			fRec215[0] = (fTemp257 - std::floor(fTemp257));
			float fTemp258 = (fRec213[1] + (fConst29 * ((fSlow17 * fRec214[0]) + (315.0f * (fRec212[0] * ftbl0mydspSIG0[int((65536.0f * fRec215[0]))])))));
			...
			fRec221[0] = std::max<float>(fTemp262, ((fRec221[1] * fSlow451) + (fTemp262 * fSlow452)));
			fRec220[0] = ((fRec220[1] * fSlow448) + (fRec221[0] * fSlow453));
			fRec219[0] = ((fConst30 * fRec219[1]) + (fSlow445 * std::max<float>(((20.0f * std::log10(fRec220[0])) - fSlow454), 0.0f)));
			float fTemp263 = (0.25f * (fTemp261 * std::pow(10.0f, (0.0500000007f * fRec219[0]))));
			fRec222[0] = (fTemp263 - (fSlow458 * ((fSlow459 * fRec222[2]) + (fSlow460 * fRec222[1]))));
			float fTemp264 = (fSlow439 * fRec211[1]);
			fRec211[0] = (fTemp263 - ((fSlow458 * (fRec222[2] + (fRec222[0] + (2.0f * fRec222[1])))) + (((fRec211[2] * fSlow468) + fTemp264) / fSlow469)));
			float fTemp265 = (fSlow436 * fRec210[1]);
			fRec210[0] = ((((fTemp264 + (fRec211[0] * fSlow471)) + (fRec211[2] * fSlow472)) / fSlow469) - (((fRec210[2] * fSlow480) + fTemp265) / fSlow481));
			fRec209[0] = ((((fTemp265 + (fRec210[0] * fSlow483)) + (fRec210[2] * fSlow484)) / fSlow481) - (fSlow485 * ((fSlow486 * fRec209[2]) + (fSlow487 * fRec209[1]))));
			float fTemp266 = (fSlow433 * (fRec209[2] + (fRec209[0] + (2.0f * fRec209[1]))));
			...
			fVec34[0] = fSlow499;
			float fTemp267 = (fSlow499 - fVec34[1]);
			fVec35[0] = fSlow501;
			float fTemp268 = (0.0f - (fSlow499 + fVec35[1]));
			float fTemp269 = std::min<float>(1.0f, ((fTemp267 * float((fTemp267 > 0.0f))) + (fSlow500 * (fTemp268 * float((fTemp268 > 0.0f))))));
			fVec36[0] = fTemp269;
			...
			fRec279[0] = (fSlow503 + (0.999000013f * fRec279[1]));
			fRec280[0] = (fSlow504 + (fRec280[1] - std::floor((fSlow504 + fRec280[1]))));
			fRec281[0] = (fSlow506 + (0.999000013f * fRec281[1]));
			fRec282[0] = (fSlow507 + (fRec282[1] - std::floor((fSlow507 + fRec282[1]))));
			fRec283[0] = (fSlow509 + (0.999000013f * fRec283[1]));
			fRec284[0] = (fSlow510 + (fRec284[1] - std::floor((fSlow510 + fRec284[1]))));
			...
			fRec287[0] = std::max<float>(fTemp274, ((fRec287[1] * fSlow517) + (fTemp274 * fSlow518)));
			fRec286[0] = ((fRec286[1] * fSlow514) + (fRec287[0] * fSlow519));
			fRec285[0] = ((fConst30 * fRec285[1]) + (fSlow511 * std::max<float>(((20.0f * std::log10(fRec286[0])) - fSlow520), 0.0f)));
			float fTemp275 = (0.25f * (fTemp273 * std::pow(10.0f, (0.0500000007f * fRec285[0]))));
			fRec288[0] = (fTemp275 - (fSlow524 * ((fSlow525 * fRec288[2]) + (fSlow526 * fRec288[1]))));
			float fTemp276 = (fSlow498 * fRec225[1]);
			fRec225[0] = (fTemp275 - ((fSlow524 * (fRec288[2] + (fRec288[0] + (2.0f * fRec288[1])))) + (((fRec225[2] * fSlow534) + fTemp276) / fSlow535)));
			float fTemp277 = (fSlow495 * fRec224[1]);
			fRec224[0] = ((((fTemp276 + (fRec225[0] * fSlow537)) + (fRec225[2] * fSlow538)) / fSlow535) - (((fRec224[2] * fSlow546) + fTemp277) / fSlow547));
			fRec223[0] = ((((fTemp277 + (fRec224[0] * fSlow549)) + (fRec224[2] * fSlow550)) / fSlow547) - (fSlow551 * ((fSlow552 * fRec223[2]) + (fSlow553 * fRec223[1]))));
			float fTemp278 = (fSlow492 * (fRec223[2] + (fRec223[0] + (2.0f * fRec223[1]))));
