...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst112 = (0.00147058826f * fConst0);
		iConst113 = int(std::min<float>(8192.0f, std::max<float>(0.0f, (0.00999999978f * fConst0))));
		iConst114 = int(std::min<float>(1024.0f, std::max<float>(0.0f, (fConst16 + -1.0f))));
		float fConst115 = std::floor(((0.256891012f * fConst0) + 0.5f));
		float fConst116 = ((0.0f - (6.90775537f * fConst115)) / fConst0);
		float fConst117 = std::exp((0.25f * fConst116));
		float fConst118 = mydsp_faustpower2_f(fConst117);
		float fConst119 = (1.0f - (fConst118 * fConst5));
		float fConst120 = (1.0f - fConst118);
		float fConst121 = (fConst119 / fConst120);
		float fConst122 = std::sqrt(std::max<float>(0.0f, ((mydsp_faustpower2_f(fConst119) / mydsp_faustpower2_f(fConst120)) + -1.0f)));
		fConst123 = (fConst121 - fConst122);
		fConst124 = (fConst117 * (fConst122 + (1.0f - fConst121)));
		fConst125 = ((std::exp(fConst116) / fConst117) + -1.0f);
		float fConst126 = std::floor(((0.0273330007f * fConst0) + 0.5f));
		iConst127 = int(std::min<float>(16384.0f, std::max<float>(0.0f, (fConst115 - fConst126))));
		iConst128 = int(std::min<float>(2048.0f, std::max<float>(0.0f, (fConst126 + -1.0f))));
		float fConst129 = std::floor(((0.192303002f * fConst0) + 0.5f));
		float fConst130 = ((0.0f - (6.90775537f * fConst129)) / fConst0);
		float fConst131 = std::exp((0.25f * fConst130));
		float fConst132 = mydsp_faustpower2_f(fConst131);
		float fConst133 = (1.0f - (fConst132 * fConst5));
		float fConst134 = (1.0f - fConst132);
		float fConst135 = (fConst133 / fConst134);
		float fConst136 = std::sqrt(std::max<float>(0.0f, ((mydsp_faustpower2_f(fConst133) / mydsp_faustpower2_f(fConst134)) + -1.0f)));
		fConst137 = (fConst135 - fConst136);
		fConst138 = (fConst131 * (fConst136 + (1.0f - fConst135)));
		fConst139 = ((std::exp(fConst130) / fConst131) + -1.0f);
		float fConst140 = std::floor(((0.0292910002f * fConst0) + 0.5f));
		iConst141 = int(std::min<float>(8192.0f, std::max<float>(0.0f, (fConst129 - fConst140))));
		iConst142 = int(std::min<float>(2048.0f, std::max<float>(0.0f, (fConst140 + -1.0f))));
		float fConst143 = std::floor(((0.210389003f * fConst0) + 0.5f));
		float fConst144 = ((0.0f - (6.90775537f * fConst143)) / fConst0);
		float fConst145 = std::exp((0.25f * fConst144));
		float fConst146 = mydsp_faustpower2_f(fConst145);
		float fConst147 = (1.0f - (fConst146 * fConst5));
		float fConst148 = (1.0f - fConst146);
		float fConst149 = (fConst147 / fConst148);
		float fConst150 = std::sqrt(std::max<float>(0.0f, ((mydsp_faustpower2_f(fConst147) / mydsp_faustpower2_f(fConst148)) + -1.0f)));
		fConst151 = (fConst149 - fConst150);
		fConst152 = (fConst145 * (fConst150 + (1.0f - fConst149)));
		fConst153 = ((std::exp(fConst144) / fConst145) + -1.0f);
		float fConst154 = std::floor(((0.0244210009f * fConst0) + 0.5f));
		iConst155 = int(std::min<float>(16384.0f, std::max<float>(0.0f, (fConst143 - fConst154))));
		iConst156 = int(std::min<float>(2048.0f, std::max<float>(0.0f, (fConst154 + -1.0f))));
		float fConst157 = std::floor(((0.125f * fConst0) + 0.5f));
		float fConst158 = ((0.0f - (6.90775537f * fConst157)) / fConst0);
		float fConst159 = std::exp((0.25f * fConst158));
		float fConst160 = mydsp_faustpower2_f(fConst159);
		float fConst161 = (1.0f - (fConst160 * fConst5));
		float fConst162 = (1.0f - fConst160);
		float fConst163 = (fConst161 / fConst162);
		float fConst164 = std::sqrt(std::max<float>(0.0f, ((mydsp_faustpower2_f(fConst161) / mydsp_faustpower2_f(fConst162)) + -1.0f)));
		fConst165 = (fConst163 - fConst164);
		fConst166 = (fConst159 * (fConst164 + (1.0f - fConst163)));
		fConst167 = ((std::exp(fConst158) / fConst159) + -1.0f);
		float fConst168 = std::floor(((0.0134579996f * fConst0) + 0.5f));
		iConst169 = int(std::min<float>(8192.0f, std::max<float>(0.0f, (fConst157 - fConst168))));
		iConst170 = int(std::min<float>(1024.0f, std::max<float>(0.0f, (fConst168 + -1.0f))));
		float fConst171 = std::floor(((0.127837002f * fConst0) + 0.5f));
		float fConst172 = ((0.0f - (6.90775537f * fConst171)) / fConst0);
		float fConst173 = std::exp((0.25f * fConst172));
		float fConst174 = mydsp_faustpower2_f(fConst173);
		float fConst175 = (1.0f - (fConst174 * fConst5));
		float fConst176 = (1.0f - fConst174);
		float fConst177 = (fConst175 / fConst176);
		float fConst178 = std::sqrt(std::max<float>(0.0f, ((mydsp_faustpower2_f(fConst175) / mydsp_faustpower2_f(fConst176)) + -1.0f)));
		fConst179 = (fConst177 - fConst178);
		fConst180 = (fConst173 * (fConst178 + (1.0f - fConst177)));
		fConst181 = ((std::exp(fConst172) / fConst173) + -1.0f);
		float fConst182 = std::floor(((0.0316039994f * fConst0) + 0.5f));
		iConst183 = int(std::min<float>(8192.0f, std::max<float>(0.0f, (fConst171 - fConst182))));
		iConst184 = int(std::min<float>(2048.0f, std::max<float>(0.0f, (fConst182 + -1.0f))));
		float fConst185 = std::floor(((0.174713001f * fConst0) + 0.5f));
		float fConst186 = ((0.0f - (6.90775537f * fConst185)) / fConst0);
		float fConst187 = std::exp((0.25f * fConst186));
		float fConst188 = mydsp_faustpower2_f(fConst187);
		float fConst189 = (1.0f - (fConst188 * fConst5));
		float fConst190 = (1.0f - fConst188);
		float fConst191 = (fConst189 / fConst190);
		float fConst192 = std::sqrt(std::max<float>(0.0f, ((mydsp_faustpower2_f(fConst189) / mydsp_faustpower2_f(fConst190)) + -1.0f)));
		fConst193 = (fConst191 - fConst192);
		fConst194 = (fConst187 * (fConst192 + (1.0f - fConst191)));
		fConst195 = ((std::exp(fConst186) / fConst187) + -1.0f);
		float fConst196 = std::floor(((0.0229039993f * fConst0) + 0.5f));
		iConst197 = int(std::min<float>(8192.0f, std::max<float>(0.0f, (fConst185 - fConst196))));
		iConst198 = int(std::min<float>(2048.0f, std::max<float>(0.0f, (fConst196 + -1.0f))));
		float fConst199 = std::floor(((0.153128996f * fConst0) + 0.5f));
		float fConst200 = ((0.0f - (6.90775537f * fConst199)) / fConst0);
		float fConst201 = std::exp((0.25f * fConst200));
		float fConst202 = mydsp_faustpower2_f(fConst201);
		float fConst203 = (1.0f - (fConst202 * fConst5));
		float fConst204 = (1.0f - fConst202);
		float fConst205 = (fConst203 / fConst204);
		float fConst206 = std::sqrt(std::max<float>(0.0f, ((mydsp_faustpower2_f(fConst203) / mydsp_faustpower2_f(fConst204)) + -1.0f)));
		fConst207 = (fConst205 - fConst206);
		fConst208 = (fConst201 * (fConst206 + (1.0f - fConst205)));
		fConst209 = ((std::exp(fConst200) / fConst201) + -1.0f);
		float fConst210 = std::floor(((0.0203460008f * fConst0) + 0.5f));
		iConst211 = int(std::min<float>(8192.0f, std::max<float>(0.0f, (fConst199 - fConst210))));
		iConst212 = int(std::min<float>(1024.0f, std::max<float>(0.0f, (fConst210 + -1.0f))));
		fConst213 = mydsp_faustpower2_f(fConst29);
		fConst214 = (2.0f * fConst213);
		fConst215 = (4.0f * (mydsp_faustpower2_f(fConst0) * std::tan((628.318542f / fConst0))));
		fConst216 = (3500.0f * fConst111);
		fConst217 = (2.0f / fConst0);
		fConst218 = (2.0f * fConst0);
		fConst219 = (0.5f / fConst0);
		fConst220 = (1.0f / std::max<float>(1.0f, (3.0f * fConst0)));
		fConst221 = (81.0f / fConst0);
		fConst222 = ftbl1mydspSIG1[50];
		float fConst223 = std::tan((31415.9258f / fConst0));
		float fConst224 = (1.0f / fConst223);
		fConst225 = (1.0f / (((fConst224 + 1.41421354f) / fConst223) + 1.0f));
		float fConst226 = std::tan((31.415926f / fConst0));
		float fConst227 = (1.0f / fConst226);
		fConst228 = (1.0f / (((fConst227 + 1.41421354f) / fConst226) + 1.0f));
		float fConst229 = mydsp_faustpower2_f(fConst226);
		fConst230 = (1.0f / fConst229);
		fConst231 = (((fConst227 + -1.41421354f) / fConst226) + 1.0f);
		fConst232 = (2.0f * (1.0f - fConst230));
		fConst233 = (0.0f - (2.0f / fConst229));
		fConst234 = (((fConst224 + -1.41421354f) / fConst223) + 1.0f);
		fConst235 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fConst223))));
		fConst236 = (1.0f / std::max<float>(1.0f, (0.00159999996f * fConst0)));
		float fConst237 = std::pow(0.00100000005f, (0.0448570587f / fConst0));
		fConst238 = (std::cos((2839.48462f / fConst0)) * (0.0f - (2.0f * fConst237)));
		fConst239 = mydsp_faustpower2_f(fConst237);
		fConst240 = ftbl1mydspSIG1[51];
		float fConst241 = std::pow(0.00100000005f, (0.0449536517f / fConst0));
		fConst242 = (std::cos((2858.84937f / fConst0)) * (0.0f - (2.0f * fConst241)));
		fConst243 = mydsp_faustpower2_f(fConst241);
		fConst244 = ftbl1mydspSIG1[52];
		float fConst245 = std::pow(0.00100000005f, (0.0609094799f / fConst0));
		fConst246 = (std::cos((5432.7124f / fConst0)) * (0.0f - (2.0f * fConst245)));
		fConst247 = mydsp_faustpower2_f(fConst245);
		fConst248 = ftbl1mydspSIG1[53];
		float fConst249 = std::pow(0.00100000005f, (0.0612352863f / fConst0));
		fConst250 = (std::cos((5475.18018f / fConst0)) * (0.0f - (2.0f * fConst249)));
		fConst251 = mydsp_faustpower2_f(fConst249);
		fConst252 = ftbl1mydspSIG1[54];
		float fConst253 = std::pow(0.00100000005f, (0.0721585602f / fConst0));
		fConst254 = (std::cos((6738.52783f / fConst0)) * (0.0f - (2.0f * fConst253)));
		fConst255 = mydsp_faustpower2_f(fConst253);
		fConst256 = ftbl1mydspSIG1[55];
		float fConst257 = std::pow(0.00100000005f, (0.0722505748f / fConst0));
		fConst258 = (std::cos((6748.01514f / fConst0)) * (0.0f - (2.0f * fConst257)));
		fConst259 = mydsp_faustpower2_f(fConst257);
		fConst260 = ftbl1mydspSIG1[56];
		float fConst261 = std::pow(0.00100000005f, (0.0874899849f / fConst0));
		fConst262 = (std::cos((8119.32031f / fConst0)) * (0.0f - (2.0f * fConst261)));
		fConst263 = mydsp_faustpower2_f(fConst261);
		fConst264 = ftbl1mydspSIG1[57];
		float fConst265 = std::pow(0.00100000005f, (0.0875099227f / fConst0));
		fConst266 = (std::cos((8120.89111f / fConst0)) * (0.0f - (2.0f * fConst265)));
		fConst267 = mydsp_faustpower2_f(fConst265);
		fConst268 = ftbl1mydspSIG1[58];
		float fConst269 = std::pow(0.00100000005f, (0.107014902f / fConst0));
		fConst270 = (std::cos((9453.68066f / fConst0)) * (0.0f - (2.0f * fConst269)));
		fConst271 = mydsp_faustpower2_f(fConst269);
		fConst272 = ftbl1mydspSIG1[59];
		float fConst273 = std::pow(0.00100000005f, (0.110012196f / fConst0));
		fConst274 = (std::cos((9628.41602f / fConst0)) * (0.0f - (2.0f * fConst273)));
		fConst275 = mydsp_faustpower2_f(fConst273);
		fConst276 = ftbl1mydspSIG1[60];
		float fConst277 = std::pow(0.00100000005f, (0.123582378f / fConst0));
		fConst278 = (std::cos((10343.3799f / fConst0)) * (0.0f - (2.0f * fConst277)));
		fConst279 = mydsp_faustpower2_f(fConst277);
		fConst280 = ftbl1mydspSIG1[61];
		float fConst281 = std::pow(0.00100000005f, (0.123685889f / fConst0));
		fConst282 = (std::cos((10348.4062f / fConst0)) * (0.0f - (2.0f * fConst281)));
		fConst283 = mydsp_faustpower2_f(fConst281);
		fConst284 = ftbl1mydspSIG1[62];
		float fConst285 = std::pow(0.00100000005f, (0.127769172f / fConst0));
		fConst286 = (std::cos((10542.1172f / fConst0)) * (0.0f - (2.0f * fConst285)));
		fConst287 = mydsp_faustpower2_f(fConst285);
		fConst288 = ftbl1mydspSIG1[63];
		float fConst289 = std::pow(0.00100000005f, (0.127809823f / fConst0));
		fConst290 = (std::cos((10544.002f / fConst0)) * (0.0f - (2.0f * fConst289)));
		fConst291 = mydsp_faustpower2_f(fConst289);
		fConst292 = ftbl1mydspSIG1[64];
		float fConst293 = std::pow(0.00100000005f, (0.157417208f / fConst0));
		fConst294 = (std::cos((11728.3818f / fConst0)) * (0.0f - (2.0f * fConst293)));
		fConst295 = mydsp_faustpower2_f(fConst293);
		fConst296 = ftbl1mydspSIG1[65];
		float fConst297 = std::pow(0.00100000005f, (0.160256028f / fConst0));
		fConst298 = (std::cos((11825.457f / fConst0)) * (0.0f - (2.0f * fConst297)));
		fConst299 = mydsp_faustpower2_f(fConst297);
		fConst300 = ftbl1mydspSIG1[66];
		float fConst301 = std::pow(0.00100000005f, (0.18117331f / fConst0));
		fConst302 = (std::cos((12473.3799f / fConst0)) * (0.0f - (2.0f * fConst301)));
		fConst303 = mydsp_faustpower2_f(fConst301);
		fConst304 = ftbl1mydspSIG1[67];
		float fConst305 = std::pow(0.00100000005f, (0.182209119f / fConst0));
		fConst306 = (std::cos((12502.7217f / fConst0)) * (0.0f - (2.0f * fConst305)));
		fConst307 = mydsp_faustpower2_f(fConst305);
		fConst308 = ftbl1mydspSIG1[68];
		float fConst309 = std::pow(0.00100000005f, (0.2133362f / fConst0));
		fConst310 = (std::cos((13288.4971f / fConst0)) * (0.0f - (2.0f * fConst309)));
		fConst311 = mydsp_faustpower2_f(fConst309);
		fConst312 = ftbl1mydspSIG1[69];
		float fConst313 = std::pow(0.00100000005f, (0.298688531f / fConst0));
		fConst314 = (std::cos((14808.2744f / fConst0)) * (0.0f - (2.0f * fConst313)));
		fConst315 = mydsp_faustpower2_f(fConst313);
		fConst316 = ftbl1mydspSIG1[70];
		float fConst317 = std::pow(0.00100000005f, (0.341466933f / fConst0));
		fConst318 = (std::cos((15358.1152f / fConst0)) * (0.0f - (2.0f * fConst317)));
		fConst319 = mydsp_faustpower2_f(fConst317);
		fConst320 = ftbl1mydspSIG1[71];
		float fConst321 = std::pow(0.00100000005f, (0.342488438f / fConst0));
		fConst322 = (std::cos((15370.0537f / fConst0)) * (0.0f - (2.0f * fConst321)));
		fConst323 = mydsp_faustpower2_f(fConst321);
		fConst324 = ftbl1mydspSIG1[72];
		float fConst325 = std::pow(0.00100000005f, (0.391345769f / fConst0));
		fConst326 = (std::cos((15888.7305f / fConst0)) * (0.0f - (2.0f * fConst325)));
		fConst327 = mydsp_faustpower2_f(fConst325);
		fConst328 = ftbl1mydspSIG1[73];
		float fConst329 = std::pow(0.00100000005f, (0.392745376f / fConst0));
		fConst330 = (std::cos((15902.2393f / fConst0)) * (0.0f - (2.0f * fConst329)));
		fConst331 = mydsp_faustpower2_f(fConst329);
		fConst332 = ftbl1mydspSIG1[74];
		float fConst333 = std::pow(0.00100000005f, (0.499480247f / fConst0));
		fConst334 = (std::cos((16768.9414f / fConst0)) * (0.0f - (2.0f * fConst333)));
		fConst335 = mydsp_faustpower2_f(fConst333);
		fConst336 = ftbl1mydspSIG1[75];
		float fConst337 = std::pow(0.00100000005f, (0.500184536f / fConst0));
		fConst338 = (std::cos((16773.7793f / fConst0)) * (0.0f - (2.0f * fConst337)));
		fConst339 = mydsp_faustpower2_f(fConst337);
		fConst340 = ftbl1mydspSIG1[76];
		float fConst341 = std::pow(0.00100000005f, (0.56877172f / fConst0));
		fConst342 = (std::cos((17203.7383f / fConst0)) * (0.0f - (2.0f * fConst341)));
		fConst343 = mydsp_faustpower2_f(fConst341);
		fConst344 = ftbl1mydspSIG1[77];
		float fConst345 = std::pow(0.00100000005f, (0.580974996f / fConst0));
		fConst346 = (std::cos((17272.6641f / fConst0)) * (0.0f - (2.0f * fConst345)));
		fConst347 = mydsp_faustpower2_f(fConst345);
		fConst348 = ftbl1mydspSIG1[78];
		float fConst349 = std::pow(0.00100000005f, (0.58267206f / fConst0));
		fConst350 = (std::cos((17282.0898f / fConst0)) * (0.0f - (2.0f * fConst349)));
		fConst351 = mydsp_faustpower2_f(fConst349);
		fConst352 = ftbl1mydspSIG1[79];
		float fConst353 = std::pow(0.00100000005f, (0.58560729f / fConst0));
		fConst354 = (std::cos((17298.3008f / fConst0)) * (0.0f - (2.0f * fConst353)));
		fConst355 = mydsp_faustpower2_f(fConst353);
		fConst356 = ftbl1mydspSIG1[80];
		float fConst357 = std::pow(0.00100000005f, (0.679538369f / fConst0));
		fConst358 = (std::cos((17763.7578f / fConst0)) * (0.0f - (2.0f * fConst357)));
		fConst359 = mydsp_faustpower2_f(fConst357);
		fConst360 = ftbl1mydspSIG1[81];
		float fConst361 = std::pow(0.00100000005f, (0.701286793f / fConst0));
		fConst362 = (std::cos((17858.8242f / fConst0)) * (0.0f - (2.0f * fConst361)));
		fConst363 = mydsp_faustpower2_f(fConst361);
		fConst364 = ftbl1mydspSIG1[82];
		float fConst365 = std::pow(0.00100000005f, (0.981793463f / fConst0));
		fConst366 = (std::cos((18802.8086f / fConst0)) * (0.0f - (2.0f * fConst365)));
		fConst367 = mydsp_faustpower2_f(fConst365);
		fConst368 = ftbl1mydspSIG1[83];
		float fConst369 = std::pow(0.00100000005f, (0.991939485f / fConst0));
		fConst370 = (std::cos((18829.7012f / fConst0)) * (0.0f - (2.0f * fConst369)));
		fConst371 = mydsp_faustpower2_f(fConst369);
		fConst372 = ftbl1mydspSIG1[84];
		float fConst373 = std::pow(0.00100000005f, (1.57685912f / fConst0));
		fConst374 = (std::cos((19934.0957f / fConst0)) * (0.0f - (2.0f * fConst373)));
		fConst375 = mydsp_faustpower2_f(fConst373);
		fConst376 = ftbl1mydspSIG1[85];
		float fConst377 = std::pow(0.00100000005f, (2.61620831f / fConst0));
		fConst378 = (std::cos((20927.9707f / fConst0)) * (0.0f - (2.0f * fConst377)));
		fConst379 = mydsp_faustpower2_f(fConst377);
		fConst380 = ftbl1mydspSIG1[86];
		float fConst381 = std::pow(0.00100000005f, (3.26228237f / fConst0));
		fConst382 = (std::cos((21302.0723f / fConst0)) * (0.0f - (2.0f * fConst381)));
		fConst383 = mydsp_faustpower2_f(fConst381);
		fConst384 = ftbl1mydspSIG1[87];
		float fConst385 = std::pow(0.00100000005f, (3.42948842f / fConst0));
		fConst386 = (std::cos((21382.3086f / fConst0)) * (0.0f - (2.0f * fConst385)));
		fConst387 = mydsp_faustpower2_f(fConst385);
		fConst388 = ftbl1mydspSIG1[88];
		float fConst389 = std::pow(0.00100000005f, (5.61909866f / fConst0));
		fConst390 = (std::cos((22094.3809f / fConst0)) * (0.0f - (2.0f * fConst389)));
		fConst391 = mydsp_faustpower2_f(fConst389);
		fConst392 = ftbl1mydspSIG1[89];
		float fConst393 = std::pow(0.00100000005f, (6.26517916f / fConst0));
		fConst394 = (std::cos((22233.3027f / fConst0)) * (0.0f - (2.0f * fConst393)));
		fConst395 = mydsp_faustpower2_f(fConst393);
		fConst396 = ftbl1mydspSIG1[90];
		float fConst397 = std::pow(0.00100000005f, (7.91042233f / fConst0));
		fConst398 = (std::cos((22511.334f / fConst0)) * (0.0f - (2.0f * fConst397)));
		fConst399 = mydsp_faustpower2_f(fConst397);
		fConst400 = ftbl1mydspSIG1[91];
		float fConst401 = std::pow(0.00100000005f, (7.95560217f / fConst0));
		fConst402 = (std::cos((22517.8047f / fConst0)) * (0.0f - (2.0f * fConst401)));
		fConst403 = mydsp_faustpower2_f(fConst401);
		fConst404 = ftbl1mydspSIG1[92];
		float fConst405 = std::pow(0.00100000005f, (21.1559925f / fConst0));
		fConst406 = (std::cos((23436.5332f / fConst0)) * (0.0f - (2.0f * fConst405)));
		fConst407 = mydsp_faustpower2_f(fConst405);
		fConst408 = ftbl1mydspSIG1[93];
		float fConst409 = std::pow(0.00100000005f, (22.8584423f / fConst0));
		fConst410 = (std::cos((23495.0293f / fConst0)) * (0.0f - (2.0f * fConst409)));
		fConst411 = mydsp_faustpower2_f(fConst409);
		fConst412 = ftbl1mydspSIG1[94];
		float fConst413 = std::pow(0.00100000005f, (27.0563507f / fConst0));
		fConst414 = (std::cos((23616.3574f / fConst0)) * (0.0f - (2.0f * fConst413)));
		fConst415 = mydsp_faustpower2_f(fConst413);
		fConst416 = ftbl1mydspSIG1[95];
		float fConst417 = std::pow(0.00100000005f, (173.368958f / fConst0));
		fConst418 = (std::cos((24528.1738f / fConst0)) * (0.0f - (2.0f * fConst417)));
		fConst419 = mydsp_faustpower2_f(fConst417);
		fConst420 = ftbl1mydspSIG1[96];
		float fConst421 = std::pow(0.00100000005f, (415.098541f / fConst0));
		fConst422 = (std::cos((24772.0234f / fConst0)) * (0.0f - (2.0f * fConst421)));
		fConst423 = mydsp_faustpower2_f(fConst421);
		fConst424 = ftbl1mydspSIG1[97];
		float fConst425 = std::pow(0.00100000005f, (1631.8125f / fConst0));
		fConst426 = (std::cos((25018.0098f / fConst0)) * (0.0f - (2.0f * fConst425)));
		fConst427 = mydsp_faustpower2_f(fConst425);
		fConst428 = ftbl1mydspSIG1[98];
		float fConst429 = std::pow(0.00100000005f, (1752.41809f / fConst0));
		fConst430 = (std::cos((25027.498f / fConst0)) * (0.0f - (2.0f * fConst429)));
		fConst431 = mydsp_faustpower2_f(fConst429);
		fConst432 = ftbl1mydspSIG1[99];
		float fConst433 = std::pow(0.00100000005f, (13161720.0f / fConst0));
		fConst434 = (std::cos((25346.1816f / fConst0)) * (0.0f - (2.0f * fConst433)));
		fConst435 = mydsp_faustpower2_f(fConst433);
		fConst436 = (1.0f / std::max<float>(1.0f, fConst218));
		fConst437 = std::exp((0.0f - (0.00999999978f / fConst0)));
		fConst438 = (1.0f - fConst437);
		fConst439 = std::exp((0.0f - (0.00333333341f / fConst0)));
		fConst440 = (1.0f - fConst439);
		fConst441 = std::exp((0.0f - (0.0199999996f / fConst0)));
		fConst442 = (1.0f - fConst441);
		fConst443 = std::exp((0.0f - (0.00499999989f / fConst0)));
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow380 = (0.25f * mydsp_faustpower2_f(fSlow379));
		...
		float fSlow388 = std::tan((fConst18 * ((2500.0f * fSlow379) + 1200.0f)));
		float fSlow389 = (1.0f / fSlow388);
		float fSlow390 = (((fSlow389 + 1.41421354f) / fSlow388) + 1.0f);
		float fSlow391 = (0.0500000007f / fSlow390);
		float fSlow392 = (1.0f / fSlow390);
		float fSlow393 = (((fSlow389 + -1.41421354f) / fSlow388) + 1.0f);
		float fSlow394 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow388))));
		float fSlow395 = (0.400000006f * (float(fHslider88) + -0.5f));
		float fSlow396 = (fConst112 * (fSlow395 + 0.270000011f));
		float fSlow397 = (fConst112 * (0.730000019f - fSlow395));
		float fSlow398 = (fConst31 * ((1.0f / float(fHslider89)) + -1.0f));
		float fSlow399 = float(fHslider90);
		int iSlow400 = (std::fabs(fSlow399) < 1.1920929e-07f);
		float fSlow401 = (iSlow400 ? 0.0f : std::exp((0.0f - (fConst29 / (iSlow400 ? 1.0f : fSlow399)))));
		float fSlow402 = float(fHslider91);
		int iSlow403 = (std::fabs(fSlow402) < 1.1920929e-07f);
		float fSlow404 = (iSlow403 ? 0.0f : std::exp((0.0f - (fConst29 / (iSlow403 ? 1.0f : fSlow402)))));
		float fSlow405 = (1.0f - fSlow404);
		float fSlow406 = (1.0f - fSlow401);
		float fSlow407 = float(fHslider92);
		float fSlow408 = (1.0f / float(fHslider93));
		float fSlow409 = std::tan((fConst18 * float(fHslider94)));
		float fSlow410 = (1.0f / fSlow409);
		float fSlow411 = (1.0f / (((fSlow408 + fSlow410) / fSlow409) + 1.0f));
		float fSlow412 = (((fSlow410 - fSlow408) / fSlow409) + 1.0f);
		float fSlow413 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow409))));
		float fSlow414 = (1.0f / fSlow377);
		float fSlow415 = float(fHslider95);
		int iSlow416 = (fSlow415 > 0.0f);
		float fSlow417 = (float(fHslider96) * std::sin((fConst32 * fSlow376)));
		float fSlow418 = (fConst18 * ((fSlow376 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow415)))) / fSlow417));
		float fSlow419 = (fConst18 * (fSlow376 / fSlow417));
		...
		float fSlow426 = (1.0f / fSlow374);
		float fSlow427 = float(fHslider97);
		int iSlow428 = (fSlow427 > 0.0f);
		float fSlow429 = (float(fHslider98) * std::sin((fConst32 * fSlow373)));
		float fSlow430 = (fConst18 * ((fSlow373 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow427)))) / fSlow429));
		float fSlow431 = (fConst18 * (fSlow373 / fSlow429));
		float fSlow432 = (iSlow428 ? fSlow431 : fSlow430);
		float fSlow433 = ((fSlow426 * (fSlow426 - fSlow432)) + 1.0f);
		float fSlow434 = ((fSlow426 * (fSlow426 + fSlow432)) + 1.0f);
		float fSlow435 = (iSlow428 ? fSlow430 : fSlow431);
		float fSlow436 = ((fSlow426 * (fSlow426 + fSlow435)) + 1.0f);
		float fSlow437 = ((fSlow426 * (fSlow426 - fSlow435)) + 1.0f);
		float fSlow438 = (1.0f / fSlow371);
		float fSlow439 = (((fSlow370 - fSlow368) / fSlow369) + 1.0f);
		float fSlow440 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow369))));
		float fSlow441 = (1.0f / float(fHslider100));
		float fSlow442 = std::tan((fConst18 * float(fHslider101)));
		float fSlow443 = (1.0f / fSlow442);
		float fSlow444 = (((fSlow441 + fSlow443) / fSlow442) + 1.0f);
		float fSlow445 = ((std::pow(10.0f, (0.0500000007f * float(fHslider99))) * (1.0f - float(fCheckbox6))) / fSlow444);
		float fSlow446 = float(fHslider102);
		float fSlow447 = std::tan((fConst18 * fSlow446));
		float fSlow448 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow447))));
		float fSlow449 = float(fHslider103);
		float fSlow450 = std::tan((fConst18 * fSlow449));
		float fSlow451 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow450))));
		float fSlow452 = (0.5f * fSlow17);
		float fSlow453 = (fConst221 * fSlow18);
		float fSlow454 = (27.0f * fSlow18);
		float fSlow455 = (9.0f * fSlow18);
		float fSlow456 = (3.0f * fSlow18);
		float fSlow457 = (fConst31 * ((1.0f / float(fHslider104)) + -1.0f));
		float fSlow458 = float(fHslider105);
		int iSlow459 = (std::fabs(fSlow458) < 1.1920929e-07f);
		float fSlow460 = (iSlow459 ? 0.0f : std::exp((0.0f - (fConst29 / (iSlow459 ? 1.0f : fSlow458)))));
		float fSlow461 = float(fHslider106);
		int iSlow462 = (std::fabs(fSlow461) < 1.1920929e-07f);
		float fSlow463 = (iSlow462 ? 0.0f : std::exp((0.0f - (fConst29 / (iSlow462 ? 1.0f : fSlow461)))));
		float fSlow464 = (1.0f - fSlow463);
		float fSlow465 = (1.0f - fSlow460);
		float fSlow466 = float(fHslider107);
		float fSlow467 = (1.0f / float(fHslider108));
		float fSlow468 = std::tan((fConst18 * float(fHslider109)));
		float fSlow469 = (1.0f / fSlow468);
		float fSlow470 = (1.0f / (((fSlow467 + fSlow469) / fSlow468) + 1.0f));
		float fSlow471 = (((fSlow469 - fSlow467) / fSlow468) + 1.0f);
		float fSlow472 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow468))));
		float fSlow473 = (1.0f / fSlow450);
		float fSlow474 = float(fHslider110);
		int iSlow475 = (fSlow474 > 0.0f);
		float fSlow476 = (float(fHslider111) * std::sin((fConst32 * fSlow449)));
		float fSlow477 = (fConst18 * ((fSlow449 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow474)))) / fSlow476));
		float fSlow478 = (fConst18 * (fSlow449 / fSlow476));
		...
		float fSlow485 = (1.0f / fSlow447);
		float fSlow486 = float(fHslider112);
		int iSlow487 = (fSlow486 > 0.0f);
		float fSlow488 = (float(fHslider113) * std::sin((fConst32 * fSlow446)));
		float fSlow489 = (fConst18 * ((fSlow446 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow486)))) / fSlow488));
		float fSlow490 = (fConst18 * (fSlow446 / fSlow488));
		float fSlow491 = (iSlow487 ? fSlow490 : fSlow489);
		float fSlow492 = ((fSlow485 * (fSlow485 - fSlow491)) + 1.0f);
		float fSlow493 = ((fSlow485 * (fSlow485 + fSlow491)) + 1.0f);
		float fSlow494 = (iSlow487 ? fSlow489 : fSlow490);
		float fSlow495 = ((fSlow485 * (fSlow485 + fSlow494)) + 1.0f);
		float fSlow496 = ((fSlow485 * (fSlow485 - fSlow494)) + 1.0f);
		float fSlow497 = (1.0f / fSlow444);
		float fSlow498 = (((fSlow443 - fSlow441) / fSlow442) + 1.0f);
		float fSlow499 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow442))));
		float fSlow500 = (1.0f / float(fHslider115));
		float fSlow501 = std::tan((fConst18 * float(fHslider116)));
		float fSlow502 = (1.0f / fSlow501);
		float fSlow503 = (((fSlow500 + fSlow502) / fSlow501) + 1.0f);
		float fSlow504 = ((std::pow(10.0f, (0.0500000007f * float(fHslider114))) * (1.0f - float(fCheckbox7))) / fSlow503);
		float fSlow505 = float(fHslider117);
		float fSlow506 = std::tan((fConst18 * fSlow505));
		float fSlow507 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow506))));
		float fSlow508 = float(fHslider118);
		float fSlow509 = std::tan((fConst18 * fSlow508));
		float fSlow510 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow509))));
		float fSlow511 = float(fHslider119);
		float fSlow512 = float((fSlow511 > 0.0f));
		float fSlow513 = (0.0f - fSlow511);
		float fSlow514 = float(fHslider120);
		float fSlow515 = (0.00100000005f * float((fSlow514 > 310.0f)));
		float fSlow516 = (fConst29 * std::max<float>(20.0f, fSlow514));
		float fSlow517 = float(fHslider121);
		float fSlow518 = (0.00100000005f * float((fSlow517 > 610.0f)));
		float fSlow519 = (fConst29 * std::max<float>(20.0f, fSlow517));
		float fSlow520 = float(fHslider122);
		float fSlow521 = (0.00100000005f * float((fSlow520 > 1210.0f)));
		float fSlow522 = (fConst29 * std::max<float>(20.0f, fSlow520));
		float fSlow523 = (fConst31 * ((1.0f / float(fHslider123)) + -1.0f));
		float fSlow524 = float(fHslider124);
		int iSlow525 = (std::fabs(fSlow524) < 1.1920929e-07f);
		float fSlow526 = (iSlow525 ? 0.0f : std::exp((0.0f - (fConst29 / (iSlow525 ? 1.0f : fSlow524)))));
		float fSlow527 = float(fHslider125);
		int iSlow528 = (std::fabs(fSlow527) < 1.1920929e-07f);
		float fSlow529 = (iSlow528 ? 0.0f : std::exp((0.0f - (fConst29 / (iSlow528 ? 1.0f : fSlow527)))));
		float fSlow530 = (1.0f - fSlow529);
		float fSlow531 = (1.0f - fSlow526);
		float fSlow532 = float(fHslider126);
		float fSlow533 = (1.0f / float(fHslider127));
		float fSlow534 = std::tan((fConst18 * float(fHslider128)));
		float fSlow535 = (1.0f / fSlow534);
		float fSlow536 = (1.0f / (((fSlow533 + fSlow535) / fSlow534) + 1.0f));
		float fSlow537 = (((fSlow535 - fSlow533) / fSlow534) + 1.0f);
		float fSlow538 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow534))));
		float fSlow539 = (1.0f / fSlow509);
		float fSlow540 = float(fHslider129);
		int iSlow541 = (fSlow540 > 0.0f);
		float fSlow542 = (float(fHslider130) * std::sin((fConst32 * fSlow508)));
		float fSlow543 = (fConst18 * ((fSlow508 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow540)))) / fSlow542));
		float fSlow544 = (fConst18 * (fSlow508 / fSlow542));
		...
		float fSlow551 = (1.0f / fSlow506);
		float fSlow552 = float(fHslider131);
		int iSlow553 = (fSlow552 > 0.0f);
		float fSlow554 = (float(fHslider132) * std::sin((fConst32 * fSlow505)));
		float fSlow555 = (fConst18 * ((fSlow505 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow552)))) / fSlow554));
		float fSlow556 = (fConst18 * (fSlow505 / fSlow554));
		float fSlow557 = (iSlow553 ? fSlow556 : fSlow555);
		float fSlow558 = ((fSlow551 * (fSlow551 - fSlow557)) + 1.0f);
		float fSlow559 = ((fSlow551 * (fSlow551 + fSlow557)) + 1.0f);
		float fSlow560 = (iSlow553 ? fSlow555 : fSlow556);
		float fSlow561 = ((fSlow551 * (fSlow551 + fSlow560)) + 1.0f);
		float fSlow562 = ((fSlow551 * (fSlow551 - fSlow560)) + 1.0f);
		float fSlow563 = (1.0f / fSlow503);
		float fSlow564 = (((fSlow502 - fSlow500) / fSlow501) + 1.0f);
		float fSlow565 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow501))));
		for (int i = 0; (i < count); i = (i + 1)) {
			iVec0[0] = 1;
			...
			fRec158[0] = (fTemp105 - (fSlow392 * ((fSlow393 * fRec158[2]) + (fSlow394 * fRec158[1]))));
			fRec159[0] = fRec132[1];
			...
			int iTemp147 = int(((fSlow396 * fTemp146) + -1.49999499f));
			...
			float fTemp150 = (fSlow396 * fTemp149);
			...
			float fTemp173 = (((fSlow381 * ftbl0mydspSIG0[int((65536.0f * fRec153[0]))]) + (fRec154[0] * ((fSlow391 * (fRec158[2] + (fRec158[0] + (2.0f * fRec158[1])))) + 1.0f))) - (0.5f * fVec14[1]));
			...
			int iTemp175 = int(((fSlow397 * fTemp146) + -1.49999499f));
			int iTemp176 = (int(std::min<float>(fConst33, float(std::max<int>(0, iTemp175)))) + 1);
			float fTemp177 = (fSlow397 * fTemp149);
			...
			fRec163[0] = std::max<float>(fTemp200, ((fRec163[1] * fSlow404) + (fTemp200 * fSlow405)));
			fRec162[0] = ((fRec162[1] * fSlow401) + (fRec163[0] * fSlow406));
			fRec161[0] = ((fConst30 * fRec161[1]) + (fSlow398 * std::max<float>(((20.0f * std::log10(fRec162[0])) - fSlow407), 0.0f)));
			float fTemp201 = (fSlow380 * (fRec131[0] * std::pow(10.0f, (0.0500000007f * fRec161[0]))));
			fRec164[0] = (fTemp201 - (fSlow411 * ((fSlow412 * fRec164[2]) + (fSlow413 * fRec164[1]))));
			float fTemp202 = (fSlow378 * fRec130[1]);
			fRec130[0] = (fTemp201 - ((fSlow411 * (fRec164[2] + (fRec164[0] + (2.0f * fRec164[1])))) + (((fRec130[2] * fSlow421) + fTemp202) / fSlow422)));
			float fTemp203 = (fSlow375 * fRec129[1]);
			fRec129[0] = ((((fTemp202 + (fRec130[0] * fSlow424)) + (fRec130[2] * fSlow425)) / fSlow422) - (((fRec129[2] * fSlow433) + fTemp203) / fSlow434));
			fRec128[0] = ((((fTemp203 + (fRec129[0] * fSlow436)) + (fRec129[2] * fSlow437)) / fSlow434) - (fSlow438 * ((fSlow439 * fRec128[2]) + (fSlow440 * fRec128[1]))));
			...
			float fTemp233 = (0.300000012f * fVec26[((IOTA - iConst113) & 2047)]);
			float fTemp234 = (fVec25[((IOTA - iConst169) & 16383)] - (fTemp233 + (0.600000024f * fRec177[1])));
			fVec27[(IOTA & 2047)] = fTemp234;
			fRec177[0] = fVec27[((IOTA - iConst170) & 2047)];
			float fRec178 = (0.600000024f * fTemp234);
			fRec199[0] = (0.0f - (fConst14 * ((fConst15 * fRec199[1]) - (fRec3[1] + fRec3[2]))));
			fRec198[0] = ((fConst179 * fRec198[1]) + (fConst180 * (fRec3[1] + (fConst181 * fRec199[0]))));
			fVec28[(IOTA & 16383)] = ((0.353553385f * fRec198[0]) + 9.99999968e-21f);
			float fTemp235 = (fVec28[((IOTA - iConst183) & 16383)] - (fTemp233 + (0.600000024f * fRec196[1])));
			fVec29[(IOTA & 4095)] = fTemp235;
			fRec196[0] = fVec29[((IOTA - iConst184) & 4095)];
			float fRec197 = (0.600000024f * fTemp235);
			fRec203[0] = (0.0f - (fConst14 * ((fConst15 * fRec203[1]) - (fRec5[1] + fRec5[2]))));
			fRec202[0] = ((fConst193 * fRec202[1]) + (fConst194 * (fRec5[1] + (fConst195 * fRec203[0]))));
			fVec30[(IOTA & 16383)] = ((0.353553385f * fRec202[0]) + 9.99999968e-21f);
			float fTemp236 = ((fTemp233 + fVec30[((IOTA - iConst197) & 16383)]) - (0.600000024f * fRec200[1]));
			fVec31[(IOTA & 4095)] = fTemp236;
			fRec200[0] = fVec31[((IOTA - iConst198) & 4095)];
			float fRec201 = (0.600000024f * fTemp236);
			fRec207[0] = (0.0f - (fConst14 * ((fConst15 * fRec207[1]) - (fRec1[1] + fRec1[2]))));
			fRec206[0] = ((fConst207 * fRec206[1]) + (fConst208 * (fRec1[1] + (fConst209 * fRec207[0]))));
			fVec32[(IOTA & 16383)] = ((0.353553385f * fRec206[0]) + 9.99999968e-21f);
			float fTemp237 = ((fVec32[((IOTA - iConst211) & 16383)] + fTemp233) - (0.600000024f * fRec204[1]));
			fVec33[(IOTA & 2047)] = fTemp237;
			fRec204[0] = fVec33[((IOTA - iConst212) & 2047)];
			...
			fRec208[0] = (fConst216 + (fConst110 * fRec208[1]));
			float fTemp245 = std::tan((fConst18 * fRec208[0]));
			float fTemp246 = mydsp_faustpower2_f(std::sqrt((fConst215 * fTemp245)));
			float fTemp247 = ((fConst214 * fTemp246) + -8.0f);
			float fTemp248 = (fConst213 * fTemp246);
			float fTemp249 = ((fConst218 * fTemp245) - (fConst219 * (fTemp246 / fTemp245)));
			float fTemp250 = (fConst217 * fTemp249);
			...
			float fTemp253 = (0.0f - (fConst217 * (fTemp249 / fTemp252)));
			fRec212[0] = ((0.999000013f * fRec212[1]) + (0.00100000005f * std::sqrt(std::max<float>(0.0f, std::min<float>(fTemp4, ((fConst220 * fTemp5) + 1.0f))))));
			fRec214[0] = (iTemp6 ? fSlow452 : fRec214[1]);
			float fTemp254 = (fRec218[1] + (fSlow453 * fRec214[0]));
			fRec218[0] = (fTemp254 - std::floor(fTemp254));
			float fTemp255 = (fRec217[1] + (fConst29 * ((315.0f * (fRec212[0] * ftbl0mydspSIG0[int((65536.0f * fRec218[0]))])) + (fSlow454 * fRec214[0]))));
			fRec217[0] = (fTemp255 - std::floor(fTemp255));
			float fTemp256 = (fRec216[1] + (fConst29 * ((315.0f * (fRec212[0] * ftbl0mydspSIG0[int((65536.0f * fRec217[0]))])) + (fSlow455 * fRec214[0]))));
			fRec216[0] = (fTemp256 - std::floor(fTemp256));
			float fTemp257 = (fRec215[1] + (fConst29 * ((315.0f * (fRec212[0] * ftbl0mydspSIG0[int((65536.0f * fRec216[0]))])) + (fSlow456 * fRec214[0]))));
			...
			fRec221[0] = std::max<float>(fTemp262, ((fRec221[1] * fSlow463) + (fTemp262 * fSlow464)));
			fRec220[0] = ((fRec220[1] * fSlow460) + (fRec221[0] * fSlow465));
			fRec219[0] = ((fConst30 * fRec219[1]) + (fSlow457 * std::max<float>(((20.0f * std::log10(fRec220[0])) - fSlow466), 0.0f)));
			float fTemp263 = (0.25f * (fTemp261 * std::pow(10.0f, (0.0500000007f * fRec219[0]))));
			fRec222[0] = (fTemp263 - (fSlow470 * ((fSlow471 * fRec222[2]) + (fSlow472 * fRec222[1]))));
			float fTemp264 = (fSlow451 * fRec211[1]);
			fRec211[0] = (fTemp263 - ((fSlow470 * (fRec222[2] + (fRec222[0] + (2.0f * fRec222[1])))) + (((fRec211[2] * fSlow480) + fTemp264) / fSlow481)));
			float fTemp265 = (fSlow448 * fRec210[1]);
			fRec210[0] = ((((fTemp264 + (fRec211[0] * fSlow483)) + (fRec211[2] * fSlow484)) / fSlow481) - (((fRec210[2] * fSlow492) + fTemp265) / fSlow493));
			fRec209[0] = ((((fTemp265 + (fRec210[0] * fSlow495)) + (fRec210[2] * fSlow496)) / fSlow493) - (fSlow497 * ((fSlow498 * fRec209[2]) + (fSlow499 * fRec209[1]))));
			float fTemp266 = (fSlow445 * (fRec209[2] + (fRec209[0] + (2.0f * fRec209[1]))));
			fRec228[0] = (fTemp105 - (fConst228 * ((fConst231 * fRec228[2]) + (fConst232 * fRec228[1]))));
			fRec227[0] = ((fConst228 * (((fConst230 * fRec228[0]) + (fConst233 * fRec228[1])) + (fConst230 * fRec228[2]))) - (fConst225 * ((fConst234 * fRec227[2]) + (fConst235 * fRec227[1]))));
			fVec34[0] = fSlow511;
			float fTemp267 = (fSlow511 - fVec34[1]);
			fVec35[0] = fSlow513;
			float fTemp268 = (0.0f - (fSlow511 + fVec35[1]));
			float fTemp269 = std::min<float>(1.0f, ((fTemp267 * float((fTemp267 > 0.0f))) + (fSlow512 * (fTemp268 * float((fTemp268 > 0.0f))))));
			fVec36[0] = fTemp269;
			iRec229[0] = (((iRec229[1] + (iRec229[1] > 0)) * (fTemp269 <= fVec36[1])) + (fTemp269 > fVec36[1]));
			float fTemp270 = float(iRec229[0]);
			float fTemp271 = (fConst236 * fTemp270);
			float fTemp272 = (fConst225 * ((fRec227[2] + (fRec227[0] + (2.0f * fRec227[1]))) * std::max<float>(0.0f, std::min<float>(fTemp271, (2.0f - fTemp271)))));
			fRec226[0] = (fTemp272 - ((fConst238 * fRec226[1]) + (fConst239 * fRec226[2])));
			fRec230[0] = (fTemp272 - ((fConst242 * fRec230[1]) + (fConst243 * fRec230[2])));
			fRec231[0] = (fTemp272 - ((fConst246 * fRec231[1]) + (fConst247 * fRec231[2])));
			fRec232[0] = (fTemp272 - ((fConst250 * fRec232[1]) + (fConst251 * fRec232[2])));
			fRec233[0] = (fTemp272 - ((fConst254 * fRec233[1]) + (fConst255 * fRec233[2])));
			fRec234[0] = (fTemp272 - ((fConst258 * fRec234[1]) + (fConst259 * fRec234[2])));
			fRec235[0] = (fTemp272 - ((fConst262 * fRec235[1]) + (fConst263 * fRec235[2])));
			fRec236[0] = (fTemp272 - ((fConst266 * fRec236[1]) + (fConst267 * fRec236[2])));
			fRec237[0] = (fTemp272 - ((fConst270 * fRec237[1]) + (fConst271 * fRec237[2])));
			fRec238[0] = (fTemp272 - ((fConst274 * fRec238[1]) + (fConst275 * fRec238[2])));
			fRec239[0] = (fTemp272 - ((fConst278 * fRec239[1]) + (fConst279 * fRec239[2])));
			fRec240[0] = (fTemp272 - ((fConst282 * fRec240[1]) + (fConst283 * fRec240[2])));
			fRec241[0] = (fTemp272 - ((fConst286 * fRec241[1]) + (fConst287 * fRec241[2])));
			fRec242[0] = (fTemp272 - ((fConst290 * fRec242[1]) + (fConst291 * fRec242[2])));
			fRec243[0] = (fTemp272 - ((fConst294 * fRec243[1]) + (fConst295 * fRec243[2])));
			fRec244[0] = (fTemp272 - ((fConst298 * fRec244[1]) + (fConst299 * fRec244[2])));
			fRec245[0] = (fTemp272 - ((fConst302 * fRec245[1]) + (fConst303 * fRec245[2])));
			fRec246[0] = (fTemp272 - ((fConst306 * fRec246[1]) + (fConst307 * fRec246[2])));
			fRec247[0] = (fTemp272 - ((fConst310 * fRec247[1]) + (fConst311 * fRec247[2])));
			fRec248[0] = (fTemp272 - ((fConst314 * fRec248[1]) + (fConst315 * fRec248[2])));
			fRec249[0] = (fTemp272 - ((fConst318 * fRec249[1]) + (fConst319 * fRec249[2])));
			fRec250[0] = (fTemp272 - ((fConst322 * fRec250[1]) + (fConst323 * fRec250[2])));
			fRec251[0] = (fTemp272 - ((fConst326 * fRec251[1]) + (fConst327 * fRec251[2])));
			fRec252[0] = (fTemp272 - ((fConst330 * fRec252[1]) + (fConst331 * fRec252[2])));
			fRec253[0] = (fTemp272 - ((fConst334 * fRec253[1]) + (fConst335 * fRec253[2])));
			fRec254[0] = (fTemp272 - ((fConst338 * fRec254[1]) + (fConst339 * fRec254[2])));
			fRec255[0] = (fTemp272 - ((fConst342 * fRec255[1]) + (fConst343 * fRec255[2])));
			fRec256[0] = (fTemp272 - ((fConst346 * fRec256[1]) + (fConst347 * fRec256[2])));
			fRec257[0] = (fTemp272 - ((fConst350 * fRec257[1]) + (fConst351 * fRec257[2])));
			fRec258[0] = (fTemp272 - ((fConst354 * fRec258[1]) + (fConst355 * fRec258[2])));
			fRec259[0] = (fTemp272 - ((fConst358 * fRec259[1]) + (fConst359 * fRec259[2])));
			fRec260[0] = (fTemp272 - ((fConst362 * fRec260[1]) + (fConst363 * fRec260[2])));
			fRec261[0] = (fTemp272 - ((fConst366 * fRec261[1]) + (fConst367 * fRec261[2])));
			fRec262[0] = (fTemp272 - ((fConst370 * fRec262[1]) + (fConst371 * fRec262[2])));
			fRec263[0] = (fTemp272 - ((fConst374 * fRec263[1]) + (fConst375 * fRec263[2])));
			fRec264[0] = (fTemp272 - ((fConst378 * fRec264[1]) + (fConst379 * fRec264[2])));
			fRec265[0] = (fTemp272 - ((fConst382 * fRec265[1]) + (fConst383 * fRec265[2])));
			fRec266[0] = (fTemp272 - ((fConst386 * fRec266[1]) + (fConst387 * fRec266[2])));
			fRec267[0] = (fTemp272 - ((fConst390 * fRec267[1]) + (fConst391 * fRec267[2])));
			fRec268[0] = (fTemp272 - ((fConst394 * fRec268[1]) + (fConst395 * fRec268[2])));
			fRec269[0] = (fTemp272 - ((fConst398 * fRec269[1]) + (fConst399 * fRec269[2])));
			fRec270[0] = (fTemp272 - ((fConst402 * fRec270[1]) + (fConst403 * fRec270[2])));
			fRec271[0] = (fTemp272 - ((fConst406 * fRec271[1]) + (fConst407 * fRec271[2])));
			fRec272[0] = (fTemp272 - ((fConst410 * fRec272[1]) + (fConst411 * fRec272[2])));
			fRec273[0] = (fTemp272 - ((fConst414 * fRec273[1]) + (fConst415 * fRec273[2])));
			fRec274[0] = (fTemp272 - ((fConst418 * fRec274[1]) + (fConst419 * fRec274[2])));
			fRec275[0] = (fTemp272 - ((fConst422 * fRec275[1]) + (fConst423 * fRec275[2])));
			fRec276[0] = (fTemp272 - ((fConst426 * fRec276[1]) + (fConst427 * fRec276[2])));
			fRec277[0] = (fTemp272 - ((fConst430 * fRec277[1]) + (fConst431 * fRec277[2])));
			fRec278[0] = (fTemp272 - ((fConst434 * fRec278[1]) + (fConst435 * fRec278[2])));
			fRec279[0] = (fSlow515 + (0.999000013f * fRec279[1]));
			fRec280[0] = (fSlow516 + (fRec280[1] - std::floor((fSlow516 + fRec280[1]))));
			fRec281[0] = (fSlow518 + (0.999000013f * fRec281[1]));
			fRec282[0] = (fSlow519 + (fRec282[1] - std::floor((fSlow519 + fRec282[1]))));
			fRec283[0] = (fSlow521 + (0.999000013f * fRec283[1]));
			fRec284[0] = (fSlow522 + (fRec284[1] - std::floor((fSlow522 + fRec284[1]))));
			float fTemp273 = ((0.0199999996f * (((((((((((((((((((((((((((((((((((((((((((((((((((fConst222 * (fRec226[0] - fRec226[2])) + (fConst240 * (fRec230[0] - fRec230[2]))) + (fConst244 * (fRec231[0] - fRec231[2]))) + (fConst248 * (fRec232[0] - fRec232[2]))) + (fConst252 * (fRec233[0] - fRec233[2]))) + (fConst256 * (fRec234[0] - fRec234[2]))) + (fConst260 * (fRec235[0] - fRec235[2]))) + (fConst264 * (fRec236[0] - fRec236[2]))) + (fConst268 * (fRec237[0] - fRec237[2]))) + (fConst272 * (fRec238[0] - fRec238[2]))) + (fConst276 * (fRec239[0] - fRec239[2]))) + (fConst280 * (fRec240[0] - fRec240[2]))) + (fConst284 * (fRec241[0] - fRec241[2]))) + (fConst288 * (fRec242[0] - fRec242[2]))) + (fConst292 * (fRec243[0] - fRec243[2]))) + (fConst296 * (fRec244[0] - fRec244[2]))) + (fConst300 * (fRec245[0] - fRec245[2]))) + (fConst304 * (fRec246[0] - fRec246[2]))) + (fConst308 * (fRec247[0] - fRec247[2]))) + (fConst312 * (fRec248[0] - fRec248[2]))) + (fConst316 * (fRec249[0] - fRec249[2]))) + (fConst320 * (fRec250[0] - fRec250[2]))) + (fConst324 * (fRec251[0] - fRec251[2]))) + (fConst328 * (fRec252[0] - fRec252[2]))) + (fConst332 * (fRec253[0] - fRec253[2]))) + (fConst336 * (fRec254[0] - fRec254[2]))) + (fConst340 * (fRec255[0] - fRec255[2]))) + (fConst344 * (fRec256[0] - fRec256[2]))) + (fConst348 * (fRec257[0] - fRec257[2]))) + (fConst352 * (fRec258[0] - fRec258[2]))) + (fConst356 * (fRec259[0] - fRec259[2]))) + (fConst360 * (fRec260[0] - fRec260[2]))) + (fConst364 * (fRec261[0] - fRec261[2]))) + (fConst368 * (fRec262[0] - fRec262[2]))) + (fConst372 * (fRec263[0] - fRec263[2]))) + (fConst376 * (fRec264[0] - fRec264[2]))) + (fConst380 * (fRec265[0] - fRec265[2]))) + (fConst384 * (fRec266[0] - fRec266[2]))) + (fConst388 * (fRec267[0] - fRec267[2]))) + (fConst392 * (fRec268[0] - fRec268[2]))) + (fConst396 * (fRec269[0] - fRec269[2]))) + (fConst400 * (fRec270[0] - fRec270[2]))) + (fConst404 * (fRec271[0] - fRec271[2]))) + (fConst408 * (fRec272[0] - fRec272[2]))) + (fConst412 * (fRec273[0] - fRec273[2]))) + (fConst416 * (fRec274[0] - fRec274[2]))) + (fConst420 * (fRec275[0] - fRec275[2]))) + (fConst424 * (fRec276[0] - fRec276[2]))) + (fConst428 * (fRec277[0] - fRec277[2]))) + (fConst432 * (fRec278[0] - fRec278[2]))) * std::max<float>(0.0f, std::min<float>((fConst22 * fTemp270), ((fConst436 * (fConst21 - fTemp270)) + 1.0f))))) + (2.0f * (((fRec279[0] * ftbl0mydspSIG0[int((65536.0f * fRec280[0]))]) + (fRec281[0] * ftbl0mydspSIG0[int((65536.0f * fRec282[0]))])) + (fRec283[0] * ftbl0mydspSIG0[int((65536.0f * fRec284[0]))]))));
			float fTemp274 = std::fabs((0.25f * fTemp273));
			fRec287[0] = std::max<float>(fTemp274, ((fRec287[1] * fSlow529) + (fTemp274 * fSlow530)));
			fRec286[0] = ((fRec286[1] * fSlow526) + (fRec287[0] * fSlow531));
			fRec285[0] = ((fConst30 * fRec285[1]) + (fSlow523 * std::max<float>(((20.0f * std::log10(fRec286[0])) - fSlow532), 0.0f)));
			float fTemp275 = (0.25f * (fTemp273 * std::pow(10.0f, (0.0500000007f * fRec285[0]))));
			fRec288[0] = (fTemp275 - (fSlow536 * ((fSlow537 * fRec288[2]) + (fSlow538 * fRec288[1]))));
			float fTemp276 = (fSlow510 * fRec225[1]);
			fRec225[0] = (fTemp275 - ((fSlow536 * (fRec288[2] + (fRec288[0] + (2.0f * fRec288[1])))) + (((fRec225[2] * fSlow546) + fTemp276) / fSlow547)));
			float fTemp277 = (fSlow507 * fRec224[1]);
			fRec224[0] = ((((fTemp276 + (fRec225[0] * fSlow549)) + (fRec225[2] * fSlow550)) / fSlow547) - (((fRec224[2] * fSlow558) + fTemp277) / fSlow559));
			fRec223[0] = ((((fTemp277 + (fRec224[0] * fSlow561)) + (fRec224[2] * fSlow562)) / fSlow559) - (fSlow563 * ((fSlow564 * fRec223[2]) + (fSlow565 * fRec223[1]))));
			float fTemp278 = (fSlow504 * (fRec223[2] + (fRec223[0] + (2.0f * fRec223[1]))));
			float fTemp279 = ((fRec0[2] * fTemp253) + ((((fTemp232 + fTemp266) + fTemp104) + fTemp278) + (fConst217 * ((fRec0[0] * fTemp249) / fTemp252))));
			float fTemp280 = std::fabs(fTemp279);
			fRec291[0] = std::max<float>(fTemp280, ((fConst439 * fRec291[1]) + (fConst440 * fTemp280)));
			fRec290[0] = ((fConst437 * fRec290[1]) + (fConst438 * fRec291[0]));
			...
			fRec294[0] = std::max<float>(fTemp282, ((fConst443 * fRec294[1]) + (fConst444 * fTemp282)));
			fRec293[0] = ((fConst441 * fRec293[1]) + (fConst442 * fRec294[0]));
			...
			float fTemp285 = ((fTemp253 * fRec298[2]) + ((fTemp37 + (fTemp278 + (fTemp104 + (fTemp266 + fTemp205)))) + (fConst217 * ((fRec298[0] * fTemp249) / fTemp252))));
			float fTemp286 = std::fabs(fTemp285);
			fRec301[0] = std::max<float>(fTemp286, ((fConst439 * fRec301[1]) + (fConst440 * fTemp286)));
			fRec300[0] = ((fConst437 * fRec300[1]) + (fConst438 * fRec301[0]));
			...
			fRec304[0] = std::max<float>(fTemp288, ((fConst443 * fRec304[1]) + (fConst444 * fTemp288)));
			fRec303[0] = ((fConst441 * fRec303[1]) + (fConst442 * fRec304[0]));
