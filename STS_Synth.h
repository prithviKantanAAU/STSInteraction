...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow380 = (fConst109 * ((11.1111107f * (fSlow379 + -0.0359999985f)) + 1.0f));
		float fSlow381 = (fConst111 * float(fHslider85));
		float fSlow382 = float(fHslider86);
		float fSlow383 = float((fSlow382 > 0.0f));
		float fSlow384 = (0.0f - fSlow382);
		float fSlow385 = float(fHslider87);
		float fSlow386 = (0.400000006f * (float(fHslider88) + -0.5f));
		float fSlow387 = (fConst119 * (fSlow386 + 0.270000011f));
		float fSlow388 = (fConst119 * (0.730000019f - fSlow386));
		float fSlow389 = (fConst31 * ((1.0f / float(fHslider89)) + -1.0f));
		...
		float fSlow393 = float(fHslider91);
		int iSlow394 = (std::fabs(fSlow393) < 1.1920929e-07f);
		float fSlow395 = (iSlow394 ? 0.0f : std::exp((0.0f - (fConst29 / (iSlow394 ? 1.0f : fSlow393)))));
		float fSlow396 = (1.0f - fSlow395);
		float fSlow397 = (1.0f - fSlow392);
		float fSlow398 = float(fHslider92);
		float fSlow399 = (1.0f / float(fHslider93));
		float fSlow400 = std::tan((fConst18 * float(fHslider94)));
		float fSlow401 = (1.0f / fSlow400);
		float fSlow402 = (1.0f / (((fSlow399 + fSlow401) / fSlow400) + 1.0f));
		float fSlow403 = (((fSlow401 - fSlow399) / fSlow400) + 1.0f);
		float fSlow404 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow400))));
		float fSlow405 = (1.0f / fSlow377);
		float fSlow406 = float(fHslider95);
		int iSlow407 = (fSlow406 > 0.0f);
		float fSlow408 = (float(fHslider96) * std::sin((fConst32 * fSlow376)));
		float fSlow409 = (fConst18 * ((fSlow376 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow406)))) / fSlow408));
		float fSlow410 = (fConst18 * (fSlow376 / fSlow408));
		float fSlow411 = (iSlow407 ? fSlow410 : fSlow409);
		float fSlow412 = ((fSlow405 * (fSlow405 - fSlow411)) + 1.0f);
		float fSlow413 = ((fSlow405 * (fSlow405 + fSlow411)) + 1.0f);
		float fSlow414 = (iSlow407 ? fSlow409 : fSlow410);
		float fSlow415 = ((fSlow405 * (fSlow405 + fSlow414)) + 1.0f);
		float fSlow416 = ((fSlow405 * (fSlow405 - fSlow414)) + 1.0f);
		float fSlow417 = (1.0f / fSlow374);
		float fSlow418 = float(fHslider97);
		int iSlow419 = (fSlow418 > 0.0f);
		float fSlow420 = (float(fHslider98) * std::sin((fConst32 * fSlow373)));
		float fSlow421 = (fConst18 * ((fSlow373 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow418)))) / fSlow420));
		float fSlow422 = (fConst18 * (fSlow373 / fSlow420));
		float fSlow423 = (iSlow419 ? fSlow422 : fSlow421);
		float fSlow424 = ((fSlow417 * (fSlow417 - fSlow423)) + 1.0f);
		float fSlow425 = ((fSlow417 * (fSlow417 + fSlow423)) + 1.0f);
		float fSlow426 = (iSlow419 ? fSlow421 : fSlow422);
		float fSlow427 = ((fSlow417 * (fSlow417 + fSlow426)) + 1.0f);
		float fSlow428 = ((fSlow417 * (fSlow417 - fSlow426)) + 1.0f);
		float fSlow429 = (1.0f / fSlow371);
		float fSlow430 = (((fSlow370 - fSlow368) / fSlow369) + 1.0f);
		float fSlow431 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow369))));
		float fSlow432 = (1.0f / float(fHslider100));
		float fSlow433 = std::tan((fConst18 * float(fHslider101)));
		float fSlow434 = (1.0f / fSlow433);
		float fSlow435 = (((fSlow432 + fSlow434) / fSlow433) + 1.0f);
		float fSlow436 = ((std::pow(10.0f, (0.0500000007f * float(fHslider99))) * (1.0f - float(fCheckbox6))) / fSlow435);
		...
		float fSlow440 = float(fHslider103);
		float fSlow441 = std::tan((fConst18 * fSlow440));
		float fSlow442 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow441))));
		float fSlow443 = (0.5f * fSlow17);
		float fSlow444 = (fConst228 * fSlow18);
		float fSlow445 = (27.0f * fSlow18);
		float fSlow446 = (9.0f * fSlow18);
		float fSlow447 = (3.0f * fSlow18);
		float fSlow448 = (fConst31 * ((1.0f / float(fHslider104)) + -1.0f));
		...
		float fSlow452 = float(fHslider106);
		int iSlow453 = (std::fabs(fSlow452) < 1.1920929e-07f);
		float fSlow454 = (iSlow453 ? 0.0f : std::exp((0.0f - (fConst29 / (iSlow453 ? 1.0f : fSlow452)))));
		float fSlow455 = (1.0f - fSlow454);
		float fSlow456 = (1.0f - fSlow451);
		float fSlow457 = float(fHslider107);
		float fSlow458 = (1.0f / float(fHslider108));
		float fSlow459 = std::tan((fConst18 * float(fHslider109)));
		float fSlow460 = (1.0f / fSlow459);
		float fSlow461 = (1.0f / (((fSlow458 + fSlow460) / fSlow459) + 1.0f));
		float fSlow462 = (((fSlow460 - fSlow458) / fSlow459) + 1.0f);
		float fSlow463 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow459))));
		float fSlow464 = (1.0f / fSlow441);
		float fSlow465 = float(fHslider110);
		int iSlow466 = (fSlow465 > 0.0f);
		float fSlow467 = (float(fHslider111) * std::sin((fConst32 * fSlow440)));
		float fSlow468 = (fConst18 * ((fSlow440 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow465)))) / fSlow467));
		float fSlow469 = (fConst18 * (fSlow440 / fSlow467));
		float fSlow470 = (iSlow466 ? fSlow469 : fSlow468);
		float fSlow471 = ((fSlow464 * (fSlow464 - fSlow470)) + 1.0f);
		float fSlow472 = ((fSlow464 * (fSlow464 + fSlow470)) + 1.0f);
		float fSlow473 = (iSlow466 ? fSlow468 : fSlow469);
		float fSlow474 = ((fSlow464 * (fSlow464 + fSlow473)) + 1.0f);
		float fSlow475 = ((fSlow464 * (fSlow464 - fSlow473)) + 1.0f);
		float fSlow476 = (1.0f / fSlow438);
		float fSlow477 = float(fHslider112);
		int iSlow478 = (fSlow477 > 0.0f);
		float fSlow479 = (float(fHslider113) * std::sin((fConst32 * fSlow437)));
		float fSlow480 = (fConst18 * ((fSlow437 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow477)))) / fSlow479));
		float fSlow481 = (fConst18 * (fSlow437 / fSlow479));
		float fSlow482 = (iSlow478 ? fSlow481 : fSlow480);
		float fSlow483 = ((fSlow476 * (fSlow476 - fSlow482)) + 1.0f);
		float fSlow484 = ((fSlow476 * (fSlow476 + fSlow482)) + 1.0f);
		float fSlow485 = (iSlow478 ? fSlow480 : fSlow481);
		float fSlow486 = ((fSlow476 * (fSlow476 + fSlow485)) + 1.0f);
		float fSlow487 = ((fSlow476 * (fSlow476 - fSlow485)) + 1.0f);
		float fSlow488 = (1.0f / fSlow435);
		float fSlow489 = (((fSlow434 - fSlow432) / fSlow433) + 1.0f);
		float fSlow490 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow433))));
		float fSlow491 = (1.0f / float(fHslider115));
		float fSlow492 = std::tan((fConst18 * float(fHslider116)));
		float fSlow493 = (1.0f / fSlow492);
		float fSlow494 = (((fSlow491 + fSlow493) / fSlow492) + 1.0f);
		float fSlow495 = ((std::pow(10.0f, (0.0500000007f * float(fHslider114))) * (1.0f - float(fCheckbox7))) / fSlow494);
		...
		float fSlow500 = std::tan((fConst18 * fSlow499));
		float fSlow501 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow500))));
		float fSlow502 = float(fHslider119);
		float fSlow503 = float((fSlow502 > 0.0f));
		float fSlow504 = (0.0f - fSlow502);
		float fSlow505 = float(fHslider120);
		float fSlow506 = (0.00100000005f * float((fSlow505 > 310.0f)));
		float fSlow507 = (fConst29 * std::max<float>(20.0f, fSlow505));
		float fSlow508 = float(fHslider121);
		float fSlow509 = (0.00100000005f * float((fSlow508 > 610.0f)));
		float fSlow510 = (fConst29 * std::max<float>(20.0f, fSlow508));
		float fSlow511 = float(fHslider122);
		float fSlow512 = (0.00100000005f * float((fSlow511 > 1210.0f)));
		float fSlow513 = (fConst29 * std::max<float>(20.0f, fSlow511));
		float fSlow514 = (fConst31 * ((1.0f / float(fHslider123)) + -1.0f));
		...
		float fSlow518 = float(fHslider125);
		int iSlow519 = (std::fabs(fSlow518) < 1.1920929e-07f);
		float fSlow520 = (iSlow519 ? 0.0f : std::exp((0.0f - (fConst29 / (iSlow519 ? 1.0f : fSlow518)))));
		float fSlow521 = (1.0f - fSlow520);
		float fSlow522 = (1.0f - fSlow517);
		float fSlow523 = float(fHslider126);
		float fSlow524 = (1.0f / float(fHslider127));
		float fSlow525 = std::tan((fConst18 * float(fHslider128)));
		float fSlow526 = (1.0f / fSlow525);
		float fSlow527 = (1.0f / (((fSlow524 + fSlow526) / fSlow525) + 1.0f));
		float fSlow528 = (((fSlow526 - fSlow524) / fSlow525) + 1.0f);
		float fSlow529 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow525))));
		float fSlow530 = (1.0f / fSlow500);
		float fSlow531 = float(fHslider129);
		int iSlow532 = (fSlow531 > 0.0f);
		float fSlow533 = (float(fHslider130) * std::sin((fConst32 * fSlow499)));
		float fSlow534 = (fConst18 * ((fSlow499 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow531)))) / fSlow533));
		float fSlow535 = (fConst18 * (fSlow499 / fSlow533));
		...
		float fSlow542 = (1.0f / fSlow497);
		float fSlow543 = float(fHslider131);
		int iSlow544 = (fSlow543 > 0.0f);
		float fSlow545 = (float(fHslider132) * std::sin((fConst32 * fSlow496)));
		float fSlow546 = (fConst18 * ((fSlow496 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow543)))) / fSlow545));
		float fSlow547 = (fConst18 * (fSlow496 / fSlow545));
		float fSlow548 = (iSlow544 ? fSlow547 : fSlow546);
		float fSlow549 = ((fSlow542 * (fSlow542 - fSlow548)) + 1.0f);
		float fSlow550 = ((fSlow542 * (fSlow542 + fSlow548)) + 1.0f);
		float fSlow551 = (iSlow544 ? fSlow546 : fSlow547);
		float fSlow552 = ((fSlow542 * (fSlow542 + fSlow551)) + 1.0f);
		float fSlow553 = ((fSlow542 * (fSlow542 - fSlow551)) + 1.0f);
		float fSlow554 = (1.0f / fSlow494);
		float fSlow555 = (((fSlow493 - fSlow491) / fSlow492) + 1.0f);
		float fSlow556 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow492))));
		for (int i = 0; (i < count); i = (i + 1)) {
			iVec0[0] = 1;
			...
			fRec153[0] = (fSlow380 + (fRec153[1] - std::floor((fSlow380 + fRec153[1]))));
			fVec12[0] = fSlow382;
			float fTemp142 = (fSlow382 - fVec12[1]);
			fVec13[0] = fSlow384;
			float fTemp143 = (0.0f - (fSlow382 + fVec13[1]));
			fRec157[0] = (int(std::min<float>(1.0f, ((fTemp142 * float((fTemp142 > 0.0f))) + (fSlow383 * (fTemp143 * float((fTemp143 > 0.0f))))))) ? fSlow385 : fRec157[1]);
			...
			fRec154[0] = ((fConst110 * fRec154[1]) + (fSlow381 * fRec155[0]));
			...
			int iTemp147 = int(((fSlow387 * fTemp146) + -1.49999499f));
			...
			float fTemp150 = (fSlow387 * fTemp149);
			...
			float fTemp173 = (((fSlow379 * ftbl0mydspSIG0[int((65536.0f * fRec153[0]))]) + (fRec154[0] * ((fConst115 * (fRec158[2] + (fRec158[0] + (2.0f * fRec158[1])))) + 1.0f))) - (0.5f * fVec14[1]));
			...
			int iTemp175 = int(((fSlow388 * fTemp146) + -1.49999499f));
			int iTemp176 = (int(std::min<float>(fConst33, float(std::max<int>(0, iTemp175)))) + 1);
			float fTemp177 = (fSlow388 * fTemp149);
			...
			fRec163[0] = std::max<float>(fTemp200, ((fRec163[1] * fSlow395) + (fTemp200 * fSlow396)));
			fRec162[0] = ((fRec162[1] * fSlow392) + (fRec163[0] * fSlow397));
			fRec161[0] = ((fConst30 * fRec161[1]) + (fSlow389 * std::max<float>(((20.0f * std::log10(fRec162[0])) - fSlow398), 0.0f)));
			float fTemp201 = (0.125f * (fRec131[0] * std::pow(10.0f, (0.0500000007f * fRec161[0]))));
			fRec164[0] = (fTemp201 - (fSlow402 * ((fSlow403 * fRec164[2]) + (fSlow404 * fRec164[1]))));
			float fTemp202 = (fSlow378 * fRec130[1]);
			fRec130[0] = (fTemp201 - ((fSlow402 * (fRec164[2] + (fRec164[0] + (2.0f * fRec164[1])))) + (((fRec130[2] * fSlow412) + fTemp202) / fSlow413)));
			float fTemp203 = (fSlow375 * fRec129[1]);
			fRec129[0] = ((((fTemp202 + (fRec130[0] * fSlow415)) + (fRec130[2] * fSlow416)) / fSlow413) - (((fRec129[2] * fSlow424) + fTemp203) / fSlow425));
			fRec128[0] = ((((fTemp203 + (fRec129[0] * fSlow427)) + (fRec129[2] * fSlow428)) / fSlow425) - (fSlow429 * ((fSlow430 * fRec128[2]) + (fSlow431 * fRec128[1]))));
			...
			fRec214[0] = (iTemp6 ? fSlow443 : fRec214[1]);
			float fTemp254 = (fRec218[1] + (fSlow444 * fRec214[0]));
			fRec218[0] = (fTemp254 - std::floor(fTemp254));
			float fTemp255 = (fRec217[1] + (fConst29 * ((315.0f * (fRec212[0] * ftbl0mydspSIG0[int((65536.0f * fRec218[0]))])) + (fSlow445 * fRec214[0]))));
			fRec217[0] = (fTemp255 - std::floor(fTemp255));
			float fTemp256 = (fRec216[1] + (fConst29 * ((315.0f * (fRec212[0] * ftbl0mydspSIG0[int((65536.0f * fRec217[0]))])) + (fSlow446 * fRec214[0]))));
			fRec216[0] = (fTemp256 - std::floor(fTemp256));
			float fTemp257 = (fRec215[1] + (fConst29 * ((315.0f * (fRec212[0] * ftbl0mydspSIG0[int((65536.0f * fRec216[0]))])) + (fSlow447 * fRec214[0]))));
			...
			fRec221[0] = std::max<float>(fTemp262, ((fRec221[1] * fSlow454) + (fTemp262 * fSlow455)));
			fRec220[0] = ((fRec220[1] * fSlow451) + (fRec221[0] * fSlow456));
			fRec219[0] = ((fConst30 * fRec219[1]) + (fSlow448 * std::max<float>(((20.0f * std::log10(fRec220[0])) - fSlow457), 0.0f)));
			float fTemp263 = (0.25f * (fTemp261 * std::pow(10.0f, (0.0500000007f * fRec219[0]))));
			fRec222[0] = (fTemp263 - (fSlow461 * ((fSlow462 * fRec222[2]) + (fSlow463 * fRec222[1]))));
			float fTemp264 = (fSlow442 * fRec211[1]);
			fRec211[0] = (fTemp263 - ((fSlow461 * (fRec222[2] + (fRec222[0] + (2.0f * fRec222[1])))) + (((fRec211[2] * fSlow471) + fTemp264) / fSlow472)));
			float fTemp265 = (fSlow439 * fRec210[1]);
			fRec210[0] = ((((fTemp264 + (fRec211[0] * fSlow474)) + (fRec211[2] * fSlow475)) / fSlow472) - (((fRec210[2] * fSlow483) + fTemp265) / fSlow484));
			fRec209[0] = ((((fTemp265 + (fRec210[0] * fSlow486)) + (fRec210[2] * fSlow487)) / fSlow484) - (fSlow488 * ((fSlow489 * fRec209[2]) + (fSlow490 * fRec209[1]))));
			float fTemp266 = (fSlow436 * (fRec209[2] + (fRec209[0] + (2.0f * fRec209[1]))));
			...
			fVec34[0] = fSlow502;
			float fTemp267 = (fSlow502 - fVec34[1]);
			fVec35[0] = fSlow504;
			float fTemp268 = (0.0f - (fSlow502 + fVec35[1]));
			float fTemp269 = std::min<float>(1.0f, ((fTemp267 * float((fTemp267 > 0.0f))) + (fSlow503 * (fTemp268 * float((fTemp268 > 0.0f))))));
			fVec36[0] = fTemp269;
			...
			fRec279[0] = (fSlow506 + (0.999000013f * fRec279[1]));
			fRec280[0] = (fSlow507 + (fRec280[1] - std::floor((fSlow507 + fRec280[1]))));
			fRec281[0] = (fSlow509 + (0.999000013f * fRec281[1]));
			fRec282[0] = (fSlow510 + (fRec282[1] - std::floor((fSlow510 + fRec282[1]))));
			fRec283[0] = (fSlow512 + (0.999000013f * fRec283[1]));
			fRec284[0] = (fSlow513 + (fRec284[1] - std::floor((fSlow513 + fRec284[1]))));
			...
			fRec287[0] = std::max<float>(fTemp274, ((fRec287[1] * fSlow520) + (fTemp274 * fSlow521)));
			fRec286[0] = ((fRec286[1] * fSlow517) + (fRec287[0] * fSlow522));
			fRec285[0] = ((fConst30 * fRec285[1]) + (fSlow514 * std::max<float>(((20.0f * std::log10(fRec286[0])) - fSlow523), 0.0f)));
			float fTemp275 = (0.25f * (fTemp273 * std::pow(10.0f, (0.0500000007f * fRec285[0]))));
			fRec288[0] = (fTemp275 - (fSlow527 * ((fSlow528 * fRec288[2]) + (fSlow529 * fRec288[1]))));
			float fTemp276 = (fSlow501 * fRec225[1]);
			fRec225[0] = (fTemp275 - ((fSlow527 * (fRec288[2] + (fRec288[0] + (2.0f * fRec288[1])))) + (((fRec225[2] * fSlow537) + fTemp276) / fSlow538)));
			float fTemp277 = (fSlow498 * fRec224[1]);
			fRec224[0] = ((((fTemp276 + (fRec225[0] * fSlow540)) + (fRec225[2] * fSlow541)) / fSlow538) - (((fRec224[2] * fSlow549) + fTemp277) / fSlow550));
			fRec223[0] = ((((fTemp277 + (fRec224[0] * fSlow552)) + (fRec224[2] * fSlow553)) / fSlow550) - (fSlow554 * ((fSlow555 * fRec223[2]) + (fSlow556 * fRec223[1]))));
			float fTemp278 = (fSlow495 * (fRec223[2] + (fRec223[0] + (2.0f * fRec223[1]))));
