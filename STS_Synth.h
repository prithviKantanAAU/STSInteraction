...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("Control 0", &fHslider6, 0.5f, 0.0f, 2000.0f, 0.00100000005f);
		ui_interface->closeBox();
		...
		ui_interface->addHorizontalSlider("Control 0", &fHslider5, 440.0f, 0.0f, 2000.0f, 0.00100000005f);
		ui_interface->closeBox();
		...
		ui_interface->addHorizontalSlider("Control 0", &fHslider11, 7.0f, 0.0f, 2000.0f, 0.00100000005f);
		ui_interface->closeBox();
		ui_interface->closeBox();
		ui_interface->closeBox();
	}
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow12 = std::pow(10.0f, (2.0f * (std::min<float>(1.0f, std::max<float>(0.0f, float(fHslider6))) + -0.5f)));
		float fSlow13 = (2.0f * (float(fHslider5) * fSlow12));
		float fSlow14 = std::min<float>(1.0f, std::max<float>(0.0f, float(fHslider7)));
		float fSlow15 = (0.5f * fSlow14);
		float fSlow16 = std::min<float>(1000.0f, std::max<float>(0.0f, float(fHslider8)));
		float fSlow17 = (1.0f - fSlow16);
		float fSlow18 = (4.65661287e-10f * fSlow16);
		float fSlow19 = std::min<float>(3.0f, std::max<float>(0.0f, float(fHslider9)));
		float fSlow20 = (fSlow19 + 5.0f);
		int iSlow21 = (fSlow20 < 23.0f);
		int iSlow22 = (fSlow20 < 24.0f);
		float fSlow23 = (fSlow19 + -18.0f);
		int iSlow24 = (fSlow20 < 22.0f);
		float fSlow25 = (fSlow19 + -17.0f);
		int iSlow26 = (fSlow20 < 21.0f);
		float fSlow27 = (fSlow19 + -16.0f);
		int iSlow28 = (fSlow20 < 20.0f);
		float fSlow29 = (fSlow19 + -15.0f);
		int iSlow30 = (fSlow20 < 19.0f);
		float fSlow31 = (fSlow19 + -14.0f);
		int iSlow32 = (fSlow20 < 18.0f);
		float fSlow33 = (fSlow19 + -13.0f);
		int iSlow34 = (fSlow20 < 17.0f);
		float fSlow35 = (fSlow19 + -12.0f);
		int iSlow36 = (fSlow20 < 16.0f);
		float fSlow37 = (fSlow19 + -11.0f);
		float fSlow38 = (80.0f * fSlow37);
		int iSlow39 = (fSlow20 < 15.0f);
		float fSlow40 = (fSlow19 + -10.0f);
		int iSlow41 = (fSlow20 < 14.0f);
		float fSlow42 = (fSlow19 + -9.0f);
		int iSlow43 = (fSlow20 < 13.0f);
		float fSlow44 = (fSlow19 + -8.0f);
		int iSlow45 = (fSlow20 < 12.0f);
		float fSlow46 = (fSlow19 + -7.0f);
		int iSlow47 = (fSlow20 < 11.0f);
		float fSlow48 = (fSlow19 + -6.0f);
		int iSlow49 = (fSlow20 < 10.0f);
		float fSlow50 = (fSlow19 + -5.0f);
		int iSlow51 = (fSlow20 < 9.0f);
		float fSlow52 = (fSlow19 + -4.0f);
		int iSlow53 = (fSlow20 < 8.0f);
		float fSlow54 = (fSlow19 + -3.0f);
		float fSlow55 = (50.0f * fSlow54);
		int iSlow56 = (fSlow20 < 7.0f);
		float fSlow57 = (fSlow19 + -2.0f);
		int iSlow58 = (fSlow20 < 6.0f);
		float fSlow59 = (fSlow19 + -1.0f);
		int iSlow60 = (fSlow20 < 5.0f);
		int iSlow61 = (fSlow20 < 4.0f);
		float fSlow62 = (fSlow19 + 1.0f);
		int iSlow63 = (fSlow20 < 3.0f);
		float fSlow64 = (fSlow19 + 2.0f);
		int iSlow65 = (fSlow20 < 2.0f);
		float fSlow66 = (fSlow19 + 3.0f);
		int iSlow67 = (fSlow20 < 1.0f);
		float fSlow68 = (fSlow19 + 4.0f);
		int iSlow69 = (fSlow20 < 0.0f);
		float fSlow70 = (iSlow21 ? (iSlow24 ? (iSlow26 ? (iSlow28 ? (iSlow30 ? (iSlow32 ? (iSlow34 ? (iSlow36 ? (iSlow39 ? (iSlow41 ? (iSlow43 ? (iSlow45 ? (iSlow47 ? (iSlow49 ? (iSlow51 ? (iSlow53 ? (iSlow56 ? (iSlow58 ? (iSlow60 ? (iSlow61 ? (iSlow63 ? (iSlow65 ? (iSlow67 ? (iSlow69 ? 800.0f : (iSlow67 ? (800.0f - (400.0f * fSlow20)) : 400.0f)) : (iSlow65 ? (400.0f - (50.0f * fSlow68)) : 350.0f)) : (iSlow63 ? ((100.0f * fSlow66) + 350.0f) : 450.0f)) : (iSlow61 ? (450.0f - (125.0f * fSlow64)) : 325.0f)) : (iSlow60 ? ((275.0f * fSlow62) + 325.0f) : 600.0f)) : (iSlow58 ? (600.0f - (200.0f * fSlow19)) : 400.0f)) : (iSlow56 ? (400.0f - (150.0f * fSlow59)) : 250.0f)) : (iSlow53 ? ((150.0f * fSlow57) + 250.0f) : 400.0f)) : (iSlow51 ? (400.0f - fSlow55) : 350.0f)) : (iSlow49 ? ((310.0f * fSlow52) + 350.0f) : 660.0f)) : (iSlow47 ? (660.0f - (220.0f * fSlow50)) : 440.0f)) : (iSlow45 ? (440.0f - (170.0f * fSlow48)) : 270.0f)) : (iSlow43 ? ((160.0f * fSlow46) + 270.0f) : 430.0f)) : (iSlow41 ? (430.0f - (60.0f * fSlow44)) : 370.0f)) : (iSlow39 ? ((430.0f * fSlow42) + 370.0f) : 800.0f)) : (iSlow36 ? (800.0f - (450.0f * fSlow40)) : 350.0f)) : (iSlow34 ? (350.0f - fSlow38) : 270.0f)) : (iSlow32 ? ((180.0f * fSlow35) + 270.0f) : 450.0f)) : (iSlow30 ? (450.0f - (125.0f * fSlow33)) : 325.0f)) : (iSlow28 ? (325.0f * (fSlow31 + 1.0f)) : 650.0f)) : (iSlow26 ? (650.0f - (250.0f * fSlow29)) : 400.0f)) : (iSlow24 ? (400.0f - (110.0f * fSlow27)) : 290.0f)) : (iSlow21 ? ((110.0f * fSlow25) + 290.0f) : 400.0f)) : (iSlow22 ? (400.0f - (50.0f * fSlow23)) : 350.0f));
		float fSlow71 = (20.0f * fSlow29);
		float fSlow72 = (20.0f * fSlow40);
		float fSlow73 = (10.0f * fSlow50);
		float fSlow74 = (10.0f * fSlow62);
		float fSlow75 = (20.0f * fSlow64);
		float fSlow76 = (20.0f * fSlow66);
		float fSlow77 = (20.0f * fSlow20);
		float fSlow78 = (iSlow21 ? (iSlow24 ? (iSlow26 ? (iSlow28 ? (iSlow30 ? (iSlow32 ? (iSlow34 ? (iSlow36 ? (iSlow39 ? (iSlow41 ? (iSlow43 ? (iSlow45 ? (iSlow47 ? (iSlow49 ? (iSlow51 ? (iSlow53 ? (iSlow56 ? (iSlow58 ? (iSlow60 ? (iSlow61 ? (iSlow63 ? (iSlow65 ? (iSlow67 ? (iSlow69 ? 80.0f : (iSlow67 ? (80.0f - fSlow77) : 60.0f)) : (iSlow65 ? (60.0f - (10.0f * fSlow68)) : 50.0f)) : (iSlow63 ? (fSlow76 + 50.0f) : 70.0f)) : (iSlow61 ? (70.0f - fSlow75) : 50.0f)) : (iSlow60 ? (fSlow74 + 50.0f) : 60.0f)) : (iSlow58 ? (60.0f - (20.0f * fSlow19)) : 40.0f)) : (iSlow56 ? ((20.0f * fSlow59) + 40.0f) : 60.0f)) : (iSlow53 ? (60.0f - (20.0f * fSlow57)) : 40.0f)) : 40.0f) : (iSlow49 ? (40.0f * (fSlow52 + 1.0f)) : 80.0f)) : (iSlow47 ? (80.0f - fSlow73) : 70.0f)) : (iSlow45 ? (70.0f - (30.0f * fSlow48)) : 40.0f)) : 40.0f) : 40.0f) : (iSlow39 ? (40.0f * (fSlow42 + 1.0f)) : 80.0f)) : (iSlow36 ? (80.0f - fSlow72) : 60.0f)) : 60.0f) : (iSlow32 ? (60.0f - (20.0f * fSlow35)) : 40.0f)) : (iSlow30 ? ((10.0f * fSlow33) + 40.0f) : 50.0f)) : 50.0f) : (iSlow26 ? (fSlow71 + 50.0f) : 70.0f)) : (iSlow24 ? (70.0f - (30.0f * fSlow27)) : 40.0f)) : (iSlow21 ? ((30.0f * fSlow25) + 40.0f) : 70.0f)) : (iSlow22 ? (70.0f - (30.0f * fSlow23)) : 40.0f));
		float fSlow79 = (iSlow21 ? (iSlow24 ? (iSlow26 ? (iSlow28 ? (iSlow30 ? (iSlow32 ? (iSlow34 ? (iSlow36 ? (iSlow39 ? (iSlow41 ? (iSlow43 ? (iSlow45 ? (iSlow47 ? (iSlow49 ? (iSlow51 ? (iSlow53 ? (iSlow56 ? (iSlow58 ? (iSlow60 ? (iSlow61 ? (iSlow63 ? (iSlow65 ? (iSlow67 ? (iSlow69 ? 1150.0f : (iSlow67 ? ((450.0f * fSlow20) + 1150.0f) : 1600.0f)) : (iSlow65 ? ((100.0f * fSlow68) + 1600.0f) : 1700.0f)) : (iSlow63 ? (1700.0f - (900.0f * fSlow66)) : 800.0f)) : (iSlow61 ? (800.0f - (100.0f * fSlow64)) : 700.0f)) : (iSlow60 ? ((340.0f * fSlow62) + 700.0f) : 1040.0f)) : (iSlow58 ? ((580.0f * fSlow19) + 1040.0f) : 1620.0f)) : (iSlow56 ? ((130.0f * fSlow59) + 1620.0f) : 1750.0f)) : (iSlow53 ? (1750.0f - (1000.0f * fSlow57)) : 750.0f)) : (iSlow51 ? (750.0f - (150.0f * fSlow54)) : 600.0f)) : (iSlow49 ? ((520.0f * fSlow52) + 600.0f) : 1120.0f)) : (iSlow47 ? ((680.0f * fSlow50) + 1120.0f) : 1800.0f)) : (iSlow45 ? ((50.0f * fSlow48) + 1800.0f) : 1850.0f)) : (iSlow43 ? (1850.0f - (1030.0f * fSlow46)) : 820.0f)) : (iSlow41 ? (820.0f - (190.0f * fSlow44)) : 630.0f)) : (iSlow39 ? ((520.0f * fSlow42) + 630.0f) : 1150.0f)) : (iSlow36 ? ((850.0f * fSlow40) + 1150.0f) : 2000.0f)) : (iSlow34 ? ((140.0f * fSlow37) + 2000.0f) : 2140.0f)) : (iSlow32 ? (2140.0f - (1340.0f * fSlow35)) : 800.0f)) : (iSlow30 ? (800.0f - (100.0f * fSlow33)) : 700.0f)) : (iSlow28 ? ((380.0f * fSlow31) + 700.0f) : 1080.0f)) : (iSlow26 ? ((620.0f * fSlow29) + 1080.0f) : 1700.0f)) : (iSlow24 ? ((170.0f * fSlow27) + 1700.0f) : 1870.0f)) : (iSlow21 ? (1870.0f - (1070.0f * fSlow25)) : 800.0f)) : (iSlow22 ? (800.0f - (200.0f * fSlow23)) : 600.0f));
		int iSlow80 = (fSlow79 >= 1300.0f);
		float fSlow81 = (fSlow79 + -1300.0f);
		float fSlow82 = (10.0f * fSlow25);
		float fSlow83 = (10.0f * fSlow29);
		float fSlow84 = (10.0f * fSlow52);
		float fSlow85 = (10.0f * fSlow19);
		float fSlow86 = (iSlow21 ? (iSlow24 ? (iSlow26 ? (iSlow28 ? (iSlow30 ? (iSlow32 ? (iSlow34 ? (iSlow36 ? (iSlow39 ? (iSlow41 ? (iSlow43 ? (iSlow45 ? (iSlow47 ? (iSlow49 ? (iSlow51 ? (iSlow53 ? (iSlow56 ? (iSlow58 ? (iSlow60 ? (iSlow61 ? (iSlow63 ? (iSlow65 ? (iSlow67 ? (iSlow69 ? 90.0f : (iSlow67 ? (90.0f - (10.0f * fSlow20)) : 80.0f)) : (iSlow65 ? ((20.0f * fSlow68) + 80.0f) : 100.0f)) : (iSlow63 ? (100.0f - fSlow76) : 80.0f)) : (iSlow61 ? (80.0f - fSlow75) : 60.0f)) : (iSlow60 ? (fSlow74 + 60.0f) : 70.0f)) : (iSlow58 ? (fSlow85 + 70.0f) : 80.0f)) : (iSlow56 ? ((10.0f * fSlow59) + 80.0f) : 90.0f)) : (iSlow53 ? (90.0f - (10.0f * fSlow57)) : 80.0f)) : 80.0f) : (iSlow49 ? (fSlow84 + 80.0f) : 90.0f)) : (iSlow47 ? (90.0f - fSlow73) : 80.0f)) : (iSlow45 ? ((10.0f * fSlow48) + 80.0f) : 90.0f)) : (iSlow43 ? (90.0f - (10.0f * fSlow46)) : 80.0f)) : (iSlow41 ? (80.0f - (20.0f * fSlow44)) : 60.0f)) : (iSlow39 ? ((30.0f * fSlow42) + 60.0f) : 90.0f)) : (iSlow36 ? ((10.0f * fSlow40) + 90.0f) : 100.0f)) : (iSlow34 ? (100.0f - (10.0f * fSlow37)) : 90.0f)) : (iSlow32 ? (90.0f - (10.0f * fSlow35)) : 80.0f)) : (iSlow30 ? (80.0f - (20.0f * fSlow33)) : 60.0f)) : (iSlow28 ? ((30.0f * fSlow31) + 60.0f) : 90.0f)) : (iSlow26 ? (90.0f - fSlow83) : 80.0f)) : (iSlow24 ? ((10.0f * fSlow27) + 80.0f) : 90.0f)) : (iSlow21 ? (90.0f - fSlow82) : 80.0f)) : (iSlow22 ? (80.0f - (20.0f * fSlow23)) : 60.0f));
		float fSlow87 = (iSlow21 ? (iSlow24 ? (iSlow26 ? (iSlow28 ? (iSlow30 ? (iSlow32 ? (iSlow34 ? (iSlow36 ? (iSlow39 ? (iSlow41 ? (iSlow43 ? (iSlow45 ? (iSlow47 ? (iSlow49 ? (iSlow51 ? (iSlow53 ? (iSlow56 ? (iSlow58 ? (iSlow60 ? (iSlow61 ? (iSlow63 ? (iSlow65 ? (iSlow67 ? (iSlow69 ? 0.630957007f : (iSlow67 ? (0.630957007f - (0.567861021f * fSlow20)) : 0.0630960017f)) : (iSlow65 ? ((0.0369039997f * fSlow68) + 0.0630960017f) : 0.100000001f)) : (iSlow63 ? ((0.254812986f * fSlow66) + 0.100000001f) : 0.35481301f)) : (iSlow61 ? (0.35481301f - (0.103624001f * fSlow64)) : 0.251188993f)) : (iSlow60 ? ((0.195494995f * fSlow62) + 0.251188993f) : 0.446684003f)) : (iSlow58 ? (0.446684003f - (0.195494995f * fSlow19)) : 0.251188993f)) : (iSlow56 ? (0.251188993f - (0.219566002f * fSlow59)) : 0.0316229984f)) : (iSlow53 ? ((0.250214994f * fSlow57) + 0.0316229984f) : 0.281838f)) : (iSlow51 ? (0.281838f - (0.181838006f * fSlow54)) : 0.100000001f)) : (iSlow49 ? ((0.401187003f * fSlow52) + 0.100000001f) : 0.501187027f)) : (iSlow47 ? (0.501187027f - (0.301661015f * fSlow50)) : 0.199525997f)) : (iSlow45 ? (0.199525997f - (0.136429995f * fSlow48)) : 0.0630960017f)) : (iSlow43 ? ((0.253131986f * fSlow46) + 0.0630960017f) : 0.316228002f)) : (iSlow41 ? (0.316228002f - (0.216227993f * fSlow44)) : 0.100000001f)) : (iSlow39 ? ((0.401187003f * fSlow42) + 0.100000001f) : 0.501187027f)) : (iSlow36 ? (0.501187027f - (0.401187003f * fSlow40)) : 0.100000001f)) : (iSlow34 ? ((0.151188999f * fSlow37) + 0.100000001f) : 0.251188993f)) : (iSlow32 ? ((0.0306490008f * fSlow35) + 0.251188993f) : 0.281838f)) : (iSlow30 ? (0.281838f - (0.123349003f * fSlow33)) : 0.158489004f)) : (iSlow28 ? ((0.342698008f * fSlow31) + 0.158489004f) : 0.501187027f)) : (iSlow26 ? (0.501187027f - (0.301661015f * fSlow29)) : 0.199525997f)) : (iSlow24 ? (0.199525997f - (0.0216979999f * fSlow27)) : 0.177827999f)) : (iSlow21 ? ((0.138400003f * fSlow25) + 0.177827999f) : 0.316228002f)) : (iSlow22 ? (0.316228002f - (0.216227993f * fSlow23)) : 0.100000001f));
		float fSlow88 = (100.0f * fSlow23);
		float fSlow89 = (50.0f * fSlow31);
		float fSlow90 = (50.0f * fSlow50);
		float fSlow91 = (iSlow21 ? (iSlow24 ? (iSlow26 ? (iSlow28 ? (iSlow30 ? (iSlow32 ? (iSlow34 ? (iSlow36 ? (iSlow39 ? (iSlow41 ? (iSlow43 ? (iSlow45 ? (iSlow47 ? (iSlow49 ? (iSlow51 ? (iSlow53 ? (iSlow56 ? (iSlow58 ? (iSlow60 ? (iSlow61 ? (iSlow63 ? (iSlow65 ? (iSlow67 ? (iSlow69 ? 2800.0f : (iSlow67 ? (2800.0f - (100.0f * fSlow20)) : 2700.0f)) : 2700.0f) : (iSlow63 ? ((130.0f * fSlow66) + 2700.0f) : 2830.0f)) : (iSlow61 ? (2830.0f - (300.0f * fSlow64)) : 2530.0f)) : (iSlow60 ? (2530.0f - (280.0f * fSlow62)) : 2250.0f)) : (iSlow58 ? ((150.0f * fSlow19) + 2250.0f) : 2400.0f)) : (iSlow56 ? ((200.0f * fSlow59) + 2400.0f) : 2600.0f)) : (iSlow53 ? (2600.0f - (200.0f * fSlow57)) : 2400.0f)) : 2400.0f) : (iSlow49 ? ((350.0f * fSlow52) + 2400.0f) : 2750.0f)) : (iSlow47 ? (2750.0f - fSlow90) : 2700.0f)) : (iSlow45 ? ((200.0f * fSlow48) + 2700.0f) : 2900.0f)) : (iSlow43 ? (2900.0f - (200.0f * fSlow46)) : 2700.0f)) : (iSlow41 ? ((50.0f * fSlow44) + 2700.0f) : 2750.0f)) : (iSlow39 ? ((150.0f * fSlow42) + 2750.0f) : 2900.0f)) : (iSlow36 ? (2900.0f - (100.0f * fSlow40)) : 2800.0f)) : (iSlow34 ? ((150.0f * fSlow37) + 2800.0f) : 2950.0f)) : (iSlow32 ? (2950.0f - (120.0f * fSlow35)) : 2830.0f)) : (iSlow30 ? (2830.0f - (130.0f * fSlow33)) : 2700.0f)) : (iSlow28 ? (2700.0f - fSlow89) : 2650.0f)) : (iSlow26 ? (2650.0f - (50.0f * fSlow29)) : 2600.0f)) : (iSlow24 ? ((200.0f * fSlow27) + 2600.0f) : 2800.0f)) : (iSlow21 ? (2800.0f - (200.0f * fSlow25)) : 2600.0f)) : (iSlow22 ? (fSlow88 + 2600.0f) : 2700.0f));
		float fSlow92 = std::tan((fConst28 * fSlow91));
		float fSlow93 = (1.0f / fSlow92);
		float fSlow94 = (20.0f * fSlow42);
		float fSlow95 = (20.0f * fSlow50);
		float fSlow96 = (20.0f * fSlow52);
		float fSlow97 = (60.0f * fSlow62);
		float fSlow98 = ((iSlow21 ? (iSlow24 ? (iSlow26 ? (iSlow28 ? (iSlow30 ? (iSlow32 ? (iSlow34 ? (iSlow36 ? (iSlow39 ? (iSlow41 ? (iSlow43 ? (iSlow45 ? (iSlow47 ? (iSlow49 ? (iSlow51 ? (iSlow53 ? (iSlow56 ? (iSlow58 ? (iSlow60 ? (iSlow61 ? (iSlow63 ? (iSlow65 ? 120.0f : (iSlow63 ? (120.0f - fSlow76) : 100.0f)) : (iSlow61 ? ((70.0f * fSlow64) + 100.0f) : 170.0f)) : (iSlow60 ? (170.0f - fSlow97) : 110.0f)) : (iSlow58 ? (110.0f - fSlow85) : 100.0f)) : 100.0f) : 100.0f) : 100.0f) : (iSlow49 ? (fSlow96 + 100.0f) : 120.0f)) : (iSlow47 ? (120.0f - fSlow95) : 100.0f)) : 100.0f) : 100.0f) : 100.0f) : (iSlow39 ? (fSlow94 + 100.0f) : 120.0f)) : 120.0f) : (iSlow34 ? (120.0f - (20.0f * fSlow37)) : 100.0f)) : 100.0f) : (iSlow30 ? ((70.0f * fSlow33) + 100.0f) : 170.0f)) : (iSlow28 ? (170.0f - fSlow89) : 120.0f)) : (iSlow26 ? (120.0f - fSlow71) : 100.0f)) : 100.0f) : 100.0f) : 100.0f) / fSlow91);
		float fSlow99 = (((fSlow93 - fSlow98) / fSlow92) + 1.0f);
		float fSlow100 = (1.0f - (1.0f / mydsp_faustpower2_f(fSlow92)));
		float fSlow101 = (((fSlow93 + fSlow98) / fSlow92) + 1.0f);
		float fSlow102 = (iSlow32 ? ((0.0293140002f * fSlow35) + 0.0501190014f) : 0.0794330016f);
		float fSlow103 = (iSlow21 ? (iSlow24 ? (iSlow26 ? (iSlow28 ? (iSlow30 ? (iSlow32 ? (iSlow34 ? (iSlow36 ? (iSlow39 ? (iSlow41 ? (iSlow43 ? (iSlow45 ? (iSlow47 ? (iSlow49 ? (iSlow51 ? (iSlow53 ? (iSlow56 ? (iSlow58 ? (iSlow60 ? (iSlow61 ? (iSlow63 ? (iSlow65 ? (iSlow67 ? (iSlow69 ? 0.100000001f : (iSlow67 ? (0.100000001f - (0.0683770031f * fSlow20)) : 0.0316229984f)) : 0.0316229984f) : (iSlow63 ? ((0.126865998f * fSlow66) + 0.0316229984f) : 0.158489004f)) : (iSlow61 ? (0.158489004f - (0.126865998f * fSlow64)) : 0.0316229984f)) : (iSlow60 ? ((0.323190004f * fSlow62) + 0.0316229984f) : 0.35481301f)) : 0.35481301f) : (iSlow56 ? (0.35481301f - (0.196324006f * fSlow59)) : 0.158489004f)) : (iSlow53 ? (0.158489004f - (0.0693639964f * fSlow57)) : 0.0891249999f)) : (iSlow51 ? (0.0891249999f - (0.0640060008f * fSlow54)) : 0.0251189992f)) : (iSlow49 ? ((0.0456760004f * fSlow52) + 0.0251189992f) : 0.0707949996f)) : (iSlow47 ? ((0.0550980009f * fSlow50) + 0.0707949996f) : 0.125892997f)) : (iSlow45 ? (0.125892997f - (0.0627970025f * fSlow48)) : 0.0630960017f)) : (iSlow43 ? (0.0630960017f - (0.0129770003f * fSlow46)) : 0.0501190014f)) : (iSlow41 ? ((0.020676f * fSlow44) + 0.0501190014f) : 0.0707949996f)) : (iSlow39 ? (0.0707949996f - (0.0456760004f * fSlow42)) : 0.0251189992f)) : (iSlow36 ? ((0.152709007f * fSlow40) + 0.0251189992f) : 0.177827999f)) : (iSlow34 ? (0.177827999f - (0.127709001f * fSlow37)) : 0.0501190014f)) : fSlow102) : (iSlow30 ? (0.0794330016f - (0.0616500005f * fSlow33)) : 0.0177829992f)) : (iSlow28 ? ((0.428900987f * fSlow31) + 0.0177829992f) : 0.446684003f)) : (iSlow26 ? (0.446684003f - (0.195494995f * fSlow29)) : 0.251188993f)) : (iSlow24 ? (0.251188993f - (0.125295997f * fSlow27)) : 0.125892997f)) : (iSlow21 ? ((0.125295997f * fSlow25) + 0.125892997f) : 0.251188993f)) : (iSlow22 ? (0.251188993f - (0.109935001f * fSlow23)) : 0.141253993f));
		float fSlow104 = (fSlow92 * fSlow101);
		float fSlow105 = (350.0f * fSlow19);
		float fSlow106 = (iSlow21 ? (iSlow24 ? (iSlow26 ? (iSlow28 ? (iSlow30 ? (iSlow32 ? (iSlow34 ? (iSlow36 ? (iSlow39 ? (iSlow41 ? (iSlow43 ? (iSlow45 ? (iSlow47 ? (iSlow49 ? (iSlow51 ? (iSlow53 ? (iSlow56 ? (iSlow58 ? (iSlow60 ? (iSlow61 ? (iSlow63 ? (iSlow65 ? (iSlow67 ? (iSlow69 ? 3500.0f : (iSlow67 ? (3500.0f - (200.0f * fSlow20)) : 3300.0f)) : (iSlow65 ? ((400.0f * fSlow68) + 3300.0f) : 3700.0f)) : (iSlow63 ? (3700.0f - (200.0f * fSlow66)) : 3500.0f)) : 3500.0f) : (iSlow60 ? (3500.0f - (1050.0f * fSlow62)) : 2450.0f)) : (iSlow58 ? (fSlow105 + 2450.0f) : 2800.0f)) : (iSlow56 ? ((250.0f * fSlow59) + 2800.0f) : 3050.0f)) : (iSlow53 ? (3050.0f - (450.0f * fSlow57)) : 2600.0f)) : (iSlow51 ? ((75.0f * fSlow54) + 2600.0f) : 2675.0f)) : (iSlow49 ? ((325.0f * fSlow52) + 2675.0f) : 3000.0f)) : 3000.0f) : (iSlow45 ? ((350.0f * fSlow48) + 3000.0f) : 3350.0f)) : (iSlow43 ? (3350.0f - (350.0f * fSlow46)) : 3000.0f)) : 3000.0f) : (iSlow39 ? ((900.0f * fSlow42) + 3000.0f) : 3900.0f)) : (iSlow36 ? (3900.0f - (300.0f * fSlow40)) : 3600.0f)) : (iSlow34 ? ((300.0f * fSlow37) + 3600.0f) : 3900.0f)) : (iSlow32 ? (3900.0f - (100.0f * fSlow35)) : 3800.0f)) : 3800.0f) : (iSlow28 ? (3800.0f - (900.0f * fSlow31)) : 2900.0f)) : (iSlow26 ? ((300.0f * fSlow29) + 2900.0f) : 3200.0f)) : (iSlow24 ? ((50.0f * fSlow27) + 3200.0f) : 3250.0f)) : (iSlow21 ? (3250.0f - (450.0f * fSlow25)) : 2800.0f)) : (iSlow22 ? (fSlow88 + 2800.0f) : 2900.0f));
		float fSlow107 = std::tan((fConst28 * fSlow106));
		float fSlow108 = (1.0f / fSlow107);
		float fSlow109 = ((iSlow21 ? (iSlow24 ? (iSlow26 ? (iSlow28 ? (iSlow30 ? (iSlow32 ? (iSlow34 ? (iSlow36 ? (iSlow39 ? (iSlow41 ? (iSlow43 ? (iSlow45 ? (iSlow47 ? (iSlow49 ? (iSlow51 ? (iSlow53 ? (iSlow56 ? (iSlow58 ? (iSlow60 ? (iSlow61 ? (iSlow63 ? (iSlow65 ? (iSlow67 ? (iSlow69 ? 130.0f : (iSlow67 ? (fSlow77 + 130.0f) : 150.0f)) : 150.0f) : (iSlow63 ? (150.0f - fSlow76) : 130.0f)) : (iSlow61 ? ((50.0f * fSlow64) + 130.0f) : 180.0f)) : (iSlow60 ? (180.0f - fSlow97) : 120.0f)) : 120.0f) : 120.0f) : 120.0f) : 120.0f) : (iSlow49 ? (fSlow84 + 120.0f) : 130.0f)) : (iSlow47 ? (130.0f - fSlow73) : 120.0f)) : 120.0f) : 120.0f) : 120.0f) : (iSlow39 ? ((10.0f * fSlow42) + 120.0f) : 130.0f)) : (iSlow36 ? (fSlow72 + 130.0f) : 150.0f)) : (iSlow34 ? (150.0f - (30.0f * fSlow37)) : 120.0f)) : 120.0f) : (iSlow30 ? ((60.0f * fSlow33) + 120.0f) : 180.0f)) : (iSlow28 ? (180.0f - fSlow89) : 130.0f)) : (iSlow26 ? (130.0f - fSlow83) : 120.0f)) : 120.0f) : (iSlow21 ? (fSlow82 + 120.0f) : 130.0f)) : (iSlow22 ? (130.0f - (10.0f * fSlow23)) : 120.0f)) / fSlow106);
		float fSlow110 = (((fSlow108 - fSlow109) / fSlow107) + 1.0f);
		float fSlow111 = (1.0f - (1.0f / mydsp_faustpower2_f(fSlow107)));
		float fSlow112 = (((fSlow108 + fSlow109) / fSlow107) + 1.0f);
		float fSlow113 = (iSlow45 ? (0.100000001f - (0.0841509998f * fSlow48)) : 0.0158489998f);
		float fSlow114 = (iSlow21 ? (iSlow24 ? (iSlow26 ? (iSlow28 ? (iSlow30 ? (iSlow32 ? (iSlow34 ? (iSlow36 ? (iSlow39 ? (iSlow41 ? (iSlow43 ? (iSlow45 ? (iSlow47 ? (iSlow49 ? (iSlow51 ? (iSlow53 ? (iSlow56 ? (iSlow58 ? (iSlow60 ? (iSlow61 ? (iSlow63 ? (iSlow65 ? (iSlow67 ? (iSlow69 ? 0.0158489998f : (iSlow67 ? ((0.00193400006f * fSlow20) + 0.0158489998f) : 0.0177829992f)) : (iSlow65 ? (0.0177829992f - (0.00193400006f * fSlow68)) : 0.0158489998f)) : (iSlow63 ? ((0.0239620004f * fSlow66) + 0.0158489998f) : 0.0398110002f)) : (iSlow61 ? (0.0398110002f - (0.0298110005f * fSlow64)) : 0.00999999978f)) : (iSlow60 ? ((0.344812989f * fSlow62) + 0.00999999978f) : 0.35481301f)) : (iSlow58 ? (0.35481301f - (0.103624001f * fSlow19)) : 0.251188993f)) : (iSlow56 ? (0.251188993f - (0.171755999f * fSlow59)) : 0.0794330016f)) : (iSlow53 ? ((0.0205669999f * fSlow57) + 0.0794330016f) : 0.100000001f)) : (iSlow51 ? (0.100000001f - (0.0601890013f * fSlow54)) : 0.0398110002f)) : (iSlow49 ? ((0.0232849997f * fSlow52) + 0.0398110002f) : 0.0630960017f)) : (iSlow47 ? ((0.0369039997f * fSlow50) + 0.0630960017f) : 0.100000001f)) : fSlow113) : (iSlow43 ? ((0.0635839999f * fSlow46) + 0.0158489998f) : 0.0794330016f)) : (iSlow41 ? (0.0794330016f - (0.0478099994f * fSlow44)) : 0.0316229984f)) : (iSlow39 ? ((0.0683770031f * fSlow42) + 0.0316229984f) : 0.100000001f)) : (iSlow36 ? (0.100000001f - (0.0900000036f * fSlow40)) : 0.00999999978f)) : (iSlow34 ? ((0.0401189998f * fSlow37) + 0.00999999978f) : 0.0501190014f)) : fSlow102) : (iSlow30 ? (0.0794330016f - (0.0694330037f * fSlow33)) : 0.00999999978f)) : (iSlow28 ? ((0.388107002f * fSlow31) + 0.00999999978f) : 0.398106992f)) : (iSlow26 ? (0.398106992f - (0.198580995f * fSlow29)) : 0.199525997f)) : (iSlow24 ? (0.199525997f - (0.099526003f * fSlow27)) : 0.100000001f)) : (iSlow21 ? ((0.151188999f * fSlow25) + 0.100000001f) : 0.251188993f)) : (iSlow22 ? (0.251188993f - (0.0516630001f * fSlow23)) : 0.199525997f));
		float fSlow115 = (fSlow107 * fSlow112);
		float fSlow116 = (iSlow21 ? (iSlow24 ? (iSlow26 ? (iSlow28 ? (iSlow30 ? (iSlow32 ? (iSlow34 ? (iSlow36 ? (iSlow39 ? (iSlow41 ? (iSlow43 ? (iSlow45 ? (iSlow47 ? (iSlow49 ? (iSlow51 ? (iSlow53 ? (iSlow56 ? (iSlow58 ? (iSlow60 ? (iSlow61 ? 4950.0f : (iSlow60 ? (4950.0f - (2200.0f * fSlow62)) : 2750.0f)) : (iSlow58 ? (fSlow105 + 2750.0f) : 3100.0f)) : (iSlow56 ? ((240.0f * fSlow59) + 3100.0f) : 3340.0f)) : (iSlow53 ? (3340.0f - (440.0f * fSlow57)) : 2900.0f)) : (iSlow51 ? (fSlow55 + 2900.0f) : 2950.0f)) : (iSlow49 ? ((400.0f * fSlow52) + 2950.0f) : 3350.0f)) : (iSlow47 ? (3350.0f - fSlow90) : 3300.0f)) : (iSlow45 ? ((290.0f * fSlow48) + 3300.0f) : 3590.0f)) : (iSlow43 ? (3590.0f - (290.0f * fSlow46)) : 3300.0f)) : (iSlow41 ? ((100.0f * fSlow44) + 3300.0f) : 3400.0f)) : (iSlow39 ? ((1550.0f * fSlow42) + 3400.0f) : 4950.0f)) : 4950.0f) : 4950.0f) : 4950.0f) : 4950.0f) : (iSlow28 ? (4950.0f - (1700.0f * fSlow31)) : 3250.0f)) : (iSlow26 ? ((330.0f * fSlow29) + 3250.0f) : 3580.0f)) : (iSlow24 ? (3580.0f - (40.0f * fSlow27)) : 3540.0f)) : (iSlow21 ? (3540.0f - (540.0f * fSlow25)) : 3000.0f)) : (iSlow22 ? ((300.0f * fSlow23) + 3000.0f) : 3300.0f));
		float fSlow117 = std::tan((fConst28 * fSlow116));
		float fSlow118 = (1.0f / fSlow117);
		float fSlow119 = ((iSlow21 ? (iSlow24 ? (iSlow26 ? (iSlow28 ? (iSlow30 ? (iSlow32 ? (iSlow34 ? (iSlow36 ? (iSlow39 ? (iSlow41 ? (iSlow43 ? (iSlow45 ? (iSlow47 ? (iSlow49 ? (iSlow51 ? (iSlow53 ? (iSlow56 ? (iSlow58 ? (iSlow60 ? (iSlow61 ? (iSlow63 ? (iSlow65 ? (iSlow67 ? (iSlow69 ? 140.0f : (iSlow67 ? ((60.0f * fSlow20) + 140.0f) : 200.0f)) : 200.0f) : (iSlow63 ? (200.0f - (65.0f * fSlow66)) : 135.0f)) : (iSlow61 ? ((65.0f * fSlow64) + 135.0f) : 200.0f)) : (iSlow60 ? (200.0f - (70.0f * fSlow62)) : 130.0f)) : (iSlow58 ? (130.0f - fSlow85) : 120.0f)) : 120.0f) : 120.0f) : 120.0f) : (iSlow49 ? (fSlow96 + 120.0f) : 140.0f)) : (iSlow47 ? (140.0f - fSlow95) : 120.0f)) : 120.0f) : 120.0f) : 120.0f) : (iSlow39 ? (fSlow94 + 120.0f) : 140.0f)) : (iSlow36 ? ((60.0f * fSlow40) + 140.0f) : 200.0f)) : (iSlow34 ? (200.0f - fSlow38) : 120.0f)) : 120.0f) : (iSlow30 ? ((80.0f * fSlow33) + 120.0f) : 200.0f)) : (iSlow28 ? (200.0f - (60.0f * fSlow31)) : 140.0f)) : (iSlow26 ? (140.0f - fSlow71) : 120.0f)) : 120.0f) : (iSlow21 ? ((15.0f * fSlow25) + 120.0f) : 135.0f)) : (iSlow22 ? (135.0f - (15.0f * fSlow23)) : 120.0f)) / fSlow116);
		float fSlow120 = (((fSlow118 - fSlow119) / fSlow117) + 1.0f);
		float fSlow121 = (1.0f - (1.0f / mydsp_faustpower2_f(fSlow117)));
		float fSlow122 = (((fSlow118 + fSlow119) / fSlow117) + 1.0f);
		float fSlow123 = (iSlow21 ? (iSlow24 ? (iSlow26 ? (iSlow28 ? (iSlow30 ? (iSlow32 ? (iSlow34 ? (iSlow36 ? (iSlow39 ? (iSlow41 ? (iSlow43 ? (iSlow45 ? (iSlow47 ? (iSlow49 ? (iSlow51 ? (iSlow53 ? (iSlow56 ? (iSlow58 ? (iSlow60 ? (iSlow61 ? (iSlow63 ? (iSlow65 ? 0.00100000005f : (iSlow63 ? ((0.000777999987f * fSlow66) + 0.00100000005f) : 0.00177800003f)) : (iSlow61 ? (0.00177800003f - (0.001147f * fSlow64)) : 0.000630999974f)) : (iSlow60 ? ((0.0993689969f * fSlow62) + 0.000630999974f) : 0.100000001f)) : (iSlow58 ? ((0.0258930009f * fSlow19) + 0.100000001f) : 0.125892997f)) : (iSlow56 ? (0.125892997f - (0.0860819966f * fSlow59)) : 0.0398110002f)) : (iSlow53 ? (0.0398110002f - (0.0298110005f * fSlow57)) : 0.00999999978f)) : (iSlow51 ? ((0.00584900007f * fSlow54) + 0.00999999978f) : 0.0158489998f)) : (iSlow49 ? (0.0158489998f - (0.00325999991f * fSlow52)) : 0.0125890002f)) : (iSlow47 ? ((0.0874110013f * fSlow50) + 0.0125890002f) : 0.100000001f)) : fSlow113) : (iSlow43 ? ((0.00410400005f * fSlow46) + 0.0158489998f) : 0.0199529994f)) : 0.0199529994f) : (iSlow39 ? (0.0199529994f - (0.0167909991f * fSlow42)) : 0.0031620001f)) : (iSlow36 ? (0.0031620001f - (0.00157700002f * fSlow40)) : 0.00158499996f)) : (iSlow34 ? ((0.00472499989f * fSlow37) + 0.00158499996f) : 0.00631000008f)) : (iSlow32 ? (0.00631000008f - (0.00314799999f * fSlow35)) : 0.0031620001f)) : (iSlow30 ? (0.0031620001f - (0.00216199993f * fSlow33)) : 0.00100000005f)) : (iSlow28 ? ((0.0784329996f * fSlow31) + 0.00100000005f) : 0.0794330016f)) : (iSlow26 ? ((0.0205669999f * fSlow29) + 0.0794330016f) : 0.100000001f)) : (iSlow24 ? (0.100000001f - (0.0683770031f * fSlow27)) : 0.0316229984f)) : (iSlow21 ? ((0.0184959993f * fSlow25) + 0.0316229984f) : 0.0501190014f)) : 0.0501190014f);
		float fSlow124 = (fSlow117 * fSlow122);
		float fSlow125 = float(fHslider10);
		float fSlow126 = float((fSlow125 > 0.0f));
		float fSlow127 = (0.0f - fSlow125);
		float fSlow128 = std::min<float>(10.0f, std::max<float>(7.0f, float(fHslider11)));
		float fSlow129 = (fConst47 * ((1.0f / float(fHslider12)) + -1.0f));
		float fSlow130 = float(fHslider13);
		...
		float fSlow137 = (1.0f - fSlow132);
		float fSlow138 = float(fHslider15);
		float fSlow139 = (1.0f / float(fHslider16));
		float fSlow140 = std::tan((fConst28 * float(fHslider17)));
		float fSlow141 = (1.0f / fSlow140);
		float fSlow142 = (1.0f / (((fSlow139 + fSlow141) / fSlow140) + 1.0f));
		float fSlow143 = (((fSlow141 - fSlow139) / fSlow140) + 1.0f);
		float fSlow144 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow140))));
		float fSlow145 = (1.0f / fSlow10);
		float fSlow146 = float(fHslider18);
		int iSlow147 = (fSlow146 > 0.0f);
		float fSlow148 = (float(fHslider19) * std::sin((fConst48 * fSlow9)));
		float fSlow149 = (fConst28 * ((fSlow9 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow146)))) / fSlow148));
		float fSlow150 = (fConst28 * (fSlow9 / fSlow148));
		float fSlow151 = (iSlow147 ? fSlow150 : fSlow149);
		float fSlow152 = ((fSlow145 * (fSlow145 - fSlow151)) + 1.0f);
		float fSlow153 = ((fSlow145 * (fSlow145 + fSlow151)) + 1.0f);
		float fSlow154 = (iSlow147 ? fSlow149 : fSlow150);
		float fSlow155 = ((fSlow145 * (fSlow145 + fSlow154)) + 1.0f);
		float fSlow156 = ((fSlow145 * (fSlow145 - fSlow154)) + 1.0f);
		float fSlow157 = (1.0f / fSlow7);
		float fSlow158 = float(fHslider20);
		int iSlow159 = (fSlow158 > 0.0f);
		float fSlow160 = (float(fHslider21) * std::sin((fConst48 * fSlow6)));
		float fSlow161 = (fConst28 * ((fSlow6 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow158)))) / fSlow160));
		float fSlow162 = (fConst28 * (fSlow6 / fSlow160));
		float fSlow163 = (iSlow159 ? fSlow162 : fSlow161);
		float fSlow164 = ((fSlow157 * (fSlow157 - fSlow163)) + 1.0f);
		float fSlow165 = ((fSlow157 * (fSlow157 + fSlow163)) + 1.0f);
		float fSlow166 = (iSlow159 ? fSlow161 : fSlow162);
		float fSlow167 = ((fSlow157 * (fSlow157 + fSlow166)) + 1.0f);
		float fSlow168 = ((fSlow157 * (fSlow157 - fSlow166)) + 1.0f);
		float fSlow169 = (1.0f / fSlow4);
		float fSlow170 = (((fSlow3 - fSlow1) / fSlow2) + 1.0f);
		float fSlow171 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow2))));
		float fSlow172 = (1.0f / float(fHslider23));
		float fSlow173 = std::tan((fConst28 * float(fHslider24)));
		float fSlow174 = (1.0f / fSlow173);
		float fSlow175 = (((fSlow172 + fSlow174) / fSlow173) + 1.0f);
		float fSlow176 = ((std::pow(10.0f, (0.0500000007f * float(fHslider22))) * (1.0f - float(fCheckbox1))) / fSlow175);
		float fSlow177 = float(fHslider25);
		...
		float fSlow183 = (2.0f * fSlow12);
		float fSlow184 = float(fHslider27);
		float fSlow185 = float((fSlow184 > 0.0f));
		float fSlow186 = (0.0f - fSlow184);
		float fSlow187 = (2.0f * float(fHslider28));
		float fSlow188 = std::min<float>(1.0f, std::max<float>(0.00999999978f, float(fHslider29)));
		float fSlow189 = (1.0f - fSlow188);
		float fSlow190 = (0.00999999978f * float(fHslider30));
		float fSlow191 = (fConst47 * ((1.0f / float(fHslider31)) + -1.0f));
		float fSlow192 = float(fHslider32);
		int iSlow193 = (std::fabs(fSlow192) < 1.1920929e-07f);
		float fSlow194 = (iSlow193 ? 0.0f : std::exp((0.0f - (fConst5 / (iSlow193 ? 1.0f : fSlow192)))));
		float fSlow195 = float(fHslider33);
		...
		float fSlow199 = (1.0f - fSlow194);
		float fSlow200 = float(fHslider34);
		float fSlow201 = (1.0f / float(fHslider35));
		float fSlow202 = std::tan((fConst28 * float(fHslider36)));
		float fSlow203 = (1.0f / fSlow202);
		float fSlow204 = (1.0f / (((fSlow201 + fSlow203) / fSlow202) + 1.0f));
		float fSlow205 = (((fSlow203 - fSlow201) / fSlow202) + 1.0f);
		float fSlow206 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow202))));
		float fSlow207 = (1.0f / fSlow181);
		float fSlow208 = float(fHslider37);
		int iSlow209 = (fSlow208 > 0.0f);
		float fSlow210 = (float(fHslider38) * std::sin((fConst48 * fSlow180)));
		float fSlow211 = (fConst28 * ((fSlow180 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow208)))) / fSlow210));
		float fSlow212 = (fConst28 * (fSlow180 / fSlow210));
		float fSlow213 = (iSlow209 ? fSlow212 : fSlow211);
		float fSlow214 = ((fSlow207 * (fSlow207 - fSlow213)) + 1.0f);
		float fSlow215 = ((fSlow207 * (fSlow207 + fSlow213)) + 1.0f);
		float fSlow216 = (iSlow209 ? fSlow211 : fSlow212);
		float fSlow217 = ((fSlow207 * (fSlow207 + fSlow216)) + 1.0f);
		float fSlow218 = ((fSlow207 * (fSlow207 - fSlow216)) + 1.0f);
		float fSlow219 = (1.0f / fSlow178);
		float fSlow220 = float(fHslider39);
		int iSlow221 = (fSlow220 > 0.0f);
		float fSlow222 = (float(fHslider40) * std::sin((fConst48 * fSlow177)));
		float fSlow223 = (fConst28 * ((fSlow177 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow220)))) / fSlow222));
		float fSlow224 = (fConst28 * (fSlow177 / fSlow222));
		...
		float fSlow231 = (1.0f / fSlow175);
		float fSlow232 = (((fSlow174 - fSlow172) / fSlow173) + 1.0f);
		float fSlow233 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow173))));
		float fSlow234 = (1.0f / float(fHslider42));
		float fSlow235 = std::tan((fConst28 * float(fHslider43)));
		float fSlow236 = (1.0f / fSlow235);
		float fSlow237 = (((fSlow234 + fSlow236) / fSlow235) + 1.0f);
		float fSlow238 = ((std::pow(10.0f, (0.0500000007f * float(fHslider41))) * (1.0f - float(fCheckbox2))) / fSlow237);
		float fSlow239 = float(fHslider44);
		float fSlow240 = std::tan((fConst28 * fSlow239));
		float fSlow241 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow240))));
		float fSlow242 = float(fHslider45);
		float fSlow243 = std::tan((fConst28 * fSlow242));
		float fSlow244 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow243))));
		float fSlow245 = std::min<float>(5.0f, std::max<float>(0.00999999978f, float(fHslider46)));
		float fSlow246 = (0.0125000002f * (std::pow(10.0f, (0.0500000007f * fSlow245)) + 1.0f));
		float fSlow247 = (fSlow245 + 1.0f);
		float fSlow248 = std::tan((fConst28 * ((1875.0f * fSlow247) + 500.0f)));
		float fSlow249 = (1.0f / fSlow248);
		float fSlow250 = (1.0f / (((fSlow249 + 1.41421354f) / fSlow248) + 1.0f));
		float fSlow251 = std::tan((fConst28 * ((62.5f * fSlow247) + 40.0f)));
		float fSlow252 = (1.0f / fSlow251);
		float fSlow253 = (1.0f / (((fSlow252 + 1.41421354f) / fSlow251) + 1.0f));
		float fSlow254 = mydsp_faustpower2_f(fSlow251);
		float fSlow255 = (1.0f / fSlow254);
		float fSlow256 = (((fSlow252 + -1.41421354f) / fSlow251) + 1.0f);
		float fSlow257 = (2.0f * (1.0f - fSlow255));
		float fSlow258 = (0.0f - (2.0f / fSlow254));
		float fSlow259 = (((fSlow249 + -1.41421354f) / fSlow248) + 1.0f);
		float fSlow260 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow248))));
		float fSlow261 = (1.0f / std::max<float>(1.0f, (fConst155 * fSlow247)));
		float fSlow262 = float(fHslider47);
		float fSlow263 = float((fSlow262 > 0.0f));
		float fSlow264 = (0.0f - fSlow262);
		float fSlow265 = (fConst47 * ((1.0f / float(fHslider48)) + -1.0f));
		float fSlow266 = float(fHslider49);
		int iSlow267 = (std::fabs(fSlow266) < 1.1920929e-07f);
		float fSlow268 = (iSlow267 ? 0.0f : std::exp((0.0f - (fConst5 / (iSlow267 ? 1.0f : fSlow266)))));
		float fSlow269 = float(fHslider50);
		int iSlow270 = (std::fabs(fSlow269) < 1.1920929e-07f);
		float fSlow271 = (iSlow270 ? 0.0f : std::exp((0.0f - (fConst5 / (iSlow270 ? 1.0f : fSlow269)))));
		...
		float fSlow276 = std::tan((fConst28 * float(fHslider53)));
		...
		float fSlow281 = (1.0f / fSlow243);
		float fSlow282 = float(fHslider54);
		int iSlow283 = (fSlow282 > 0.0f);
		float fSlow284 = (float(fHslider55) * std::sin((fConst48 * fSlow242)));
		float fSlow285 = (fConst28 * ((fSlow242 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow282)))) / fSlow284));
		float fSlow286 = (fConst28 * (fSlow242 / fSlow284));
		...
		float fSlow293 = (1.0f / fSlow240);
		float fSlow294 = float(fHslider56);
		int iSlow295 = (fSlow294 > 0.0f);
		float fSlow296 = (float(fHslider57) * std::sin((fConst48 * fSlow239)));
		float fSlow297 = (fConst28 * ((fSlow239 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow294)))) / fSlow296));
		float fSlow298 = (fConst28 * (fSlow239 / fSlow296));
		...
		float fSlow305 = (1.0f / fSlow237);
		float fSlow306 = (((fSlow236 - fSlow234) / fSlow235) + 1.0f);
		float fSlow307 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow235))));
		float fSlow308 = (1.0f / float(fHslider59));
		float fSlow309 = std::tan((fConst28 * float(fHslider60)));
		...
		float fSlow313 = float(fHslider61);
		float fSlow314 = std::tan((fConst28 * fSlow313));
		float fSlow315 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow314))));
		float fSlow316 = float(fHslider62);
		float fSlow317 = std::tan((fConst28 * fSlow316));
		float fSlow318 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow317))));
		float fSlow319 = float(fHslider63);
		float fSlow320 = float((fSlow319 > 0.0f));
		float fSlow321 = (0.0f - fSlow319);
		float fSlow322 = std::min<float>(20000.0f, std::max<float>(20.0f, float(fHslider64)));
		float fSlow323 = ((fSlow322 * fSlow12) * ((0.0500000007f * fSlow14) + 1.0f));
		float fSlow324 = (fConst222 * ((0.200000003f * ((0.5f * fSlow128) + -5.0f)) + 1.0f));
		float fSlow325 = ((std::min<float>(20000.0f, std::max<float>(20.0f, float(fHslider65))) * fSlow12) * (1.0f - (0.0299999993f * fSlow14)));
		float fSlow326 = ((std::min<float>(20000.0f, std::max<float>(20.0f, float(fHslider66))) * fSlow12) * ((0.310000002f * fSlow14) + 1.0f));
		float fSlow327 = ((std::min<float>(20000.0f, std::max<float>(20.0f, float(fHslider67))) * fSlow12) * (1.0f - (0.270000011f * fSlow14)));
		float fSlow328 = (fConst47 * ((1.0f / float(fHslider68)) + -1.0f));
		float fSlow329 = float(fHslider69);
		int iSlow330 = (std::fabs(fSlow329) < 1.1920929e-07f);
		float fSlow331 = (iSlow330 ? 0.0f : std::exp((0.0f - (fConst5 / (iSlow330 ? 1.0f : fSlow329)))));
		float fSlow332 = float(fHslider70);
		int iSlow333 = (std::fabs(fSlow332) < 1.1920929e-07f);
		float fSlow334 = (iSlow333 ? 0.0f : std::exp((0.0f - (fConst5 / (iSlow333 ? 1.0f : fSlow332)))));
		float fSlow335 = (1.0f - fSlow334);
		float fSlow336 = (1.0f - fSlow331);
		float fSlow337 = float(fHslider71);
		float fSlow338 = (1.0f / float(fHslider72));
		float fSlow339 = std::tan((fConst28 * float(fHslider73)));
		float fSlow340 = (1.0f / fSlow339);
		float fSlow341 = (1.0f / (((fSlow338 + fSlow340) / fSlow339) + 1.0f));
		float fSlow342 = (((fSlow340 - fSlow338) / fSlow339) + 1.0f);
		float fSlow343 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow339))));
		float fSlow344 = (1.0f / fSlow317);
		float fSlow345 = float(fHslider74);
		int iSlow346 = (fSlow345 > 0.0f);
		float fSlow347 = (float(fHslider75) * std::sin((fConst48 * fSlow316)));
		float fSlow348 = (fConst28 * ((fSlow316 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow345)))) / fSlow347));
		float fSlow349 = (fConst28 * (fSlow316 / fSlow347));
		float fSlow350 = (iSlow346 ? fSlow349 : fSlow348);
		float fSlow351 = ((fSlow344 * (fSlow344 - fSlow350)) + 1.0f);
		float fSlow352 = ((fSlow344 * (fSlow344 + fSlow350)) + 1.0f);
		float fSlow353 = (iSlow346 ? fSlow348 : fSlow349);
		float fSlow354 = ((fSlow344 * (fSlow344 + fSlow353)) + 1.0f);
		float fSlow355 = ((fSlow344 * (fSlow344 - fSlow353)) + 1.0f);
		float fSlow356 = (1.0f / fSlow314);
		float fSlow357 = float(fHslider76);
		int iSlow358 = (fSlow357 > 0.0f);
		float fSlow359 = (float(fHslider77) * std::sin((fConst48 * fSlow313)));
		float fSlow360 = (fConst28 * ((fSlow313 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow357)))) / fSlow359));
		float fSlow361 = (fConst28 * (fSlow313 / fSlow359));
		float fSlow362 = (iSlow358 ? fSlow361 : fSlow360);
		float fSlow363 = ((fSlow356 * (fSlow356 - fSlow362)) + 1.0f);
		float fSlow364 = ((fSlow356 * (fSlow356 + fSlow362)) + 1.0f);
		float fSlow365 = (iSlow358 ? fSlow360 : fSlow361);
		float fSlow366 = ((fSlow356 * (fSlow356 + fSlow365)) + 1.0f);
		float fSlow367 = ((fSlow356 * (fSlow356 - fSlow365)) + 1.0f);
		float fSlow368 = (1.0f / fSlow311);
		float fSlow369 = (((fSlow310 - fSlow308) / fSlow309) + 1.0f);
		float fSlow370 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow309))));
		float fSlow371 = (1.0f / float(fHslider79));
		float fSlow372 = std::tan((fConst28 * float(fHslider80)));
		float fSlow373 = (1.0f / fSlow372);
		float fSlow374 = (((fSlow371 + fSlow373) / fSlow372) + 1.0f);
		float fSlow375 = ((std::pow(10.0f, (0.0500000007f * float(fHslider78))) * (1.0f - float(fCheckbox4))) / fSlow374);
		float fSlow376 = (0.300000012f * fSlow375);
		...
		float fSlow380 = float(fHslider82);
		float fSlow381 = std::tan((fConst28 * fSlow380));
		float fSlow382 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow381))));
		float fSlow383 = float(fHslider83);
		float fSlow384 = float((fSlow383 > 0.0f));
		float fSlow385 = (0.0f - fSlow383);
		float fSlow386 = (1.0f / std::max<float>(1.0f, (fConst155 * (std::min<float>(10.0f, std::max<float>(1.0f, float(fHslider84))) + 1.0f))));
		float fSlow387 = (fConst47 * ((1.0f / float(fHslider85)) + -1.0f));
		float fSlow388 = float(fHslider86);
		int iSlow389 = (std::fabs(fSlow388) < 1.1920929e-07f);
		float fSlow390 = (iSlow389 ? 0.0f : std::exp((0.0f - (fConst5 / (iSlow389 ? 1.0f : fSlow388)))));
		float fSlow391 = float(fHslider87);
		int iSlow392 = (std::fabs(fSlow391) < 1.1920929e-07f);
		float fSlow393 = (iSlow392 ? 0.0f : std::exp((0.0f - (fConst5 / (iSlow392 ? 1.0f : fSlow391)))));
		float fSlow394 = (1.0f - fSlow393);
		float fSlow395 = (1.0f - fSlow390);
		float fSlow396 = float(fHslider88);
		float fSlow397 = (1.0f / float(fHslider89));
		float fSlow398 = std::tan((fConst28 * float(fHslider90)));
		float fSlow399 = (1.0f / fSlow398);
		float fSlow400 = (1.0f / (((fSlow397 + fSlow399) / fSlow398) + 1.0f));
		float fSlow401 = (((fSlow399 - fSlow397) / fSlow398) + 1.0f);
		float fSlow402 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow398))));
		float fSlow403 = (1.0f / fSlow381);
		float fSlow404 = float(fHslider91);
		int iSlow405 = (fSlow404 > 0.0f);
		float fSlow406 = (float(fHslider92) * std::sin((fConst48 * fSlow380)));
		float fSlow407 = (fConst28 * ((fSlow380 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow404)))) / fSlow406));
		float fSlow408 = (fConst28 * (fSlow380 / fSlow406));
		float fSlow409 = (iSlow405 ? fSlow408 : fSlow407);
		float fSlow410 = ((fSlow403 * (fSlow403 - fSlow409)) + 1.0f);
		float fSlow411 = ((fSlow403 * (fSlow403 + fSlow409)) + 1.0f);
		float fSlow412 = (iSlow405 ? fSlow407 : fSlow408);
		float fSlow413 = ((fSlow403 * (fSlow403 + fSlow412)) + 1.0f);
		float fSlow414 = ((fSlow403 * (fSlow403 - fSlow412)) + 1.0f);
		float fSlow415 = (1.0f / fSlow378);
		float fSlow416 = float(fHslider93);
		int iSlow417 = (fSlow416 > 0.0f);
		float fSlow418 = (float(fHslider94) * std::sin((fConst48 * fSlow377)));
		float fSlow419 = (fConst28 * ((fSlow377 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow416)))) / fSlow418));
		float fSlow420 = (fConst28 * (fSlow377 / fSlow418));
		float fSlow421 = (iSlow417 ? fSlow420 : fSlow419);
		float fSlow422 = ((fSlow415 * (fSlow415 - fSlow421)) + 1.0f);
		float fSlow423 = ((fSlow415 * (fSlow415 + fSlow421)) + 1.0f);
		float fSlow424 = (iSlow417 ? fSlow419 : fSlow420);
		float fSlow425 = ((fSlow415 * (fSlow415 + fSlow424)) + 1.0f);
		float fSlow426 = ((fSlow415 * (fSlow415 - fSlow424)) + 1.0f);
		float fSlow427 = (1.0f / fSlow374);
		float fSlow428 = (((fSlow373 - fSlow371) / fSlow372) + 1.0f);
		float fSlow429 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow372))));
		float fSlow430 = (1.0f / float(fHslider96));
		float fSlow431 = std::tan((fConst28 * float(fHslider97)));
		float fSlow432 = (1.0f / fSlow431);
		float fSlow433 = (((fSlow430 + fSlow432) / fSlow431) + 1.0f);
		float fSlow434 = ((std::pow(10.0f, (0.0500000007f * float(fHslider95))) * (1.0f - float(fCheckbox5))) / fSlow433);
		float fSlow435 = float(fHslider98);
		float fSlow436 = std::tan((fConst28 * fSlow435));
		float fSlow437 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow436))));
		float fSlow438 = float(fHslider99);
		float fSlow439 = std::tan((fConst28 * fSlow438));
		float fSlow440 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow439))));
		float fSlow441 = (0.5f * fSlow322);
		float fSlow442 = (fConst488 * fSlow12);
		float fSlow443 = (27.0f * fSlow12);
		float fSlow444 = (9.0f * fSlow12);
		float fSlow445 = (3.0f * fSlow12);
		float fSlow446 = (fConst47 * ((1.0f / float(fHslider100)) + -1.0f));
		float fSlow447 = float(fHslider101);
		int iSlow448 = (std::fabs(fSlow447) < 1.1920929e-07f);
		float fSlow449 = (iSlow448 ? 0.0f : std::exp((0.0f - (fConst5 / (iSlow448 ? 1.0f : fSlow447)))));
		float fSlow450 = float(fHslider102);
		...
		float fSlow455 = float(fHslider103);
		float fSlow456 = (1.0f / float(fHslider104));
		float fSlow457 = std::tan((fConst28 * float(fHslider105)));
		...
		float fSlow462 = (1.0f / fSlow439);
		float fSlow463 = float(fHslider106);
		int iSlow464 = (fSlow463 > 0.0f);
		float fSlow465 = (float(fHslider107) * std::sin((fConst48 * fSlow438)));
		float fSlow466 = (fConst28 * ((fSlow438 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow463)))) / fSlow465));
		float fSlow467 = (fConst28 * (fSlow438 / fSlow465));
		...
		float fSlow474 = (1.0f / fSlow436);
		float fSlow475 = float(fHslider108);
		int iSlow476 = (fSlow475 > 0.0f);
		float fSlow477 = (float(fHslider109) * std::sin((fConst48 * fSlow435)));
		float fSlow478 = (fConst28 * ((fSlow435 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow475)))) / fSlow477));
		float fSlow479 = (fConst28 * (fSlow435 / fSlow477));
		...
		float fSlow486 = (1.0f / fSlow433);
		float fSlow487 = (((fSlow432 - fSlow430) / fSlow431) + 1.0f);
		float fSlow488 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow431))));
		float fSlow489 = (1.0f / float(fHslider111));
		float fSlow490 = std::tan((fConst28 * float(fHslider112)));
		float fSlow491 = (1.0f / fSlow490);
		float fSlow492 = (((fSlow489 + fSlow491) / fSlow490) + 1.0f);
		float fSlow493 = ((std::pow(10.0f, (0.0500000007f * float(fHslider110))) * (1.0f - float(fCheckbox6))) / fSlow492);
		float fSlow494 = float(fHslider113);
		float fSlow495 = std::tan((fConst28 * fSlow494));
		float fSlow496 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow495))));
		float fSlow497 = float(fHslider114);
		float fSlow498 = std::tan((fConst28 * fSlow497));
		float fSlow499 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow498))));
		float fSlow500 = float(fHslider115);
		float fSlow501 = float((fSlow500 > 0.0f));
		float fSlow502 = (0.0f - fSlow500);
		float fSlow503 = float(fHslider116);
		float fSlow504 = float((2 * (fSlow503 > 20.0f)));
		float fSlow505 = (fConst5 * std::max<float>(20.0f, fSlow503));
		float fSlow506 = float(fHslider117);
		float fSlow507 = float((2 * (fSlow506 > 20.0f)));
		float fSlow508 = (fConst5 * std::max<float>(20.0f, fSlow506));
		float fSlow509 = (fConst47 * ((1.0f / float(fHslider118)) + -1.0f));
		float fSlow510 = float(fHslider119);
		int iSlow511 = (std::fabs(fSlow510) < 1.1920929e-07f);
		float fSlow512 = (iSlow511 ? 0.0f : std::exp((0.0f - (fConst5 / (iSlow511 ? 1.0f : fSlow510)))));
		float fSlow513 = float(fHslider120);
		int iSlow514 = (std::fabs(fSlow513) < 1.1920929e-07f);
		float fSlow515 = (iSlow514 ? 0.0f : std::exp((0.0f - (fConst5 / (iSlow514 ? 1.0f : fSlow513)))));
		float fSlow516 = (1.0f - fSlow515);
		float fSlow517 = (1.0f - fSlow512);
		float fSlow518 = float(fHslider121);
		float fSlow519 = (1.0f / float(fHslider122));
		float fSlow520 = std::tan((fConst28 * float(fHslider123)));
		...
		float fSlow525 = (1.0f / fSlow498);
		float fSlow526 = float(fHslider124);
		int iSlow527 = (fSlow526 > 0.0f);
		float fSlow528 = (float(fHslider125) * std::sin((fConst48 * fSlow497)));
		float fSlow529 = (fConst28 * ((fSlow497 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow526)))) / fSlow528));
		float fSlow530 = (fConst28 * (fSlow497 / fSlow528));
		...
		float fSlow537 = (1.0f / fSlow495);
		float fSlow538 = float(fHslider126);
		int iSlow539 = (fSlow538 > 0.0f);
		float fSlow540 = (float(fHslider127) * std::sin((fConst48 * fSlow494)));
		float fSlow541 = (fConst28 * ((fSlow494 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow538)))) / fSlow540));
		float fSlow542 = (fConst28 * (fSlow494 / fSlow540));
		...
		float fSlow549 = (1.0f / fSlow492);
		float fSlow550 = (((fSlow491 - fSlow489) / fSlow490) + 1.0f);
		float fSlow551 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow490))));
		float fSlow552 = (0.949999988f * fSlow375);
		for (int i = 0; (i < count); i = (i + 1)) {
			iVec0[0] = 1;
			...
			fRec20[0] = ((0.999000013f * fRec20[1]) + (0.00100000005f * ((fSlow15 * ftbl0mydspSIG0[int((65536.0f * fRec21[0]))]) + 1.0f)));
			fRec19[0] = ((fConst34 * fRec19[1]) + (fConst35 * (std::min<float>(5000.0f, std::max<float>(20.0f, (fSlow13 * fRec20[0]))) * fTemp0)));
			...
			float fTemp7 = (0.400000006f * ((fSlow17 * ((2.0f * fRec24) + -1.0f)) + (fSlow18 * fTemp6)));
			float fTemp8 = ((fSlow70 <= fRec19[0]) ? fRec19[0] : fSlow70);
			float fTemp9 = std::tan((fConst28 * fTemp8));
			float fTemp10 = (1.0f / fTemp9);
			float fTemp11 = (fSlow78 / fTemp8);
			...
			float fTemp15 = ((iSlow80 & (fRec19[0] >= 200.0f)) ? (fSlow79 - (0.000952380942f * ((fRec19[0] + -200.0f) * fSlow81))) : ((fSlow79 <= fTemp14) ? fTemp14 : fSlow79));
			float fTemp16 = std::tan((fConst28 * fTemp15));
			float fTemp17 = (1.0f / fTemp16);
			float fTemp18 = (fSlow86 / fTemp15);
			...
			fRec27[0] = (fTemp7 - (((fRec27[2] * fSlow99) + (2.0f * (fRec27[1] * fSlow100))) / fSlow101));
			fRec28[0] = (fTemp7 - (((fRec28[2] * fSlow110) + (2.0f * (fRec28[1] * fSlow111))) / fSlow112));
			fRec29[0] = (fTemp7 - (((fRec29[2] * fSlow120) + (2.0f * (fRec29[1] * fSlow121))) / fSlow122));
			fVec2[0] = fSlow125;
			float fTemp21 = (fSlow125 - fVec2[1]);
			fVec3[0] = fSlow127;
			float fTemp22 = (0.0f - (fSlow125 + fVec3[1]));
			float fTemp23 = std::min<float>(1.0f, ((fTemp21 * float((fTemp21 > 0.0f))) + (fSlow126 * (fTemp22 * float((fTemp22 > 0.0f))))));
			fVec4[0] = fTemp23;
			iRec30[0] = (((iRec30[1] + (iRec30[1] > 0)) * (fTemp23 <= fVec4[1])) + (fTemp23 > fVec4[1]));
			float fTemp24 = float(iRec30[0]);
			fRec16[0] = (((fTemp0 * ((fTemp1 * (((((fRec22[0] / fTemp13) + ((fRec26[0] * fSlow87) / fTemp20)) + ((fRec27[0] * fSlow103) / fSlow104)) + ((fRec28[0] * fSlow114) / fSlow115)) + ((fRec29[0] * fSlow123) / fSlow124))) + (((((fRec22[2] * (0.0f - (fTemp1 / fTemp13))) + (fRec26[2] * (0.0f - ((fTemp1 * fSlow87) / fTemp20)))) + (fRec27[2] * (0.0f - ((fTemp1 * fSlow103) / fSlow104)))) + (fRec28[2] * (0.0f - ((fTemp1 * fSlow114) / fSlow115)))) + (fRec29[2] * (0.0f - ((fTemp1 * fSlow123) / fSlow124)))))) * std::sqrt(std::max<float>(0.0f, std::min<float>((fConst38 * fTemp24), ((fConst39 * (fConst37 - fTemp24)) + 1.0f))))) - (fConst40 * ((fConst41 * fRec16[2]) + (fConst42 * fRec16[1]))));
			fRec31[0] = (int(fTemp23) ? fSlow128 : fRec31[1]);
			...
			fRec34[0] = std::max<float>(fTemp26, ((fRec34[1] * fSlow135) + (fTemp26 * fSlow136)));
			fRec33[0] = ((fRec33[1] * fSlow132) + (fRec34[0] * fSlow137));
			fRec32[0] = ((fConst46 * fRec32[1]) + (fSlow129 * std::max<float>(((20.0f * std::log10(fRec33[0])) - fSlow138), 0.0f)));
			float fTemp27 = (fConst32 * (fTemp25 * std::pow(10.0f, (0.0500000007f * fRec32[0]))));
			fRec35[0] = (fTemp27 - (fSlow142 * ((fSlow143 * fRec35[2]) + (fSlow144 * fRec35[1]))));
			float fTemp28 = (fSlow11 * fRec15[1]);
			fRec15[0] = (fTemp27 - ((fSlow142 * (fRec35[2] + (fRec35[0] + (2.0f * fRec35[1])))) + (((fRec15[2] * fSlow152) + fTemp28) / fSlow153)));
			float fTemp29 = (fSlow8 * fRec14[1]);
			fRec14[0] = ((((fTemp28 + (fRec15[0] * fSlow155)) + (fRec15[2] * fSlow156)) / fSlow153) - (((fRec14[2] * fSlow164) + fTemp29) / fSlow165));
			fRec13[0] = ((((fTemp29 + (fRec14[0] * fSlow167)) + (fRec14[2] * fSlow168)) / fSlow165) - (fSlow169 * ((fSlow170 * fRec13[2]) + (fSlow171 * fRec13[1]))));
			...
			fVec5[0] = fSlow184;
			float fTemp31 = (fSlow184 - fVec5[1]);
			fVec6[0] = fSlow186;
			float fTemp32 = (0.0f - (fSlow184 + fVec6[1]));
			float fTemp33 = std::min<float>(1.0f, ((fTemp31 * float((fTemp31 > 0.0f))) + (fSlow185 * (fTemp32 * float((fTemp32 > 0.0f))))));
			fVec7[0] = fTemp33;
			int iTemp34 = int(fTemp33);
			fRec65[0] = (iTemp34 ? fSlow187 : fRec65[1]);
			float fTemp35 = ((340.0f / std::min<float>(5000.0f, std::max<float>(20.0f, (fSlow183 * (fRec20[0] * fRec65[0]))))) + -0.109999999f);
			...
			fRec66[0] = ((fSlow188 * fRec66[1]) + (fSlow189 * fRec61[1]));
			...
			fVec9[0] = fTemp88;
			fRec67[(IOTA & 2047)] = ((fSlow188 * fRec67[((IOTA - 1) & 2047)]) + (fSlow189 * fVec9[2]));
			...
			fRec40[0] = fRec43;
			float fRec41 = fRec45;
			fRec70[0] = (fSlow190 + (0.999000013f * fRec70[1]));
			...
			fRec72[0] = (iTemp34 ? fSlow128 : fRec72[1]);
			...
			fRec75[0] = std::max<float>(fTemp95, ((fRec75[1] * fSlow197) + (fTemp95 * fSlow198)));
			fRec74[0] = ((fRec74[1] * fSlow194) + (fRec75[0] * fSlow199));
			fRec73[0] = ((fConst46 * fRec73[1]) + (fSlow191 * std::max<float>(((20.0f * std::log10(fRec74[0])) - fSlow200), 0.0f)));
			float fTemp96 = (0.25f * ((fTemp94 * std::pow(10.0f, (0.0500000007f * fRec73[0]))) / fTemp92));
			fRec76[0] = (fTemp96 - (fSlow204 * ((fSlow205 * fRec76[2]) + (fSlow206 * fRec76[1]))));
			float fTemp97 = (fSlow182 * fRec38[1]);
			fRec38[0] = (fTemp96 - ((fSlow204 * (fRec76[2] + (fRec76[0] + (2.0f * fRec76[1])))) + (((fRec38[2] * fSlow214) + fTemp97) / fSlow215)));
			float fTemp98 = (fSlow179 * fRec37[1]);
			fRec37[0] = ((((fTemp97 + (fRec38[0] * fSlow217)) + (fRec38[2] * fSlow218)) / fSlow215) - (((fRec37[2] * fSlow226) + fTemp98) / fSlow227));
			fRec36[0] = ((((fTemp98 + (fRec37[0] * fSlow229)) + (fRec37[2] * fSlow230)) / fSlow227) - (fSlow231 * ((fSlow232 * fRec36[2]) + (fSlow233 * fRec36[1]))));
			float fTemp99 = (fSlow176 * (fRec36[2] + (fRec36[0] + (2.0f * fRec36[1]))));
			...
			fRec110[0] = (fTemp116 - (fSlow253 * ((fSlow256 * fRec110[2]) + (fSlow257 * fRec110[1]))));
			fRec109[0] = ((fSlow253 * (((fSlow255 * fRec110[0]) + (fSlow258 * fRec110[1])) + (fSlow255 * fRec110[2]))) - (fSlow250 * ((fSlow259 * fRec109[2]) + (fSlow260 * fRec109[1]))));
			fVec26[0] = fSlow262;
			float fTemp117 = (fSlow262 - fVec26[1]);
			fVec27[0] = fSlow264;
			float fTemp118 = (0.0f - (fSlow262 + fVec27[1]));
			float fTemp119 = std::min<float>(1.0f, ((fTemp117 * float((fTemp117 > 0.0f))) + (fSlow263 * (fTemp118 * float((fTemp118 > 0.0f))))));
			fVec28[0] = fTemp119;
			iRec111[0] = (((iRec111[1] + (iRec111[1] > 0)) * (fTemp119 <= fVec28[1])) + (fTemp119 > fVec28[1]));
			float fTemp120 = (fSlow261 * float(iRec111[0]));
			float fTemp121 = (fSlow250 * ((fRec109[2] + (fRec109[0] + (2.0f * fRec109[1]))) * std::max<float>(0.0f, std::min<float>(fTemp120, (2.0f - fTemp120)))));
			int iTemp122 = int(fTemp119);
			fRec112[0] = (iTemp122 ? fSlow262 : fRec112[1]);
			...
			fRec132[0] = (iTemp122 ? fSlow128 : fRec132[1]);
			...
			float fTemp124 = std::fabs((fSlow246 * fTemp123));
			fRec135[0] = std::max<float>(fTemp124, ((fRec135[1] * fSlow271) + (fTemp124 * fSlow272)));
			fRec134[0] = ((fRec134[1] * fSlow268) + (fRec135[0] * fSlow273));
			fRec133[0] = ((fConst46 * fRec133[1]) + (fSlow265 * std::max<float>(((20.0f * std::log10(fRec134[0])) - fSlow274), 0.0f)));
			float fTemp125 = (fSlow246 * (fTemp123 * std::pow(10.0f, (0.0500000007f * fRec133[0]))));
			fRec136[0] = (fTemp125 - (fSlow278 * ((fSlow279 * fRec136[2]) + (fSlow280 * fRec136[1]))));
			float fTemp126 = (fSlow244 * fRec107[1]);
			fRec107[0] = (fTemp125 - ((fSlow278 * (fRec136[2] + (fRec136[0] + (2.0f * fRec136[1])))) + (((fRec107[2] * fSlow288) + fTemp126) / fSlow289)));
			float fTemp127 = (fSlow241 * fRec106[1]);
			fRec106[0] = ((((fTemp126 + (fRec107[0] * fSlow291)) + (fRec107[2] * fSlow292)) / fSlow289) - (((fRec106[2] * fSlow300) + fTemp127) / fSlow301));
			fRec105[0] = ((((fTemp127 + (fRec106[0] * fSlow303)) + (fRec106[2] * fSlow304)) / fSlow301) - (fSlow305 * ((fSlow306 * fRec105[2]) + (fSlow307 * fRec105[1]))));
			float fTemp128 = ((fSlow238 * (fRec105[2] + (fRec105[0] + (2.0f * fRec105[1])))) + fTemp30);
			fVec29[0] = fSlow319;
			float fTemp129 = (fSlow319 - fVec29[1]);
			fVec30[0] = fSlow321;
			float fTemp130 = (0.0f - (fSlow319 + fVec30[1]));
			float fTemp131 = std::min<float>(1.0f, ((fTemp129 * float((fTemp129 > 0.0f))) + (fSlow320 * (fTemp130 * float((fTemp130 > 0.0f))))));
			fVec31[0] = fTemp131;
			...
			fRec146[0] = ((fConst221 * fRec146[1]) + (fSlow324 * fRec147[0]));
			...
			fRec150[0] = (iTemp135 ? fSlow325 : fRec150[1]);
			...
			fRec153[0] = (iTemp135 ? fSlow326 : fRec153[1]);
			...
			fRec156[0] = (iTemp135 ? fSlow327 : fRec156[1]);
			...
			fRec159[0] = std::max<float>(fTemp160, ((fRec159[1] * fSlow334) + (fTemp160 * fSlow335)));
			fRec158[0] = ((fRec158[1] * fSlow331) + (fRec159[0] * fSlow336));
			fRec157[0] = ((fConst46 * fRec157[1]) + (fSlow328 * std::max<float>(((20.0f * std::log10(fRec158[0])) - fSlow337), 0.0f)));
			float fTemp161 = (0.25f * (fTemp159 * std::pow(10.0f, (0.0500000007f * fRec157[0]))));
			fRec160[0] = (fTemp161 - (fSlow341 * ((fSlow342 * fRec160[2]) + (fSlow343 * fRec160[1]))));
			float fTemp162 = (fSlow318 * fRec139[1]);
			fRec139[0] = (fTemp161 - ((fSlow341 * (fRec160[2] + (fRec160[0] + (2.0f * fRec160[1])))) + (((fRec139[2] * fSlow351) + fTemp162) / fSlow352)));
			float fTemp163 = (fSlow315 * fRec138[1]);
			fRec138[0] = ((((fTemp162 + (fRec139[0] * fSlow354)) + (fRec139[2] * fSlow355)) / fSlow352) - (((fRec138[2] * fSlow363) + fTemp163) / fSlow364));
			fRec137[0] = ((((fTemp163 + (fRec138[0] * fSlow366)) + (fRec138[2] * fSlow367)) / fSlow364) - (fSlow368 * ((fSlow369 * fRec137[2]) + (fSlow370 * fRec137[1]))));
			iRec164[0] = 0;
			...
			fVec33[0] = fSlow383;
			float fTemp165 = (fSlow383 - fVec33[1]);
			fVec34[0] = fSlow385;
			float fTemp166 = (0.0f - (fSlow383 + fVec34[1]));
			float fTemp167 = std::min<float>(1.0f, ((fTemp165 * float((fTemp165 > 0.0f))) + (fSlow384 * (fTemp166 * float((fTemp166 > 0.0f))))));
			fVec35[0] = fTemp167;
			int iTemp168 = int(fTemp167);
			fRec169[0] = (iTemp168 ? fSlow383 : fRec169[1]);
			...
			float fTemp197 = (fSlow386 * float(iRec174[0]));
			...
			fRec224[0] = (iTemp168 ? fSlow128 : fRec224[1]);
			float fTemp200 = (fRec165 * std::pow(10.0f, (0.144444451f * (fRec224[0] + -10.0f))));
			float fTemp201 = std::fabs((0.25f * fTemp200));
			fRec227[0] = std::max<float>(fTemp201, ((fRec227[1] * fSlow393) + (fTemp201 * fSlow394)));
			fRec226[0] = ((fRec226[1] * fSlow390) + (fRec227[0] * fSlow395));
			fRec225[0] = ((fConst46 * fRec225[1]) + (fSlow387 * std::max<float>(((20.0f * std::log10(fRec226[0])) - fSlow396), 0.0f)));
			float fTemp202 = (0.25f * (fTemp200 * std::pow(10.0f, (0.0500000007f * fRec225[0]))));
			fRec228[0] = (fTemp202 - (fSlow400 * ((fSlow401 * fRec228[2]) + (fSlow402 * fRec228[1]))));
			float fTemp203 = (fSlow382 * fRec163[1]);
			fRec163[0] = (fTemp202 - ((fSlow400 * (fRec228[2] + (fRec228[0] + (2.0f * fRec228[1])))) + (((fRec163[2] * fSlow410) + fTemp203) / fSlow411)));
			float fTemp204 = (fSlow379 * fRec162[1]);
			fRec162[0] = ((((fTemp203 + (fRec163[0] * fSlow413)) + (fRec163[2] * fSlow414)) / fSlow411) - (((fRec162[2] * fSlow422) + fTemp204) / fSlow423));
			fRec161[0] = ((((fTemp204 + (fRec162[0] * fSlow425)) + (fRec162[2] * fSlow426)) / fSlow423) - (fSlow427 * ((fSlow428 * fRec161[2]) + (fSlow429 * fRec161[1]))));
			...
			fRec234[0] = (iTemp135 ? fSlow441 : fRec234[1]);
			float fTemp206 = (fRec238[1] + (fSlow442 * fRec234[0]));
			fRec238[0] = (fTemp206 - std::floor(fTemp206));
			float fTemp207 = (fRec237[1] + (fConst5 * ((315.0f * (fRec232[0] * ftbl0mydspSIG0[int((65536.0f * fRec238[0]))])) + (fSlow443 * fRec234[0]))));
			fRec237[0] = (fTemp207 - std::floor(fTemp207));
			float fTemp208 = (fRec236[1] + (fConst5 * ((315.0f * (fRec232[0] * ftbl0mydspSIG0[int((65536.0f * fRec237[0]))])) + (fSlow444 * fRec234[0]))));
			fRec236[0] = (fTemp208 - std::floor(fTemp208));
			float fTemp209 = (fRec235[1] + (fConst5 * ((315.0f * (fRec232[0] * ftbl0mydspSIG0[int((65536.0f * fRec236[0]))])) + (fSlow445 * fRec234[0]))));
			fRec235[0] = (fTemp209 - std::floor(fTemp209));
			float fTemp210 = (fRec233[1] + (fConst5 * ((fSlow12 * fRec234[0]) + (315.0f * (fRec232[0] * ftbl0mydspSIG0[int((65536.0f * fRec235[0]))])))));
			...
			fRec241[0] = std::max<float>(fTemp214, ((fRec241[1] * fSlow452) + (fTemp214 * fSlow453)));
			fRec240[0] = ((fRec240[1] * fSlow449) + (fRec241[0] * fSlow454));
			fRec239[0] = ((fConst46 * fRec239[1]) + (fSlow446 * std::max<float>(((20.0f * std::log10(fRec240[0])) - fSlow455), 0.0f)));
			float fTemp215 = (0.25f * (fTemp213 * std::pow(10.0f, (0.0500000007f * fRec239[0]))));
			fRec242[0] = (fTemp215 - (fSlow459 * ((fSlow460 * fRec242[2]) + (fSlow461 * fRec242[1]))));
			float fTemp216 = (fSlow440 * fRec231[1]);
			fRec231[0] = (fTemp215 - ((fSlow459 * (fRec242[2] + (fRec242[0] + (2.0f * fRec242[1])))) + (((fRec231[2] * fSlow469) + fTemp216) / fSlow470)));
			float fTemp217 = (fSlow437 * fRec230[1]);
			fRec230[0] = ((((fTemp216 + (fRec231[0] * fSlow472)) + (fRec231[2] * fSlow473)) / fSlow470) - (((fRec230[2] * fSlow481) + fTemp217) / fSlow482));
			fRec229[0] = ((((fTemp217 + (fRec230[0] * fSlow484)) + (fRec230[2] * fSlow485)) / fSlow482) - (fSlow486 * ((fSlow487 * fRec229[2]) + (fSlow488 * fRec229[1]))));
			float fTemp218 = (fSlow434 * (fRec229[2] + (fRec229[0] + (2.0f * fRec229[1]))));
			fRec247[0] = (fTemp196 - (fConst492 * ((fConst493 * fRec247[2]) + (fConst494 * fRec247[1]))));
			fVec38[0] = fSlow500;
			float fTemp219 = (fSlow500 - fVec38[1]);
			fVec39[0] = fSlow502;
			float fTemp220 = (0.0f - (fSlow500 + fVec39[1]));
			float fTemp221 = std::min<float>(1.0f, ((fTemp219 * float((fTemp219 > 0.0f))) + (fSlow501 * (fTemp220 * float((fTemp220 > 0.0f))))));
			fVec40[0] = fTemp221;
			...
			fRec298[0] = (fSlow505 + (fRec298[1] - std::floor((fSlow505 + fRec298[1]))));
			fRec299[0] = (fSlow508 + (fRec299[1] - std::floor((fSlow508 + fRec299[1]))));
			float fTemp225 = (((0.0199999996f * (((((((((((((((((((((((((((((((((((((((((((((((((((fConst489 * (fRec246[0] - fRec246[2])) + (fConst499 * (fRec249[0] - fRec249[2]))) + (fConst503 * (fRec250[0] - fRec250[2]))) + (fConst507 * (fRec251[0] - fRec251[2]))) + (fConst511 * (fRec252[0] - fRec252[2]))) + (fConst515 * (fRec253[0] - fRec253[2]))) + (fConst519 * (fRec254[0] - fRec254[2]))) + (fConst523 * (fRec255[0] - fRec255[2]))) + (fConst527 * (fRec256[0] - fRec256[2]))) + (fConst531 * (fRec257[0] - fRec257[2]))) + (fConst535 * (fRec258[0] - fRec258[2]))) + (fConst539 * (fRec259[0] - fRec259[2]))) + (fConst543 * (fRec260[0] - fRec260[2]))) + (fConst547 * (fRec261[0] - fRec261[2]))) + (fConst551 * (fRec262[0] - fRec262[2]))) + (fConst555 * (fRec263[0] - fRec263[2]))) + (fConst559 * (fRec264[0] - fRec264[2]))) + (fConst563 * (fRec265[0] - fRec265[2]))) + (fConst567 * (fRec266[0] - fRec266[2]))) + (fConst571 * (fRec267[0] - fRec267[2]))) + (fConst575 * (fRec268[0] - fRec268[2]))) + (fConst579 * (fRec269[0] - fRec269[2]))) + (fConst583 * (fRec270[0] - fRec270[2]))) + (fConst587 * (fRec271[0] - fRec271[2]))) + (fConst591 * (fRec272[0] - fRec272[2]))) + (fConst595 * (fRec273[0] - fRec273[2]))) + (fConst599 * (fRec274[0] - fRec274[2]))) + (fConst603 * (fRec275[0] - fRec275[2]))) + (fConst607 * (fRec276[0] - fRec276[2]))) + (fConst611 * (fRec277[0] - fRec277[2]))) + (fConst615 * (fRec278[0] - fRec278[2]))) + (fConst619 * (fRec279[0] - fRec279[2]))) + (fConst623 * (fRec280[0] - fRec280[2]))) + (fConst627 * (fRec281[0] - fRec281[2]))) + (fConst631 * (fRec282[0] - fRec282[2]))) + (fConst635 * (fRec283[0] - fRec283[2]))) + (fConst639 * (fRec284[0] - fRec284[2]))) + (fConst643 * (fRec285[0] - fRec285[2]))) + (fConst647 * (fRec286[0] - fRec286[2]))) + (fConst651 * (fRec287[0] - fRec287[2]))) + (fConst655 * (fRec288[0] - fRec288[2]))) + (fConst659 * (fRec289[0] - fRec289[2]))) + (fConst663 * (fRec290[0] - fRec290[2]))) + (fConst667 * (fRec291[0] - fRec291[2]))) + (fConst671 * (fRec292[0] - fRec292[2]))) + (fConst675 * (fRec293[0] - fRec293[2]))) + (fConst679 * (fRec294[0] - fRec294[2]))) + (fConst683 * (fRec295[0] - fRec295[2]))) + (fConst687 * (fRec296[0] - fRec296[2]))) + (fConst691 * (fRec297[0] - fRec297[2]))) * std::max<float>(0.0f, std::min<float>((fConst44 * fTemp222), ((fConst695 * (fConst43 - fTemp222)) + 1.0f))))) + (fSlow504 * ftbl0mydspSIG0[int((65536.0f * fRec298[0]))])) + (fSlow507 * ftbl0mydspSIG0[int((65536.0f * fRec299[0]))]));
			float fTemp226 = std::fabs((0.25f * fTemp225));
			fRec302[0] = std::max<float>(fTemp226, ((fRec302[1] * fSlow515) + (fTemp226 * fSlow516)));
			fRec301[0] = ((fRec301[1] * fSlow512) + (fRec302[0] * fSlow517));
			fRec300[0] = ((fConst46 * fRec300[1]) + (fSlow509 * std::max<float>(((20.0f * std::log10(fRec301[0])) - fSlow518), 0.0f)));
			float fTemp227 = (0.25f * (fTemp225 * std::pow(10.0f, (0.0500000007f * fRec300[0]))));
			fRec303[0] = (fTemp227 - (fSlow522 * ((fSlow523 * fRec303[2]) + (fSlow524 * fRec303[1]))));
			float fTemp228 = (fSlow499 * fRec245[1]);
			fRec245[0] = (fTemp227 - ((fSlow522 * (fRec303[2] + (fRec303[0] + (2.0f * fRec303[1])))) + (((fRec245[2] * fSlow532) + fTemp228) / fSlow533)));
			float fTemp229 = (fSlow496 * fRec244[1]);
			fRec244[0] = ((((fTemp228 + (fRec245[0] * fSlow535)) + (fRec245[2] * fSlow536)) / fSlow533) - (((fRec244[2] * fSlow544) + fTemp229) / fSlow545));
			fRec243[0] = ((((fTemp229 + (fRec244[0] * fSlow547)) + (fRec244[2] * fSlow548)) / fSlow545) - (fSlow549 * ((fSlow550 * fRec243[2]) + (fSlow551 * fRec243[1]))));
			float fTemp230 = (fSlow493 * (fRec243[2] + (fRec243[0] + (2.0f * fRec243[1]))));
			float fTemp231 = ((fConst10 * fRec0[2]) + ((((((fTemp128 + (fSlow312 * (fRec137[2] + (fRec137[0] + (2.0f * fRec137[1]))))) + (fSlow376 * fTemp205)) + fTemp218) + fTemp99) + fTemp230) + (fConst9 * fRec0[0])));
			float fTemp232 = std::fabs(fTemp231);
			fRec306[0] = std::max<float>(fTemp232, ((fConst698 * fRec306[1]) + (fConst699 * fTemp232)));
			fRec305[0] = ((fConst696 * fRec305[1]) + (fConst697 * fRec306[0]));
			fRec304[0] = ((fConst46 * fRec304[1]) + (fConst47 * (0.0f - (0.00990098994f * std::max<float>((20.0f * (std::log10(fRec305[0]) + 1.0f)), 0.0f)))));
			float fTemp233 = (fTemp231 * std::pow(10.0f, (0.0500000007f * fRec304[0])));
			float fTemp234 = std::fabs(fTemp233);
			fRec309[0] = std::max<float>(fTemp234, ((fConst702 * fRec309[1]) + (fConst703 * fTemp234)));
			fRec308[0] = ((fConst700 * fRec308[1]) + (fConst701 * fRec309[0]));
			fRec307[0] = ((fConst46 * fRec307[1]) + (fConst47 * (0.0f - (0.0909090936f * std::max<float>(((20.0f * std::log10(fRec308[0])) + 5.0f), 0.0f)))));
			float fTemp235 = (fTemp233 * std::pow(10.0f, (0.0500000007f * fRec307[0])));
			float fTemp236 = std::fabs((fSlow0 * fTemp235));
			fRec312[0] = std::max<float>(fTemp236, ((fConst46 * fRec312[1]) + (fConst47 * fTemp236)));
			fRec311[0] = ((fConst704 * fRec311[1]) + (fConst705 * fRec312[0]));
			fRec310[0] = ((fConst46 * fRec310[1]) + (fConst47 * (0.0f - (0.899999976f * std::max<float>((20.0f * std::log10(fRec311[0])), 0.0f)))));
			output0[i] = FAUSTFLOAT(std::max<float>(-1.0f, std::min<float>(1.0f, (fSlow0 * (fTemp235 * std::pow(10.0f, (0.0500000007f * fRec310[0])))))));
			fRec313[0] = ((0.370000005f * (fRec2[0] - fRec3[0])) - (fConst152 * ((fConst153 * fRec313[1]) + (fConst154 * fRec313[2]))));
			float fTemp237 = (fRec145[0] + 0.5f);
			iRec318[0] = ((iVec0[1] + iRec318[1]) % int((fConst0 / fTemp237)));
			float fTemp238 = float(iRec318[0]);
			...
			fRec317[0] = ((2.0f * (((float((fTemp238 < (fConst218 / fTemp237))) + -0.5f) + (float((fTemp238 < (fConst219 / fTemp237))) + -0.5f)) + (float((fTemp238 < (fConst220 / fTemp237))) + -0.5f))) - (((fRec317[2] * (((fTemp240 + -1.41421354f) / fTemp239) + 1.0f)) + (2.0f * (fRec317[1] * (1.0f - (1.0f / mydsp_faustpower2_f(fTemp239)))))) / fTemp241));
			float fTemp242 = (fRec150[0] + 0.5f);
			iRec320[0] = ((iVec0[1] + iRec320[1]) % int((fConst0 / fTemp242)));
			float fTemp243 = float(iRec320[0]);
			...
			fRec319[0] = ((2.0f * (((float((fTemp243 < (fConst218 / fTemp242))) + -0.5f) + (float((fTemp243 < (fConst219 / fTemp242))) + -0.5f)) + (float((fTemp243 < (fConst220 / fTemp242))) + -0.5f))) - (((fRec319[2] * (((fTemp245 + -1.41421354f) / fTemp244) + 1.0f)) + (2.0f * (fRec319[1] * (1.0f - (1.0f / mydsp_faustpower2_f(fTemp244)))))) / fTemp246));
			float fTemp247 = (fRec153[0] + 0.5f);
			iRec322[0] = ((iVec0[1] + iRec322[1]) % int((fConst0 / fTemp247)));
			float fTemp248 = float(iRec322[0]);
			...
			fRec321[0] = ((2.0f * (((float((fTemp248 < (fConst218 / fTemp247))) + -0.5f) + (float((fTemp248 < (fConst219 / fTemp247))) + -0.5f)) + (float((fTemp248 < (fConst220 / fTemp247))) + -0.5f))) - (((fRec321[2] * (((fTemp250 + -1.41421354f) / fTemp249) + 1.0f)) + (2.0f * (fRec321[1] * (1.0f - (1.0f / mydsp_faustpower2_f(fTemp249)))))) / fTemp251));
			float fTemp252 = (fRec156[0] + 0.5f);
			iRec324[0] = ((iVec0[1] + iRec324[1]) % int((fConst0 / fTemp252)));
			float fTemp253 = float(iRec324[0]);
			...
			fRec323[0] = ((2.0f * (((float((fTemp253 < (fConst218 / fTemp252))) + -0.5f) + (float((fTemp253 < (fConst219 / fTemp252))) + -0.5f)) + (float((fTemp253 < (fConst220 / fTemp252))) + -0.5f))) - (((fRec323[2] * (((fTemp255 + -1.41421354f) / fTemp254) + 1.0f)) + (2.0f * (fRec323[1] * (1.0f - (1.0f / mydsp_faustpower2_f(fTemp254)))))) / fTemp256));
			float fTemp257 = (fTemp137 * (((((fRec317[2] + (fRec317[0] + (2.0f * fRec317[1]))) / fTemp241) + ((fRec319[2] + (fRec319[0] + (2.0f * fRec319[1]))) / fTemp246)) + ((fRec321[2] + (fRec321[0] + (2.0f * fRec321[1]))) / fTemp251)) + ((fRec323[2] + (fRec323[0] + (2.0f * fRec323[1]))) / fTemp256)));
			float fTemp258 = std::fabs((0.25f * fTemp257));
			fRec327[0] = std::max<float>(fTemp258, ((fSlow334 * fRec327[1]) + (fSlow335 * fTemp258)));
			fRec326[0] = ((fSlow331 * fRec326[1]) + (fRec327[0] * fSlow336));
			fRec325[0] = ((fConst46 * fRec325[1]) + (fSlow328 * std::max<float>(((20.0f * std::log10(fRec326[0])) - fSlow337), 0.0f)));
			float fTemp259 = (0.25f * (fTemp257 * std::pow(10.0f, (0.0500000007f * fRec325[0]))));
			fRec328[0] = (fTemp259 - (fSlow341 * ((fSlow342 * fRec328[2]) + (fSlow343 * fRec328[1]))));
			float fTemp260 = (fSlow318 * fRec316[1]);
			fRec316[0] = (fTemp259 - ((fSlow341 * (fRec328[2] + (fRec328[0] + (2.0f * fRec328[1])))) + (((fSlow351 * fRec316[2]) + fTemp260) / fSlow352)));
			float fTemp261 = (fSlow315 * fRec315[1]);
			fRec315[0] = ((((fTemp260 + (fRec316[0] * fSlow354)) + (fSlow355 * fRec316[2])) / fSlow352) - (((fSlow363 * fRec315[2]) + fTemp261) / fSlow364));
			fRec314[0] = ((((fTemp261 + (fRec315[0] * fSlow366)) + (fSlow367 * fRec315[2])) / fSlow364) - (fSlow368 * ((fSlow369 * fRec314[2]) + (fSlow370 * fRec314[1]))));
			float fTemp262 = ((fConst10 * fRec313[2]) + (((fSlow312 * (fRec314[2] + (fRec314[0] + (2.0f * fRec314[1])))) + (fTemp230 + (fTemp99 + (fTemp218 + (fTemp128 + (fSlow552 * fTemp205)))))) + (fConst9 * fRec313[0])));
			float fTemp263 = std::fabs(fTemp262);
			fRec331[0] = std::max<float>(fTemp263, ((fConst698 * fRec331[1]) + (fConst699 * fTemp263)));
			fRec330[0] = ((fConst696 * fRec330[1]) + (fConst697 * fRec331[0]));
			fRec329[0] = ((fConst46 * fRec329[1]) + (fConst47 * (0.0f - (0.00990098994f * std::max<float>((20.0f * (std::log10(fRec330[0]) + 1.0f)), 0.0f)))));
			float fTemp264 = (fTemp262 * std::pow(10.0f, (0.0500000007f * fRec329[0])));
			float fTemp265 = std::fabs(fTemp264);
			fRec334[0] = std::max<float>(fTemp265, ((fConst702 * fRec334[1]) + (fConst703 * fTemp265)));
			fRec333[0] = ((fConst700 * fRec333[1]) + (fConst701 * fRec334[0]));
			fRec332[0] = ((fConst46 * fRec332[1]) + (fConst47 * (0.0f - (0.0909090936f * std::max<float>(((20.0f * std::log10(fRec333[0])) + 5.0f), 0.0f)))));
			float fTemp266 = (fTemp264 * std::pow(10.0f, (0.0500000007f * fRec332[0])));
			float fTemp267 = std::fabs((fSlow0 * fTemp266));
			fRec337[0] = std::max<float>(fTemp267, ((fConst46 * fRec337[1]) + (fConst47 * fTemp267)));
			fRec336[0] = ((fConst704 * fRec336[1]) + (fConst705 * fRec337[0]));
			fRec335[0] = ((fConst46 * fRec335[1]) + (fConst47 * (0.0f - (0.899999976f * std::max<float>((20.0f * std::log10(fRec336[0])), 0.0f)))));
			output1[i] = FAUSTFLOAT(std::max<float>(-1.0f, std::min<float>(1.0f, (fSlow0 * (fTemp266 * std::pow(10.0f, (0.0500000007f * fRec335[0])))))));
			iVec0[1] = iVec0[0];
			fRec12[1] = fRec12[0];
			fRec11[1] = fRec11[0];
			IOTA = (IOTA + 1);
