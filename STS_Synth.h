...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void instanceResetUserInterface() {
		...
		fHslider28 = FAUSTFLOAT(0.01f);
		fHslider29 = FAUSTFLOAT(1500.0f);
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("Track 1", &fHslider40, 0.0f, -96.0f, 24.0f, 0.00999999978f);
		ui_interface->addHorizontalSlider("Track 2", &fHslider0, 0.0f, -96.0f, 24.0f, 0.00999999978f);
		ui_interface->addHorizontalSlider("Track 3", &fHslider57, 0.0f, -96.0f, 24.0f, 0.00999999978f);
		ui_interface->addHorizontalSlider("Track 4", &fHslider77, 0.0f, -96.0f, 24.0f, 0.00999999978f);
		...
		ui_interface->addHorizontalSlider("Control 0", &fHslider28, 0.00999999978f, 0.0f, 2000.0f, 0.00100000005f);
		ui_interface->closeBox();
		...
		ui_interface->addHorizontalSlider("Control 0", &fHslider45, 1.0f, 0.0f, 2000.0f, 0.00100000005f);
		ui_interface->closeBox();
		...
		ui_interface->addHorizontalSlider("Control 0", &fHslider29, 1500.0f, 0.0f, 2000.0f, 0.00100000005f);
		ui_interface->closeBox();
		...
		ui_interface->addHorizontalSlider("Control 0", &fHslider63, 440.0f, 0.0f, 2000.0f, 0.00100000005f);
		ui_interface->addHorizontalSlider("Control 1", &fHslider64, 440.0f, 0.0f, 2000.0f, 0.00100000005f);
		ui_interface->addHorizontalSlider("Control 2", &fHslider65, 440.0f, 0.0f, 2000.0f, 0.00100000005f);
		ui_interface->addHorizontalSlider("Control 3", &fHslider66, 440.0f, 0.0f, 2000.0f, 0.00100000005f);
		ui_interface->closeBox();
		...
		ui_interface->addHorizontalSlider("Control 0", &fHslider82, 0.0f, 0.0f, 2000.0f, 0.00100000005f);
		ui_interface->closeBox();
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow13 = std::pow(10.0f, (2.0f * (std::min<float>(1.0f, std::max<float>(0.0f, float(fHslider6))) + -0.5f)));
		float fSlow14 = (2.0f * (fSlow12 * fSlow13));
		float fSlow15 = std::min<float>(1.0f, std::max<float>(0.0f, float(fHslider7)));
		float fSlow16 = (0.5f * fSlow15);
		float fSlow17 = std::min<float>(1000.0f, std::max<float>(0.0f, float(fHslider8)));
		float fSlow18 = (1.0f - fSlow17);
		float fSlow19 = (4.65661287e-10f * fSlow17);
		...
		float fSlow126 = float(fHslider10);
		float fSlow127 = float((fSlow126 > 0.0f));
		float fSlow128 = (0.0f - fSlow126);
		float fSlow129 = std::min<float>(10.0f, std::max<float>(7.0f, float(fHslider11)));
		float fSlow130 = (fConst47 * ((1.0f / float(fHslider12)) + -1.0f));
		float fSlow131 = float(fHslider13);
		int iSlow132 = (std::fabs(fSlow131) < 1.1920929e-07f);
		float fSlow133 = (iSlow132 ? 0.0f : std::exp((0.0f - (fConst5 / (iSlow132 ? 1.0f : fSlow131)))));
		float fSlow134 = float(fHslider14);
		int iSlow135 = (std::fabs(fSlow134) < 1.1920929e-07f);
		float fSlow136 = (iSlow135 ? 0.0f : std::exp((0.0f - (fConst5 / (iSlow135 ? 1.0f : fSlow134)))));
		float fSlow137 = (1.0f - fSlow136);
		float fSlow138 = (1.0f - fSlow133);
		float fSlow139 = float(fHslider15);
		float fSlow140 = (1.0f / float(fHslider16));
		float fSlow141 = std::tan((fConst28 * float(fHslider17)));
		float fSlow142 = (1.0f / fSlow141);
		float fSlow143 = (1.0f / (((fSlow140 + fSlow142) / fSlow141) + 1.0f));
		float fSlow144 = (((fSlow142 - fSlow140) / fSlow141) + 1.0f);
		float fSlow145 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow141))));
		float fSlow146 = (1.0f / fSlow10);
		float fSlow147 = float(fHslider18);
		int iSlow148 = (fSlow147 > 0.0f);
		float fSlow149 = (float(fHslider19) * std::sin((fConst48 * fSlow9)));
		float fSlow150 = (fConst28 * ((fSlow9 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow147)))) / fSlow149));
		float fSlow151 = (fConst28 * (fSlow9 / fSlow149));
		float fSlow152 = (iSlow148 ? fSlow151 : fSlow150);
		float fSlow153 = ((fSlow146 * (fSlow146 - fSlow152)) + 1.0f);
		float fSlow154 = ((fSlow146 * (fSlow146 + fSlow152)) + 1.0f);
		float fSlow155 = (iSlow148 ? fSlow150 : fSlow151);
		float fSlow156 = ((fSlow146 * (fSlow146 + fSlow155)) + 1.0f);
		float fSlow157 = ((fSlow146 * (fSlow146 - fSlow155)) + 1.0f);
		float fSlow158 = (1.0f / fSlow7);
		float fSlow159 = float(fHslider20);
		int iSlow160 = (fSlow159 > 0.0f);
		float fSlow161 = (float(fHslider21) * std::sin((fConst48 * fSlow6)));
		float fSlow162 = (fConst28 * ((fSlow6 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow159)))) / fSlow161));
		float fSlow163 = (fConst28 * (fSlow6 / fSlow161));
		float fSlow164 = (iSlow160 ? fSlow163 : fSlow162);
		float fSlow165 = ((fSlow158 * (fSlow158 - fSlow164)) + 1.0f);
		float fSlow166 = ((fSlow158 * (fSlow158 + fSlow164)) + 1.0f);
		float fSlow167 = (iSlow160 ? fSlow162 : fSlow163);
		float fSlow168 = ((fSlow158 * (fSlow158 + fSlow167)) + 1.0f);
		float fSlow169 = ((fSlow158 * (fSlow158 - fSlow167)) + 1.0f);
		float fSlow170 = (1.0f / fSlow4);
		float fSlow171 = (((fSlow3 - fSlow1) / fSlow2) + 1.0f);
		float fSlow172 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow2))));
		float fSlow173 = (1.0f / float(fHslider23));
		float fSlow174 = std::tan((fConst28 * float(fHslider24)));
		float fSlow175 = (1.0f / fSlow174);
		float fSlow176 = (((fSlow173 + fSlow175) / fSlow174) + 1.0f);
		float fSlow177 = ((std::pow(10.0f, (0.0500000007f * float(fHslider22))) * (1.0f - float(fCheckbox1))) / fSlow176);
		float fSlow178 = float(fHslider25);
		float fSlow179 = std::tan((fConst28 * fSlow178));
		float fSlow180 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow179))));
		float fSlow181 = float(fHslider26);
		float fSlow182 = std::tan((fConst28 * fSlow181));
		float fSlow183 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow182))));
		float fSlow184 = (2.0f * fSlow13);
		float fSlow185 = float(fHslider27);
		float fSlow186 = float((fSlow185 > 0.0f));
		float fSlow187 = (0.0f - fSlow185);
		float fSlow188 = (2.0f * fSlow12);
		float fSlow189 = std::min<float>(1.0f, std::max<float>(0.00999999978f, float(fHslider28)));
		float fSlow190 = (1.0f - fSlow189);
		float fSlow191 = (0.00999999978f * float(fHslider29));
		float fSlow192 = (fConst47 * ((1.0f / float(fHslider30)) + -1.0f));
		float fSlow193 = float(fHslider31);
		int iSlow194 = (std::fabs(fSlow193) < 1.1920929e-07f);
		float fSlow195 = (iSlow194 ? 0.0f : std::exp((0.0f - (fConst5 / (iSlow194 ? 1.0f : fSlow193)))));
		float fSlow196 = float(fHslider32);
		int iSlow197 = (std::fabs(fSlow196) < 1.1920929e-07f);
		float fSlow198 = (iSlow197 ? 0.0f : std::exp((0.0f - (fConst5 / (iSlow197 ? 1.0f : fSlow196)))));
		float fSlow199 = (1.0f - fSlow198);
		float fSlow200 = (1.0f - fSlow195);
		float fSlow201 = float(fHslider33);
		float fSlow202 = (1.0f / float(fHslider34));
		float fSlow203 = std::tan((fConst28 * float(fHslider35)));
		float fSlow204 = (1.0f / fSlow203);
		float fSlow205 = (1.0f / (((fSlow202 + fSlow204) / fSlow203) + 1.0f));
		float fSlow206 = (((fSlow204 - fSlow202) / fSlow203) + 1.0f);
		float fSlow207 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow203))));
		float fSlow208 = (1.0f / fSlow182);
		float fSlow209 = float(fHslider36);
		int iSlow210 = (fSlow209 > 0.0f);
		float fSlow211 = (float(fHslider37) * std::sin((fConst48 * fSlow181)));
		float fSlow212 = (fConst28 * ((fSlow181 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow209)))) / fSlow211));
		float fSlow213 = (fConst28 * (fSlow181 / fSlow211));
		float fSlow214 = (iSlow210 ? fSlow213 : fSlow212);
		float fSlow215 = ((fSlow208 * (fSlow208 - fSlow214)) + 1.0f);
		float fSlow216 = ((fSlow208 * (fSlow208 + fSlow214)) + 1.0f);
		float fSlow217 = (iSlow210 ? fSlow212 : fSlow213);
		float fSlow218 = ((fSlow208 * (fSlow208 + fSlow217)) + 1.0f);
		float fSlow219 = ((fSlow208 * (fSlow208 - fSlow217)) + 1.0f);
		float fSlow220 = (1.0f / fSlow179);
		float fSlow221 = float(fHslider38);
		int iSlow222 = (fSlow221 > 0.0f);
		float fSlow223 = (float(fHslider39) * std::sin((fConst48 * fSlow178)));
		float fSlow224 = (fConst28 * ((fSlow178 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow221)))) / fSlow223));
		float fSlow225 = (fConst28 * (fSlow178 / fSlow223));
		...
		float fSlow232 = (1.0f / fSlow176);
		float fSlow233 = (((fSlow175 - fSlow173) / fSlow174) + 1.0f);
		float fSlow234 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow174))));
		float fSlow235 = (1.0f / float(fHslider41));
		float fSlow236 = std::tan((fConst28 * float(fHslider42)));
		float fSlow237 = (1.0f / fSlow236);
		float fSlow238 = (((fSlow235 + fSlow237) / fSlow236) + 1.0f);
		float fSlow239 = ((std::pow(10.0f, (0.0500000007f * float(fHslider40))) * (1.0f - float(fCheckbox2))) / fSlow238);
		float fSlow240 = float(fHslider43);
		float fSlow241 = std::tan((fConst28 * fSlow240));
		float fSlow242 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow241))));
		float fSlow243 = float(fHslider44);
		float fSlow244 = std::tan((fConst28 * fSlow243));
		float fSlow245 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow244))));
		float fSlow246 = (std::min<float>(5.0f, std::max<float>(0.00999999978f, float(fHslider45))) + 1.0f);
		float fSlow247 = std::tan((fConst28 * ((1875.0f * fSlow246) + 500.0f)));
		float fSlow248 = (1.0f / fSlow247);
		float fSlow249 = (1.0f / (((fSlow248 + 1.41421354f) / fSlow247) + 1.0f));
		float fSlow250 = std::tan((fConst28 * ((62.5f * fSlow246) + 40.0f)));
		float fSlow251 = (1.0f / fSlow250);
		float fSlow252 = (1.0f / (((fSlow251 + 1.41421354f) / fSlow250) + 1.0f));
		float fSlow253 = mydsp_faustpower2_f(fSlow250);
		float fSlow254 = (1.0f / fSlow253);
		float fSlow255 = (((fSlow251 + -1.41421354f) / fSlow250) + 1.0f);
		float fSlow256 = (2.0f * (1.0f - fSlow254));
		float fSlow257 = (0.0f - (2.0f / fSlow253));
		float fSlow258 = (((fSlow248 + -1.41421354f) / fSlow247) + 1.0f);
		float fSlow259 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow247))));
		float fSlow260 = (1.0f / std::max<float>(1.0f, (fConst155 * fSlow246)));
		float fSlow261 = float(fHslider46);
		float fSlow262 = float((fSlow261 > 0.0f));
		float fSlow263 = (0.0f - fSlow261);
		float fSlow264 = (fConst47 * ((1.0f / float(fHslider47)) + -1.0f));
		...
		float fSlow268 = float(fHslider49);
		...
		float fSlow272 = (1.0f - fSlow267);
		float fSlow273 = float(fHslider50);
		float fSlow274 = (1.0f / float(fHslider51));
		float fSlow275 = std::tan((fConst28 * float(fHslider52)));
		float fSlow276 = (1.0f / fSlow275);
		float fSlow277 = (1.0f / (((fSlow274 + fSlow276) / fSlow275) + 1.0f));
		float fSlow278 = (((fSlow276 - fSlow274) / fSlow275) + 1.0f);
		float fSlow279 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow275))));
		float fSlow280 = (1.0f / fSlow244);
		float fSlow281 = float(fHslider53);
		int iSlow282 = (fSlow281 > 0.0f);
		float fSlow283 = (float(fHslider54) * std::sin((fConst48 * fSlow243)));
		float fSlow284 = (fConst28 * ((fSlow243 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow281)))) / fSlow283));
		float fSlow285 = (fConst28 * (fSlow243 / fSlow283));
		float fSlow286 = (iSlow282 ? fSlow285 : fSlow284);
		float fSlow287 = ((fSlow280 * (fSlow280 - fSlow286)) + 1.0f);
		float fSlow288 = ((fSlow280 * (fSlow280 + fSlow286)) + 1.0f);
		float fSlow289 = (iSlow282 ? fSlow284 : fSlow285);
		float fSlow290 = ((fSlow280 * (fSlow280 + fSlow289)) + 1.0f);
		float fSlow291 = ((fSlow280 * (fSlow280 - fSlow289)) + 1.0f);
		float fSlow292 = (1.0f / fSlow241);
		float fSlow293 = float(fHslider55);
		int iSlow294 = (fSlow293 > 0.0f);
		float fSlow295 = (float(fHslider56) * std::sin((fConst48 * fSlow240)));
		float fSlow296 = (fConst28 * ((fSlow240 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow293)))) / fSlow295));
		float fSlow297 = (fConst28 * (fSlow240 / fSlow295));
		float fSlow298 = (iSlow294 ? fSlow297 : fSlow296);
		float fSlow299 = ((fSlow292 * (fSlow292 - fSlow298)) + 1.0f);
		float fSlow300 = ((fSlow292 * (fSlow292 + fSlow298)) + 1.0f);
		float fSlow301 = (iSlow294 ? fSlow296 : fSlow297);
		float fSlow302 = ((fSlow292 * (fSlow292 + fSlow301)) + 1.0f);
		float fSlow303 = ((fSlow292 * (fSlow292 - fSlow301)) + 1.0f);
		float fSlow304 = (1.0f / fSlow238);
		float fSlow305 = (((fSlow237 - fSlow235) / fSlow236) + 1.0f);
		float fSlow306 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow236))));
		float fSlow307 = (1.0f / float(fHslider58));
		float fSlow308 = std::tan((fConst28 * float(fHslider59)));
		float fSlow309 = (1.0f / fSlow308);
		float fSlow310 = (((fSlow307 + fSlow309) / fSlow308) + 1.0f);
		float fSlow311 = ((std::pow(10.0f, (0.0500000007f * float(fHslider57))) * (1.0f - float(fCheckbox3))) / fSlow310);
		...
		float fSlow316 = std::tan((fConst28 * fSlow315));
		float fSlow317 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow316))));
		float fSlow318 = float(fHslider62);
		float fSlow319 = float((fSlow318 > 0.0f));
		float fSlow320 = (0.0f - fSlow318);
		float fSlow321 = std::min<float>(20000.0f, std::max<float>(20.0f, float(fHslider63)));
		float fSlow322 = ((fSlow321 * fSlow13) * ((0.0500000007f * fSlow15) + 1.0f));
		float fSlow323 = (fConst222 * ((0.200000003f * ((0.5f * fSlow129) + -5.0f)) + 1.0f));
		float fSlow324 = ((std::min<float>(20000.0f, std::max<float>(20.0f, float(fHslider64))) * fSlow13) * (1.0f - (0.0299999993f * fSlow15)));
		float fSlow325 = ((std::min<float>(20000.0f, std::max<float>(20.0f, float(fHslider65))) * fSlow13) * ((0.310000002f * fSlow15) + 1.0f));
		float fSlow326 = ((std::min<float>(20000.0f, std::max<float>(20.0f, float(fHslider66))) * fSlow13) * (1.0f - (0.270000011f * fSlow15)));
		float fSlow327 = (fConst47 * ((1.0f / float(fHslider67)) + -1.0f));
		float fSlow328 = float(fHslider68);
		int iSlow329 = (std::fabs(fSlow328) < 1.1920929e-07f);
		float fSlow330 = (iSlow329 ? 0.0f : std::exp((0.0f - (fConst5 / (iSlow329 ? 1.0f : fSlow328)))));
		float fSlow331 = float(fHslider69);
		int iSlow332 = (std::fabs(fSlow331) < 1.1920929e-07f);
		float fSlow333 = (iSlow332 ? 0.0f : std::exp((0.0f - (fConst5 / (iSlow332 ? 1.0f : fSlow331)))));
		float fSlow334 = (1.0f - fSlow333);
		float fSlow335 = (1.0f - fSlow330);
		float fSlow336 = float(fHslider70);
		float fSlow337 = (1.0f / float(fHslider71));
		float fSlow338 = std::tan((fConst28 * float(fHslider72)));
		float fSlow339 = (1.0f / fSlow338);
		float fSlow340 = (1.0f / (((fSlow337 + fSlow339) / fSlow338) + 1.0f));
		float fSlow341 = (((fSlow339 - fSlow337) / fSlow338) + 1.0f);
		float fSlow342 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow338))));
		float fSlow343 = (1.0f / fSlow316);
		float fSlow344 = float(fHslider73);
		int iSlow345 = (fSlow344 > 0.0f);
		float fSlow346 = (float(fHslider74) * std::sin((fConst48 * fSlow315)));
		float fSlow347 = (fConst28 * ((fSlow315 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow344)))) / fSlow346));
		float fSlow348 = (fConst28 * (fSlow315 / fSlow346));
		float fSlow349 = (iSlow345 ? fSlow348 : fSlow347);
		float fSlow350 = ((fSlow343 * (fSlow343 - fSlow349)) + 1.0f);
		float fSlow351 = ((fSlow343 * (fSlow343 + fSlow349)) + 1.0f);
		float fSlow352 = (iSlow345 ? fSlow347 : fSlow348);
		float fSlow353 = ((fSlow343 * (fSlow343 + fSlow352)) + 1.0f);
		float fSlow354 = ((fSlow343 * (fSlow343 - fSlow352)) + 1.0f);
		float fSlow355 = (1.0f / fSlow313);
		float fSlow356 = float(fHslider75);
		int iSlow357 = (fSlow356 > 0.0f);
		float fSlow358 = (float(fHslider76) * std::sin((fConst48 * fSlow312)));
		float fSlow359 = (fConst28 * ((fSlow312 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow356)))) / fSlow358));
		float fSlow360 = (fConst28 * (fSlow312 / fSlow358));
		float fSlow361 = (iSlow357 ? fSlow360 : fSlow359);
		float fSlow362 = ((fSlow355 * (fSlow355 - fSlow361)) + 1.0f);
		float fSlow363 = ((fSlow355 * (fSlow355 + fSlow361)) + 1.0f);
		float fSlow364 = (iSlow357 ? fSlow359 : fSlow360);
		float fSlow365 = ((fSlow355 * (fSlow355 + fSlow364)) + 1.0f);
		float fSlow366 = ((fSlow355 * (fSlow355 - fSlow364)) + 1.0f);
		float fSlow367 = (1.0f / fSlow310);
		float fSlow368 = (((fSlow309 - fSlow307) / fSlow308) + 1.0f);
		float fSlow369 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow308))));
		float fSlow370 = (1.0f / float(fHslider78));
		float fSlow371 = std::tan((fConst28 * float(fHslider79)));
		float fSlow372 = (1.0f / fSlow371);
		float fSlow373 = (((fSlow370 + fSlow372) / fSlow371) + 1.0f);
		float fSlow374 = ((std::pow(10.0f, (0.0500000007f * float(fHslider77))) * (1.0f - float(fCheckbox4))) / fSlow373);
		float fSlow375 = (0.300000012f * fSlow374);
		float fSlow376 = float(fHslider80);
		float fSlow377 = std::tan((fConst28 * fSlow376));
		float fSlow378 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow377))));
		float fSlow379 = float(fHslider81);
		float fSlow380 = std::tan((fConst28 * fSlow379));
		float fSlow381 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow380))));
		float fSlow382 = float(fHslider82);
		float fSlow383 = float((fSlow382 > 0.0f));
		float fSlow384 = (0.0f - fSlow382);
		float fSlow385 = (1.0f / std::max<float>(1.0f, (fConst155 * (std::min<float>(10.0f, std::max<float>(1.0f, float(fHslider83))) + 1.0f))));
		float fSlow386 = (fConst47 * ((1.0f / float(fHslider84)) + -1.0f));
		float fSlow387 = float(fHslider85);
		int iSlow388 = (std::fabs(fSlow387) < 1.1920929e-07f);
		float fSlow389 = (iSlow388 ? 0.0f : std::exp((0.0f - (fConst5 / (iSlow388 ? 1.0f : fSlow387)))));
		float fSlow390 = float(fHslider86);
		int iSlow391 = (std::fabs(fSlow390) < 1.1920929e-07f);
		float fSlow392 = (iSlow391 ? 0.0f : std::exp((0.0f - (fConst5 / (iSlow391 ? 1.0f : fSlow390)))));
		float fSlow393 = (1.0f - fSlow392);
		float fSlow394 = (1.0f - fSlow389);
		float fSlow395 = float(fHslider87);
		float fSlow396 = (1.0f / float(fHslider88));
		float fSlow397 = std::tan((fConst28 * float(fHslider89)));
		...
		float fSlow402 = (1.0f / fSlow380);
		float fSlow403 = float(fHslider90);
		int iSlow404 = (fSlow403 > 0.0f);
		float fSlow405 = (float(fHslider91) * std::sin((fConst48 * fSlow379)));
		float fSlow406 = (fConst28 * ((fSlow379 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow403)))) / fSlow405));
		float fSlow407 = (fConst28 * (fSlow379 / fSlow405));
		...
		float fSlow415 = float(fHslider92);
		int iSlow416 = (fSlow415 > 0.0f);
		float fSlow417 = (float(fHslider93) * std::sin((fConst48 * fSlow376)));
		float fSlow418 = (fConst28 * ((fSlow376 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow415)))) / fSlow417));
		float fSlow419 = (fConst28 * (fSlow376 / fSlow417));
		...
		float fSlow426 = (1.0f / fSlow373);
		float fSlow427 = (((fSlow372 - fSlow370) / fSlow371) + 1.0f);
		float fSlow428 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow371))));
		float fSlow429 = (1.0f / float(fHslider95));
		float fSlow430 = std::tan((fConst28 * float(fHslider96)));
		float fSlow431 = (1.0f / fSlow430);
		float fSlow432 = (((fSlow429 + fSlow431) / fSlow430) + 1.0f);
		float fSlow433 = ((std::pow(10.0f, (0.0500000007f * float(fHslider94))) * (1.0f - float(fCheckbox5))) / fSlow432);
		float fSlow434 = float(fHslider97);
		float fSlow435 = std::tan((fConst28 * fSlow434));
		float fSlow436 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow435))));
		float fSlow437 = float(fHslider98);
		float fSlow438 = std::tan((fConst28 * fSlow437));
		float fSlow439 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow438))));
		float fSlow440 = (0.5f * fSlow321);
		float fSlow441 = (fConst488 * fSlow13);
		float fSlow442 = (27.0f * fSlow13);
		float fSlow443 = (9.0f * fSlow13);
		float fSlow444 = (3.0f * fSlow13);
		float fSlow445 = (fConst47 * ((1.0f / float(fHslider99)) + -1.0f));
		float fSlow446 = float(fHslider100);
		int iSlow447 = (std::fabs(fSlow446) < 1.1920929e-07f);
		float fSlow448 = (iSlow447 ? 0.0f : std::exp((0.0f - (fConst5 / (iSlow447 ? 1.0f : fSlow446)))));
		float fSlow449 = float(fHslider101);
		int iSlow450 = (std::fabs(fSlow449) < 1.1920929e-07f);
		float fSlow451 = (iSlow450 ? 0.0f : std::exp((0.0f - (fConst5 / (iSlow450 ? 1.0f : fSlow449)))));
		float fSlow452 = (1.0f - fSlow451);
		float fSlow453 = (1.0f - fSlow448);
		float fSlow454 = float(fHslider102);
		float fSlow455 = (1.0f / float(fHslider103));
		float fSlow456 = std::tan((fConst28 * float(fHslider104)));
		...
		float fSlow462 = float(fHslider105);
		int iSlow463 = (fSlow462 > 0.0f);
		float fSlow464 = (float(fHslider106) * std::sin((fConst48 * fSlow437)));
		float fSlow465 = (fConst28 * ((fSlow437 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow462)))) / fSlow464));
		float fSlow466 = (fConst28 * (fSlow437 / fSlow464));
		...
		float fSlow474 = float(fHslider107);
		int iSlow475 = (fSlow474 > 0.0f);
		float fSlow476 = (float(fHslider108) * std::sin((fConst48 * fSlow434)));
		float fSlow477 = (fConst28 * ((fSlow434 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow474)))) / fSlow476));
		float fSlow478 = (fConst28 * (fSlow434 / fSlow476));
		...
		float fSlow488 = (1.0f / float(fHslider110));
		float fSlow489 = std::tan((fConst28 * float(fHslider111)));
		float fSlow490 = (1.0f / fSlow489);
		float fSlow491 = (((fSlow488 + fSlow490) / fSlow489) + 1.0f);
		float fSlow492 = ((std::pow(10.0f, (0.0500000007f * float(fHslider109))) * (1.0f - float(fCheckbox6))) / fSlow491);
		float fSlow493 = float(fHslider112);
		float fSlow494 = std::tan((fConst28 * fSlow493));
		float fSlow495 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow494))));
		float fSlow496 = float(fHslider113);
		float fSlow497 = std::tan((fConst28 * fSlow496));
		float fSlow498 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow497))));
		float fSlow499 = float(fHslider114);
		float fSlow500 = float((fSlow499 > 0.0f));
		float fSlow501 = (0.0f - fSlow499);
		float fSlow502 = (fConst47 * ((1.0f / float(fHslider115)) + -1.0f));
		float fSlow503 = float(fHslider116);
		int iSlow504 = (std::fabs(fSlow503) < 1.1920929e-07f);
		float fSlow505 = (iSlow504 ? 0.0f : std::exp((0.0f - (fConst5 / (iSlow504 ? 1.0f : fSlow503)))));
		float fSlow506 = float(fHslider117);
		int iSlow507 = (std::fabs(fSlow506) < 1.1920929e-07f);
		float fSlow508 = (iSlow507 ? 0.0f : std::exp((0.0f - (fConst5 / (iSlow507 ? 1.0f : fSlow506)))));
		float fSlow509 = (1.0f - fSlow508);
		float fSlow510 = (1.0f - fSlow505);
		float fSlow511 = float(fHslider118);
		float fSlow512 = (1.0f / float(fHslider119));
		float fSlow513 = std::tan((fConst28 * float(fHslider120)));
		float fSlow514 = (1.0f / fSlow513);
		float fSlow515 = (1.0f / (((fSlow512 + fSlow514) / fSlow513) + 1.0f));
		float fSlow516 = (((fSlow514 - fSlow512) / fSlow513) + 1.0f);
		float fSlow517 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow513))));
		float fSlow518 = (1.0f / fSlow497);
		float fSlow519 = float(fHslider121);
		int iSlow520 = (fSlow519 > 0.0f);
		float fSlow521 = (float(fHslider122) * std::sin((fConst48 * fSlow496)));
		float fSlow522 = (fConst28 * ((fSlow496 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow519)))) / fSlow521));
		float fSlow523 = (fConst28 * (fSlow496 / fSlow521));
		float fSlow524 = (iSlow520 ? fSlow523 : fSlow522);
		float fSlow525 = ((fSlow518 * (fSlow518 - fSlow524)) + 1.0f);
		float fSlow526 = ((fSlow518 * (fSlow518 + fSlow524)) + 1.0f);
		float fSlow527 = (iSlow520 ? fSlow522 : fSlow523);
		float fSlow528 = ((fSlow518 * (fSlow518 + fSlow527)) + 1.0f);
		float fSlow529 = ((fSlow518 * (fSlow518 - fSlow527)) + 1.0f);
		float fSlow530 = (1.0f / fSlow494);
		float fSlow531 = float(fHslider123);
		int iSlow532 = (fSlow531 > 0.0f);
		float fSlow533 = (float(fHslider124) * std::sin((fConst48 * fSlow493)));
		float fSlow534 = (fConst28 * ((fSlow493 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow531)))) / fSlow533));
		float fSlow535 = (fConst28 * (fSlow493 / fSlow533));
		float fSlow536 = (iSlow532 ? fSlow535 : fSlow534);
		float fSlow537 = ((fSlow530 * (fSlow530 - fSlow536)) + 1.0f);
		float fSlow538 = ((fSlow530 * (fSlow530 + fSlow536)) + 1.0f);
		float fSlow539 = (iSlow532 ? fSlow534 : fSlow535);
		float fSlow540 = ((fSlow530 * (fSlow530 + fSlow539)) + 1.0f);
		float fSlow541 = ((fSlow530 * (fSlow530 - fSlow539)) + 1.0f);
		float fSlow542 = (1.0f / fSlow491);
		float fSlow543 = (((fSlow490 - fSlow488) / fSlow489) + 1.0f);
		float fSlow544 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow489))));
		float fSlow545 = (0.949999988f * fSlow374);
		for (int i = 0; (i < count); i = (i + 1)) {
			iVec0[0] = 1;
			...
			fRec20[0] = ((0.999000013f * fRec20[1]) + (0.00100000005f * ((fSlow16 * ftbl0mydspSIG0[int((65536.0f * fRec21[0]))]) + 1.0f)));
			fRec19[0] = ((fConst34 * fRec19[1]) + (fConst35 * (std::min<float>(5000.0f, std::max<float>(20.0f, (fSlow14 * fRec20[0]))) * fTemp0)));
			...
			float fTemp7 = (0.400000006f * ((fSlow18 * ((2.0f * fRec24) + -1.0f)) + (fSlow19 * fTemp6)));
			float fTemp8 = ((fSlow71 <= fRec19[0]) ? fRec19[0] : fSlow71);
			float fTemp9 = std::tan((fConst28 * fTemp8));
			float fTemp10 = (1.0f / fTemp9);
			float fTemp11 = (fSlow79 / fTemp8);
			...
			float fTemp15 = ((iSlow81 & (fRec19[0] >= 200.0f)) ? (fSlow80 - (0.000952380942f * ((fRec19[0] + -200.0f) * fSlow82))) : ((fSlow80 <= fTemp14) ? fTemp14 : fSlow80));
			float fTemp16 = std::tan((fConst28 * fTemp15));
			float fTemp17 = (1.0f / fTemp16);
			float fTemp18 = (fSlow87 / fTemp15);
			...
			fRec27[0] = (fTemp7 - (((fRec27[2] * fSlow100) + (2.0f * (fRec27[1] * fSlow101))) / fSlow102));
			fRec28[0] = (fTemp7 - (((fRec28[2] * fSlow111) + (2.0f * (fRec28[1] * fSlow112))) / fSlow113));
			fRec29[0] = (fTemp7 - (((fRec29[2] * fSlow121) + (2.0f * (fRec29[1] * fSlow122))) / fSlow123));
			fVec2[0] = fSlow126;
			float fTemp21 = (fSlow126 - fVec2[1]);
			fVec3[0] = fSlow128;
			float fTemp22 = (0.0f - (fSlow126 + fVec3[1]));
			float fTemp23 = std::min<float>(1.0f, ((fTemp21 * float((fTemp21 > 0.0f))) + (fSlow127 * (fTemp22 * float((fTemp22 > 0.0f))))));
			fVec4[0] = fTemp23;
			iRec30[0] = (((iRec30[1] + (iRec30[1] > 0)) * (fTemp23 <= fVec4[1])) + (fTemp23 > fVec4[1]));
			float fTemp24 = float(iRec30[0]);
			fRec16[0] = (((fTemp0 * ((fTemp1 * (((((fRec22[0] / fTemp13) + ((fRec26[0] * fSlow88) / fTemp20)) + ((fRec27[0] * fSlow104) / fSlow105)) + ((fRec28[0] * fSlow115) / fSlow116)) + ((fRec29[0] * fSlow124) / fSlow125))) + (((((fRec22[2] * (0.0f - (fTemp1 / fTemp13))) + (fRec26[2] * (0.0f - ((fTemp1 * fSlow88) / fTemp20)))) + (fRec27[2] * (0.0f - ((fTemp1 * fSlow104) / fSlow105)))) + (fRec28[2] * (0.0f - ((fTemp1 * fSlow115) / fSlow116)))) + (fRec29[2] * (0.0f - ((fTemp1 * fSlow124) / fSlow125)))))) * std::sqrt(std::max<float>(0.0f, std::min<float>((fConst38 * fTemp24), ((fConst39 * (fConst37 - fTemp24)) + 1.0f))))) - (fConst40 * ((fConst41 * fRec16[2]) + (fConst42 * fRec16[1]))));
			fRec31[0] = (int(fTemp23) ? fSlow129 : fRec31[1]);
			...
			fRec34[0] = std::max<float>(fTemp26, ((fRec34[1] * fSlow136) + (fTemp26 * fSlow137)));
			fRec33[0] = ((fRec33[1] * fSlow133) + (fRec34[0] * fSlow138));
			fRec32[0] = ((fConst46 * fRec32[1]) + (fSlow130 * std::max<float>(((20.0f * std::log10(fRec33[0])) - fSlow139), 0.0f)));
			float fTemp27 = (fConst32 * (fTemp25 * std::pow(10.0f, (0.0500000007f * fRec32[0]))));
			fRec35[0] = (fTemp27 - (fSlow143 * ((fSlow144 * fRec35[2]) + (fSlow145 * fRec35[1]))));
			float fTemp28 = (fSlow11 * fRec15[1]);
			fRec15[0] = (fTemp27 - ((fSlow143 * (fRec35[2] + (fRec35[0] + (2.0f * fRec35[1])))) + (((fRec15[2] * fSlow153) + fTemp28) / fSlow154)));
			float fTemp29 = (fSlow8 * fRec14[1]);
			fRec14[0] = ((((fTemp28 + (fRec15[0] * fSlow156)) + (fRec15[2] * fSlow157)) / fSlow154) - (((fRec14[2] * fSlow165) + fTemp29) / fSlow166));
			fRec13[0] = ((((fTemp29 + (fRec14[0] * fSlow168)) + (fRec14[2] * fSlow169)) / fSlow166) - (fSlow170 * ((fSlow171 * fRec13[2]) + (fSlow172 * fRec13[1]))));
			...
			fVec5[0] = fSlow185;
			float fTemp31 = (fSlow185 - fVec5[1]);
			fVec6[0] = fSlow187;
			float fTemp32 = (0.0f - (fSlow185 + fVec6[1]));
			float fTemp33 = std::min<float>(1.0f, ((fTemp31 * float((fTemp31 > 0.0f))) + (fSlow186 * (fTemp32 * float((fTemp32 > 0.0f))))));
			fVec7[0] = fTemp33;
			int iTemp34 = int(fTemp33);
			fRec65[0] = (iTemp34 ? fSlow188 : fRec65[1]);
			float fTemp35 = ((340.0f / std::min<float>(5000.0f, std::max<float>(20.0f, (fSlow184 * (fRec20[0] * fRec65[0]))))) + -0.109999999f);
			...
			fRec66[0] = ((fSlow189 * fRec66[1]) + (fSlow190 * fRec61[1]));
			...
			fVec9[0] = fTemp88;
			fRec67[(IOTA & 2047)] = ((fSlow189 * fRec67[((IOTA - 1) & 2047)]) + (fSlow190 * fVec9[2]));
			...
			fRec40[0] = fRec43;
			float fRec41 = fRec45;
			fRec70[0] = (fSlow191 + (0.999000013f * fRec70[1]));
			...
			fRec72[0] = (iTemp34 ? fSlow129 : fRec72[1]);
			...
			fRec75[0] = std::max<float>(fTemp95, ((fRec75[1] * fSlow198) + (fTemp95 * fSlow199)));
			fRec74[0] = ((fRec74[1] * fSlow195) + (fRec75[0] * fSlow200));
			fRec73[0] = ((fConst46 * fRec73[1]) + (fSlow192 * std::max<float>(((20.0f * std::log10(fRec74[0])) - fSlow201), 0.0f)));
			float fTemp96 = (0.25f * ((fTemp94 * std::pow(10.0f, (0.0500000007f * fRec73[0]))) / fTemp92));
			fRec76[0] = (fTemp96 - (fSlow205 * ((fSlow206 * fRec76[2]) + (fSlow207 * fRec76[1]))));
			float fTemp97 = (fSlow183 * fRec38[1]);
			fRec38[0] = (fTemp96 - ((fSlow205 * (fRec76[2] + (fRec76[0] + (2.0f * fRec76[1])))) + (((fRec38[2] * fSlow215) + fTemp97) / fSlow216)));
			float fTemp98 = (fSlow180 * fRec37[1]);
			fRec37[0] = ((((fTemp97 + (fRec38[0] * fSlow218)) + (fRec38[2] * fSlow219)) / fSlow216) - (((fRec37[2] * fSlow227) + fTemp98) / fSlow228));
			fRec36[0] = ((((fTemp98 + (fRec37[0] * fSlow230)) + (fRec37[2] * fSlow231)) / fSlow228) - (fSlow232 * ((fSlow233 * fRec36[2]) + (fSlow234 * fRec36[1]))));
			float fTemp99 = (fSlow177 * (fRec36[2] + (fRec36[0] + (2.0f * fRec36[1]))));
			...
			fRec110[0] = (fTemp116 - (fSlow252 * ((fSlow255 * fRec110[2]) + (fSlow256 * fRec110[1]))));
			fRec109[0] = ((fSlow252 * (((fSlow254 * fRec110[0]) + (fSlow257 * fRec110[1])) + (fSlow254 * fRec110[2]))) - (fSlow249 * ((fSlow258 * fRec109[2]) + (fSlow259 * fRec109[1]))));
			fVec26[0] = fSlow261;
			float fTemp117 = (fSlow261 - fVec26[1]);
			fVec27[0] = fSlow263;
			float fTemp118 = (0.0f - (fSlow261 + fVec27[1]));
			float fTemp119 = std::min<float>(1.0f, ((fTemp117 * float((fTemp117 > 0.0f))) + (fSlow262 * (fTemp118 * float((fTemp118 > 0.0f))))));
			fVec28[0] = fTemp119;
			iRec111[0] = (((iRec111[1] + (iRec111[1] > 0)) * (fTemp119 <= fVec28[1])) + (fTemp119 > fVec28[1]));
			float fTemp120 = (fSlow260 * float(iRec111[0]));
			float fTemp121 = (fSlow249 * ((fRec109[2] + (fRec109[0] + (2.0f * fRec109[1]))) * std::max<float>(0.0f, std::min<float>(fTemp120, (2.0f - fTemp120)))));
			int iTemp122 = int(fTemp119);
			fRec112[0] = (iTemp122 ? fSlow261 : fRec112[1]);
			...
			fRec132[0] = (iTemp122 ? fSlow129 : fRec132[1]);
			...
			fRec135[0] = std::max<float>(fTemp124, ((fRec135[1] * fSlow270) + (fTemp124 * fSlow271)));
			fRec134[0] = ((fRec134[1] * fSlow267) + (fRec135[0] * fSlow272));
			fRec133[0] = ((fConst46 * fRec133[1]) + (fSlow264 * std::max<float>(((20.0f * std::log10(fRec134[0])) - fSlow273), 0.0f)));
			float fTemp125 = (0.0125000002f * (fTemp123 * std::pow(10.0f, (0.0500000007f * fRec133[0]))));
			fRec136[0] = (fTemp125 - (fSlow277 * ((fSlow278 * fRec136[2]) + (fSlow279 * fRec136[1]))));
			float fTemp126 = (fSlow245 * fRec107[1]);
			fRec107[0] = (fTemp125 - ((fSlow277 * (fRec136[2] + (fRec136[0] + (2.0f * fRec136[1])))) + (((fRec107[2] * fSlow287) + fTemp126) / fSlow288)));
			float fTemp127 = (fSlow242 * fRec106[1]);
			fRec106[0] = ((((fTemp126 + (fRec107[0] * fSlow290)) + (fRec107[2] * fSlow291)) / fSlow288) - (((fRec106[2] * fSlow299) + fTemp127) / fSlow300));
			fRec105[0] = ((((fTemp127 + (fRec106[0] * fSlow302)) + (fRec106[2] * fSlow303)) / fSlow300) - (fSlow304 * ((fSlow305 * fRec105[2]) + (fSlow306 * fRec105[1]))));
			float fTemp128 = ((fSlow239 * (fRec105[2] + (fRec105[0] + (2.0f * fRec105[1])))) + fTemp30);
			fVec29[0] = fSlow318;
			float fTemp129 = (fSlow318 - fVec29[1]);
			fVec30[0] = fSlow320;
			float fTemp130 = (0.0f - (fSlow318 + fVec30[1]));
			float fTemp131 = std::min<float>(1.0f, ((fTemp129 * float((fTemp129 > 0.0f))) + (fSlow319 * (fTemp130 * float((fTemp130 > 0.0f))))));
			fVec31[0] = fTemp131;
			...
			fRec146[0] = ((fConst221 * fRec146[1]) + (fSlow323 * fRec147[0]));
			...
			fRec150[0] = (iTemp135 ? fSlow324 : fRec150[1]);
			...
			fRec153[0] = (iTemp135 ? fSlow325 : fRec153[1]);
			...
			fRec156[0] = (iTemp135 ? fSlow326 : fRec156[1]);
			...
			fRec159[0] = std::max<float>(fTemp160, ((fRec159[1] * fSlow333) + (fTemp160 * fSlow334)));
			fRec158[0] = ((fRec158[1] * fSlow330) + (fRec159[0] * fSlow335));
			fRec157[0] = ((fConst46 * fRec157[1]) + (fSlow327 * std::max<float>(((20.0f * std::log10(fRec158[0])) - fSlow336), 0.0f)));
			float fTemp161 = (0.25f * (fTemp159 * std::pow(10.0f, (0.0500000007f * fRec157[0]))));
			fRec160[0] = (fTemp161 - (fSlow340 * ((fSlow341 * fRec160[2]) + (fSlow342 * fRec160[1]))));
			float fTemp162 = (fSlow317 * fRec139[1]);
			fRec139[0] = (fTemp161 - ((fSlow340 * (fRec160[2] + (fRec160[0] + (2.0f * fRec160[1])))) + (((fRec139[2] * fSlow350) + fTemp162) / fSlow351)));
			float fTemp163 = (fSlow314 * fRec138[1]);
			fRec138[0] = ((((fTemp162 + (fRec139[0] * fSlow353)) + (fRec139[2] * fSlow354)) / fSlow351) - (((fRec138[2] * fSlow362) + fTemp163) / fSlow363));
			fRec137[0] = ((((fTemp163 + (fRec138[0] * fSlow365)) + (fRec138[2] * fSlow366)) / fSlow363) - (fSlow367 * ((fSlow368 * fRec137[2]) + (fSlow369 * fRec137[1]))));
			iRec164[0] = 0;
			...
			fVec33[0] = fSlow382;
			float fTemp165 = (fSlow382 - fVec33[1]);
			fVec34[0] = fSlow384;
			float fTemp166 = (0.0f - (fSlow382 + fVec34[1]));
			float fTemp167 = std::min<float>(1.0f, ((fTemp165 * float((fTemp165 > 0.0f))) + (fSlow383 * (fTemp166 * float((fTemp166 > 0.0f))))));
			fVec35[0] = fTemp167;
			int iTemp168 = int(fTemp167);
			fRec169[0] = (iTemp168 ? fSlow382 : fRec169[1]);
			...
			float fTemp197 = (fSlow385 * float(iRec174[0]));
			...
			fRec224[0] = (iTemp168 ? fSlow129 : fRec224[1]);
			float fTemp200 = (fRec165 * std::pow(10.0f, (0.144444451f * (fRec224[0] + -10.0f))));
			float fTemp201 = std::fabs((0.25f * fTemp200));
			fRec227[0] = std::max<float>(fTemp201, ((fRec227[1] * fSlow392) + (fTemp201 * fSlow393)));
			fRec226[0] = ((fRec226[1] * fSlow389) + (fRec227[0] * fSlow394));
			fRec225[0] = ((fConst46 * fRec225[1]) + (fSlow386 * std::max<float>(((20.0f * std::log10(fRec226[0])) - fSlow395), 0.0f)));
			float fTemp202 = (0.25f * (fTemp200 * std::pow(10.0f, (0.0500000007f * fRec225[0]))));
			fRec228[0] = (fTemp202 - (fSlow399 * ((fSlow400 * fRec228[2]) + (fSlow401 * fRec228[1]))));
			float fTemp203 = (fSlow381 * fRec163[1]);
			fRec163[0] = (fTemp202 - ((fSlow399 * (fRec228[2] + (fRec228[0] + (2.0f * fRec228[1])))) + (((fRec163[2] * fSlow409) + fTemp203) / fSlow410)));
			float fTemp204 = (fSlow378 * fRec162[1]);
			fRec162[0] = ((((fTemp203 + (fRec163[0] * fSlow412)) + (fRec163[2] * fSlow413)) / fSlow410) - (((fRec162[2] * fSlow421) + fTemp204) / fSlow422));
			fRec161[0] = ((((fTemp204 + (fRec162[0] * fSlow424)) + (fRec162[2] * fSlow425)) / fSlow422) - (fSlow426 * ((fSlow427 * fRec161[2]) + (fSlow428 * fRec161[1]))));
			...
			fRec234[0] = (iTemp135 ? fSlow440 : fRec234[1]);
			float fTemp206 = (fRec238[1] + (fSlow441 * fRec234[0]));
			fRec238[0] = (fTemp206 - std::floor(fTemp206));
			float fTemp207 = (fRec237[1] + (fConst5 * ((315.0f * (fRec232[0] * ftbl0mydspSIG0[int((65536.0f * fRec238[0]))])) + (fSlow442 * fRec234[0]))));
			fRec237[0] = (fTemp207 - std::floor(fTemp207));
			float fTemp208 = (fRec236[1] + (fConst5 * ((315.0f * (fRec232[0] * ftbl0mydspSIG0[int((65536.0f * fRec237[0]))])) + (fSlow443 * fRec234[0]))));
			fRec236[0] = (fTemp208 - std::floor(fTemp208));
			float fTemp209 = (fRec235[1] + (fConst5 * ((315.0f * (fRec232[0] * ftbl0mydspSIG0[int((65536.0f * fRec236[0]))])) + (fSlow444 * fRec234[0]))));
			fRec235[0] = (fTemp209 - std::floor(fTemp209));
			float fTemp210 = (fRec233[1] + (fConst5 * ((fSlow13 * fRec234[0]) + (315.0f * (fRec232[0] * ftbl0mydspSIG0[int((65536.0f * fRec235[0]))])))));
			...
			fRec241[0] = std::max<float>(fTemp214, ((fRec241[1] * fSlow451) + (fTemp214 * fSlow452)));
			fRec240[0] = ((fRec240[1] * fSlow448) + (fRec241[0] * fSlow453));
			fRec239[0] = ((fConst46 * fRec239[1]) + (fSlow445 * std::max<float>(((20.0f * std::log10(fRec240[0])) - fSlow454), 0.0f)));
			float fTemp215 = (0.25f * (fTemp213 * std::pow(10.0f, (0.0500000007f * fRec239[0]))));
			fRec242[0] = (fTemp215 - (fSlow458 * ((fSlow459 * fRec242[2]) + (fSlow460 * fRec242[1]))));
			float fTemp216 = (fSlow439 * fRec231[1]);
			fRec231[0] = (fTemp215 - ((fSlow458 * (fRec242[2] + (fRec242[0] + (2.0f * fRec242[1])))) + (((fRec231[2] * fSlow468) + fTemp216) / fSlow469)));
			float fTemp217 = (fSlow436 * fRec230[1]);
			fRec230[0] = ((((fTemp216 + (fRec231[0] * fSlow471)) + (fRec231[2] * fSlow472)) / fSlow469) - (((fRec230[2] * fSlow480) + fTemp217) / fSlow481));
			fRec229[0] = ((((fTemp217 + (fRec230[0] * fSlow483)) + (fRec230[2] * fSlow484)) / fSlow481) - (fSlow485 * ((fSlow486 * fRec229[2]) + (fSlow487 * fRec229[1]))));
			float fTemp218 = (fSlow433 * (fRec229[2] + (fRec229[0] + (2.0f * fRec229[1]))));
			fRec247[0] = (fTemp196 - (fConst492 * ((fConst493 * fRec247[2]) + (fConst494 * fRec247[1]))));
			fVec38[0] = fSlow499;
			float fTemp219 = (fSlow499 - fVec38[1]);
			fVec39[0] = fSlow501;
			float fTemp220 = (0.0f - (fSlow499 + fVec39[1]));
			float fTemp221 = std::min<float>(1.0f, ((fTemp219 * float((fTemp219 > 0.0f))) + (fSlow500 * (fTemp220 * float((fTemp220 > 0.0f))))));
			fVec40[0] = fTemp221;
			...
			fRec300[0] = std::max<float>(fTemp226, ((fRec300[1] * fSlow508) + (fTemp226 * fSlow509)));
			fRec299[0] = ((fRec299[1] * fSlow505) + (fRec300[0] * fSlow510));
			fRec298[0] = ((fConst46 * fRec298[1]) + (fSlow502 * std::max<float>(((20.0f * std::log10(fRec299[0])) - fSlow511), 0.0f)));
			float fTemp227 = (0.00499999989f * (fTemp225 * std::pow(10.0f, (0.0500000007f * fRec298[0]))));
			fRec301[0] = (fTemp227 - (fSlow515 * ((fSlow516 * fRec301[2]) + (fSlow517 * fRec301[1]))));
			float fTemp228 = (fSlow498 * fRec245[1]);
			fRec245[0] = (fTemp227 - ((fSlow515 * (fRec301[2] + (fRec301[0] + (2.0f * fRec301[1])))) + (((fRec245[2] * fSlow525) + fTemp228) / fSlow526)));
			float fTemp229 = (fSlow495 * fRec244[1]);
			fRec244[0] = ((((fTemp228 + (fRec245[0] * fSlow528)) + (fRec245[2] * fSlow529)) / fSlow526) - (((fRec244[2] * fSlow537) + fTemp229) / fSlow538));
			fRec243[0] = ((((fTemp229 + (fRec244[0] * fSlow540)) + (fRec244[2] * fSlow541)) / fSlow538) - (fSlow542 * ((fSlow543 * fRec243[2]) + (fSlow544 * fRec243[1]))));
			float fTemp230 = (fSlow492 * (fRec243[2] + (fRec243[0] + (2.0f * fRec243[1]))));
			float fTemp231 = ((fConst10 * fRec0[2]) + ((((((fTemp128 + (fSlow311 * (fRec137[2] + (fRec137[0] + (2.0f * fRec137[1]))))) + (fSlow375 * fTemp205)) + fTemp218) + fTemp99) + fTemp230) + (fConst9 * fRec0[0])));
			...
			fRec325[0] = std::max<float>(fTemp258, ((fSlow333 * fRec325[1]) + (fSlow334 * fTemp258)));
			fRec324[0] = ((fSlow330 * fRec324[1]) + (fRec325[0] * fSlow335));
			fRec323[0] = ((fConst46 * fRec323[1]) + (fSlow327 * std::max<float>(((20.0f * std::log10(fRec324[0])) - fSlow336), 0.0f)));
			float fTemp259 = (0.25f * (fTemp257 * std::pow(10.0f, (0.0500000007f * fRec323[0]))));
			fRec326[0] = (fTemp259 - (fSlow340 * ((fSlow341 * fRec326[2]) + (fSlow342 * fRec326[1]))));
			float fTemp260 = (fSlow317 * fRec314[1]);
			fRec314[0] = (fTemp259 - ((fSlow340 * (fRec326[2] + (fRec326[0] + (2.0f * fRec326[1])))) + (((fSlow350 * fRec314[2]) + fTemp260) / fSlow351)));
			float fTemp261 = (fSlow314 * fRec313[1]);
			fRec313[0] = ((((fTemp260 + (fRec314[0] * fSlow353)) + (fSlow354 * fRec314[2])) / fSlow351) - (((fSlow362 * fRec313[2]) + fTemp261) / fSlow363));
			fRec312[0] = ((((fTemp261 + (fRec313[0] * fSlow365)) + (fSlow366 * fRec313[2])) / fSlow363) - (fSlow367 * ((fSlow368 * fRec312[2]) + (fSlow369 * fRec312[1]))));
			float fTemp262 = ((fConst10 * fRec311[2]) + (((fSlow311 * (fRec312[2] + (fRec312[0] + (2.0f * fRec312[1])))) + (fTemp230 + (fTemp99 + (fTemp218 + (fTemp128 + (fSlow545 * fTemp205)))))) + (fConst9 * fRec311[0])));
